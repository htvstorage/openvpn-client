...
CREATE TABLE "inventory"."isdn" (
  ...
  "isdn_new" varchar(10) COLLATE "pg_catalog"."default"
)
;
...
COMMENT ON COLUMN "inventory"."isdn"."session_keeping" IS 'Session của khách hàng đang giữ số';
