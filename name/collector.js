...
async function collect(stockData, symbol) {
  try {
    let func = [Exchange.fundamental, Exchange.financialIndicators];
    let key = ["fundamental", "financialIndicators"];
    let check = [(e)=> {return e.beta != undefined}, (e)=>{return e.length > 0}];
