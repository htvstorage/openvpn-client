...
END {
    # In tiêu đề
    printf "%-20s%-15s%-15s%-15s%-15s%-15s%-15s%-15s\n", "Thời gian", "Mã Chứng Khoán", "Mua", "Bán", "Không Xác Định", "Giá Trị Mua", "Giá Trị Bán", "Giá Trị Không Xác Định"
    ...
    for(symbol in symbols){
        for(time_slot in atime){
            ...
            printf "%02d:%02d-%02d:%02d%-20s%-20'\''.0f%-15d%-15d%-15d%-15d%-15d%-15d\n", int(time_slot/60), time_slot%60, int((time_slot+5)/60), (time_slot+5)%60, symbol, giatrimua-giatriban, mua, ban, khongxacdinh, giatrimua, giatriban, giatrikhongxacdinh
        }
    }
    printf "%-15s%-15s%-20s%-15s%-15s%-15s%-15s%-15s%-15s\n", "Thời gian", "Mã Chứng Khoán", "Mua-Ban", "Mua", "Bán", "Không Xác Định", "Giá Trị Mua", "Giá Trị Bán", "Giá Trị Không Xác Định"
}' "$input_file"
