...
async function wss() {
  ...
  ws.on('open', function () {
    ...
    ws.send('{"type":"sub","topic":"stockRealtimeByListV2","variables":["VN30F2311","VN30F2312"],"component":"depthChart"}')
    ws.send('{"type":"sub","topic":"matchedVolByPriceV2","variables":["VN30F2311","VN30F2312"]}')
    ws.send('{"type":"sub","topic":"leTableAddV2","variables":["VN30F2311","VN30F2312"]}')
