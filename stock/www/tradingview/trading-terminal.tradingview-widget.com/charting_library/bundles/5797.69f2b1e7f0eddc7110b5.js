                    ...
                    if ("IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype) "isIntersecting" in window.IntersectionObserverEntry.prototype || Object.defineProperty(window.IntersectionObserverEntry.prototype, "isIntersecting", {
                        ...
                        i.prototype.THROTTLE_TIMEOUT = 100, i.prototype.POLL_INTERVAL = null, i.prototype.USE_MUTATION_OBSERVER = !0, i.prototype.observe = function(t) {
                            ...
                            if ("none" != window.getComputedStyle(e).display) {
                                for (var i, o, r, h, a, u, d, l, p = s(e), f = c(e), g = !1; !g;) {
                                    var _ = null,
                                        v = 1 == f.nodeType ? window.getComputedStyle(f) : {};
                                    if ("none" == v.display) return;
                                    if (f == this.root || f == t ? (g = !0, _ = n) : f != t.body && f != t.documentElement && "visible" != v.overflow && (_ = s(f)), _ && (i = _, o = p, r = void 0, h = void 0, a = void 0, u = void 0, d = void 0, l = void 0, r = Math.max(i.top, o.top), h = Math.min(i.bottom, o.bottom), a = Math.max(i.left, o.left), u = Math.min(i.right, o.right), l = h - r, !(p = (d = u - a) >= 0 && l >= 0 && {
                                            top: r,
                                            bottom: h,
                                            left: a,
                                            right: u,
