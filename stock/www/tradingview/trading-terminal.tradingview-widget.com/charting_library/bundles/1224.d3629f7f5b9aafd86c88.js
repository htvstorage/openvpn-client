    ...
    [1224], {
        ...
        69893: (o, e, l) => {
            ...
            const i = {
                ...
                dot: l(21801),
                drawginmode: l(29390),
                drawginmodeActive: l(8724),
                eraser: l(88791),
                group: l(15864),
                hideAllDrawings: l(71485),
                hideAllDrawingsActive: l(26),
                hideAllIndicators: l(64886),
                hideAllIndicatorsActive: l(60236),
                hideAllDrawingTools: l(99595),
                hideAllDrawingToolsActive: l(53793),
                hideAllPositionsTools: l(97737),
                hideAllPositionsToolsActive: l(91693),
                lockAllDrawings: l(3992),
                lockAllDrawingsActive: l(69840),
                magnet: l(32210),
                strongMagnet: l(4228),
                measure: l(15622),
                removeAllDrawingTools: l(86312),
                showObjectTree: l(51966),
                zoom: l(64223),
                "zoom-out": l(96187)
            }
        },
        84291: (o, e, l) => {
            ...
            var i = l(25177),
                ...
                s = l(15942),
                r = l(80185);
            const c = (0, r.humanReadableModifiers)(r.Modifiers.Shift, !1),
                d = (0, r.humanReadableModifiers)(r.Modifiers.Alt, !1),
                T = (0, r.humanReadableModifiers)(r.Modifiers.Mod, !1),
                L = {
                    keys: [c],
                ...
                v = {
                    ...
                    SyncDrawing: {
                        ...
                        localizedName: (0, i.t)("New drawings are replicated to all charts in the layout and shown when the same ticker is selected")
                    },
                    arrow: {
        ...
        3597: (o, e, l) => {
            ...
            ! function(o) {
                function e() {
                    o.favorites = [];
                    (0, s.getJSON)("chart.favoriteDrawings", []).forEach(e => {
                ...
                o.favorites = [], o.favoritesSynced = new(t()), o.favoriteIndex = function(e) {
                    return o.favorites.indexOf(e)
                }, o.isValidLineToolName = l, o.saveFavorites = function(e) {
                    (0, s.setJSON)("chart.favoriteDrawings", o.favorites, e)
                }, e(), s.onSync.subscribe(null, e)
            }(i || (i = {})),
            function(o) {
                function e(o) {
                ...
                o.favoriteAdded = new(t()), o.favoriteRemoved = new(t()), o.favoriteMoved = new(t()), o.favoritesSynced = i.favoritesSynced, o.favorites = function() {
                    ...
                    return -1 !== s && a !== s && (i.favorites.splice(s, 1), i.favorites.splice(a, 0, n), i.saveFavorites(t), o.favoriteMoved.fire(n, s, a), !0)
                }
            }(n || (n = {}))
        },
        96038: (o, e, l) => {
        ...
        63694: (o, e, l) => {
            ...
            class n extends i.PureComponent {
                constructor(o) {
                    super(o), this._addDrawer = () => {
                        const o = this.state.currentDrawer + 1;
        ...
        59339: (o, e, l) => {
            ...
            function h(o) {
                const {
                    ...
                    className: m,
                    theme: v = L
                } = o, z = (0, n.ensureNotNull)((0, i.useContext)(c.DrawerContext)), [g, w] = (0, i.useState)(0), u = (0, i.useRef)(null), f = (0, i.useContext)(T.CloseDelegateContext);
                return (0, i.useEffect)(() => {
                    const o = (0, n.ensureNotNull)(u.current);
                    return o.focus({
                        preventScroll: !0
                    }), f.subscribe(z, l), 0 === z.currentDrawer && (0, s.setFixedBodyState)(!0), d.CheckMobile.iOS() && (0, t.disableBodyScroll)(o), w(z.addDrawer()), () => {
                        f.unsubscribe(z, l);
                        const e = z.removeDrawer();
                        d.CheckMobile.iOS() && (0, t.enableBodyScroll)(o), 0 === e && (0, s.setFixedBodyState)(!1)
                    }
                }, []), i.createElement(r.Portal, null, i.createElement("div", {
                    className: a(L.wrap, L["position" + e])
                }, g === z.currentDrawer && i.createElement("div", {
                    className: L.backdrop,
                    onClick: l
                }), i.createElement("div", {
                    className: a(L.drawer, v.drawer, L["position" + e], m),
                    ref: u,
                    tabIndex: -1,
        ...
        77687: (o, e, l) => {
            ...
            function T(o) {
                ...
                return n.createElement(t.Icon, { ...L,
                    className: a(c.favorite, "apply-common-tooltip", l && c.checked, i && c.active, e),
                    icon: l ? s : r,
                    onClick: T,
        ...
        92063: (o, e, l) => {
            ...
            function d(o) {
                ...
                return i.createElement(o.href ? "a" : "div", n)
            }
            ...
            function L(o) {
                const {
                    ...
                    theme: P = r
                } = o, F = (0, s.filterDataProps)(o), R = (0, i.useRef)(null);
                return i.createElement(d, { ...F,
                    id: e,
                    role: l,
                    "aria-selected": c,
                    className: n(L, P.item, w && P.withIcon, {
                        [P.isActive]: u,
                        [P.isDisabled]: f || p,
                        [P.hovered]: N
                    }),
                    ...
                    target: b,
                    rel: C,
                    reference: function(o) {
                        R.current = o, "function" == typeof y && y(o);
                        "object" == typeof y && (y.current = o)
                    },
                    onClick: function(e) {
                        const {
                            dontClosePopup: l,
                        ...
                        if (f) return;
                        s && (0, t.trackEvent)(s.category, s.event, s.label);
                        i && i(n, e);
                        l || (0, a.globalCloseMenu)()
                    },
                    onContextMenu: function(e) {
                        ...
                        l && i && (0, t.trackEvent)(l.category, l.event, l.label + "_rightClick")
                    },
                    onMouseUp: function(e) {
                        ...
                        if (1 === e.button && A && l) {
                            let o = l.label;
                            i && (o += "_mouseWheelClick"), (0, t.trackEvent)(l.category, l.event, o)
                        }
                    },
                    onMouseOver: S,
                    onMouseOut: k
                }, void 0 !== w && i.createElement("div", {
                    className: P.icon,
                    dangerouslySetInnerHTML: {
                        __html: w
                    }
                }), i.createElement("div", {
                    className: n(P.labelRow, m)
                }, i.createElement("div", {
                    className: n(P.label, v)
                }, x)), (void 0 !== z || g) && i.createElement("div", {
                    className: P.shortcut
                }, (B = z) && B.split("+").join(" + ")), void 0 !== M && i.createElement("div", {
                    onClick: D ? T : void 0,
                    className: n(P.toolbox, {
                        [P.showOnHover]: I
                    })
                }, M));
                var B
        ...
        44377: (o, e, l) => {
            ...
            function c(o) {
                const {
                    ...
                    onClose: h,
                    ...m
                } = o, v = (0, i.useContext)(s.CloseDelegateContext), z = (0, r.useOutsideEvent)({
                    handler: function(o) {
                        L && L(o);
                        if (!d) return;
                        if (T && o.target instanceof Node) {
                            const e = n.findDOMNode(T);
                            if (e instanceof Node && e.contains(o.target)) return
                        }
                        h()
                    },
                    mouseDown: !0,
