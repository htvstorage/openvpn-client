    ...
    [5093], {
        ...
        49803: (e, t, s) => {
            ...
            const k = (0, c.humanReadableModifiers)(c.Modifiers.Alt, !1),
                ...
                x = (0, c.humanReadableModifiers)(c.Modifiers.Mod, !1),
                ...
                P = (0, l.t)("Zoom Out"),
                O = (0, l.t)("Zoom In"),
                z = (0, l.t)("Maximize chart"),
                I = (0, l.t)("Restore chart"),
                N = (0, l.t)("Scroll to the Left"),
                R = (0, l.t)("Scroll to the Right"),
                j = (0, l.t)("Reset Chart"),
                F = (0,
                    l.t)("Scroll to the Most Recent Bar"),
                Y = `<div class="control-bar-wrapper">\n\t<div class="control-bar control-bar--hidden">\n\t\t<div class="control-bar__group js-btn-group js-btn-group-zoom">\n\t\t\t<div class="control-bar__btn control-bar__btn--zoom-out apply-common-tooltip" title="${P}" data-tooltip-hotkey="${B}">\n\t\t\t\t${m}\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--zoom-in apply-common-tooltip" title="${O}" data-tooltip-hotkey="${H}">\n\t\t\t\t${b}\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-maximize">\n\t\t\t<div class="control-bar__btn control-bar__btn--maximize apply-common-tooltip" title="${z}" data-tooltip-hotkey="${W}">\n\t\t\t\t${C}\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--minimize js-hidden apply-common-tooltip" title="${I}" data-tooltip-hotkey="${W}">\n\t\t\t\t${E}\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-scroll">\n\t\t\t<div class="control-bar__btn control-bar__btn--move-left apply-common-tooltip" title="${N}" data-tooltip-hotkey="${L}">\n\t\t\t\t${p}\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--move-right apply-common-tooltip" title="${R}" data-tooltip-hotkey="${A}">\n\t\t\t\t${v}\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-reset-scale">\n\t\t\t<div class="control-bar__btn control-bar__btn--turn-button control-bar__btn--btn-hidden apply-common-tooltip js-btn-reset" title="${j}" data-tooltip-hotkey="${T}">\n\t\t\t\t${g}\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>`,
                U = `<div class="control-bar control-bar__btn control-bar__btn--back-present control-bar__btn--btn-hidden apply-common-tooltip" title="${F}" data-tooltip-hotkey="${D}">\n\t${w}\n</div>`,
                X = u.CheckMobile.any(),
                q = {
                    zoomInOut: !0,
                    maximize: !0,
            ...
            class G {
                ...
                _updateBtnGroupVisibility() {
                    ...
                    for (const e of this._visibilityPrioritizedGroups) {
                        ...
                        e.available() && (!X || !e.shouldBeHiddenOnMobile) && (s -= e.totalWidth, e.enoughSpaceForGroup = s >= 0 && !i, i = i || !e.enoughSpaceForGroup), !e.enoughSpaceForGroup !== e.element.classList.contains("js-hidden") && e.element.classList.toggle("js-hidden", !e.enoughSpaceForGroup)
                    }
        ...
        98018: (e, t, s) => {
            ...
            class y {
                constructor(e, t, s) {
                    this._el = null, this._firstBlockWrapper = null, this._titleParentEl = null, this._titleElements = [], this._valuesParentEl = null, this._valuesAdditionalWrapperEl = null, this._valuesElements = [], this._actionsParentEl = null, this._actionAdditionalWrapperEl = null, this._stayInHoveredMode = !1, this._mode = 4, this._statusesWrapper = null, this._resizeObserver = null, this._hideInvisibleHover = null, this._hideValues = null, this._allButtonsWidth = null, this._lastStatusesWrapperWidth = null, this._lastActionsWrapperWidth = null, this._showActionsHandler = null, this._hideActionsHandler = null, this._selectedSourceHandler = null, this._mouseEventHandlers = [], this._disableTimeout = null, this._loader = null, this._updateDisabledState = (e = this._disabled.value()) => {
                        null !== this._el && (this._el.classList.toggle(v.disabled, e), this._updateLoadingState(), this._updateStatusWidgetVisibility(e), this._updateTitleMaxWidth())
                    }, this._updateLoadingState = (e = this._loading.value()) => {
                        if (null !== this._el) {
                            const t = this._el.classList;
                            t.toggle(v.eyeLoading, e && !this._disabled.value()), t.toggle(v.loading, e)
                        }
                    ...
                    this._withActions = s.withActions, this._render(), this._updateStates(), this._updateShowTitles(), this._updateShowValues(), this._updateShowLine(),
                        null !== this._valuesParentEl && (this._loader = new g.LoaderPointsRenderer(this._valuesParentEl, {
                            className: v.loader
                ...
                destroy() {
                    ...
                    if (null !== this._actionAdditionalWrapperEl && (this._withActions && null !== this._showActionsHandler && null !== this._hideActionsHandler && !S && (this._actionAdditionalWrapperEl.removeEventListener("mouseenter", this._showActionsHandler), this._actionAdditionalWrapperEl.removeEventListener("mouseleave", this._hideActionsHandler)), this._actionAdditionalWrapperEl = null), this._actionsParentEl = null, this._removeValuesSpawnsSubscriptions(), this._values.destroy(), null !== this._valuesParentEl && (this._valuesElements = [], this._valuesParentEl = null),
                        null === (e = this._hideInvisibleHover) || void 0 === e || e.destroy(), null === (t = this._hideValues) || void 0 === t || t.destroy(), null !== this._resizeObserver && (this._resizeObserver.disconnect(), this._resizeObserver = null), null !== this._el) {
                ...
                _renderTitle() {
                    ...
                    for (let t = 0; t < this._titlesSpawns.length; t++) {
                        ...
                        l.classList.add(v.title, i, "apply-overflow-tooltip"), l.dataset.name = "legend-source-title", s.length > 0 ? (l.appendChild(document.createTextNode(s)), l.classList.add(v.withDot)) : l.classList.add(w.blockHidden), e.appendChild(l), this._titleElements.push(l)
                    }
                }
                _renderActions() {
                    ...
                    for (const s of this._model.actions()) {
                        const i = (0, _.createActionElement)(s, v.button, v.buttonIcon, w.blockHidden, t);
                        e.appendChild(i)
                    }
                }
                _isWidthButtonsMode() {
                ...
                _updateTitlesHandler(e, t) {
                    const s = (0, i.ensureNotNull)(this._titleElements[e]),
                        l = 0 === t.length;
                    s.classList.toggle(w.blockHidden, l), s.classList.toggle(v.withDot, !l), (0, b.updateTextNode)(s, t)
                }
                _updateStates(e) {
                ...
                _updateValuesHTMLElHandler(e, t) {
                    ...
                    (0, b.updateTextNode)(s, t), this._updateShowValues()
                }
                _updateValueColorHandler(e, t = "") {
                    (0, i.ensure)(this._valuesElements[e].value).style.color = t
                }
                _updateValueVisibleHandler(e, t) {
                    const s = (0, i.ensure)(this._valuesElements[e].value).closest("." + v.valueItem);
                    null !== s && s.classList.toggle(w.blockHidden, !t)
                }
                _updateShowLine() {
                ...
                _addStatusesWidget(e, t, s) {
                    this._statusesWrapper = document.createElement("div"), this._statusesWrapper.classList.add(v.statusesWrapper), this._statusesWrapper.appendChild(e), (0, i.ensureNotNull)(this._firstBlockWrapper).appendChild(this._statusesWrapper), this._hideInvisibleHover = t.spawn(), this._hideInvisibleHover.subscribe(this._updateInvisibleHoverMode.bind(this), {
                        callWithLast: !0
                ...
                _updateInvisibleHoverMode(e) {
                    null !== this._el && this._el.classList.toggle(v.invisibleHover, !e)
                }
                _updateHideValuesMode(e) {
                    null !== this._el && this._el.classList.toggle(v.hideValues, e)
                }
                _showActions() {
                    ...
                    this._el.classList.toggle(v.withTail, e), this._updateTitleMaxWidth()
                }
                _hideActions() {
                ...
                _clearDisableState() {
                    null !== this._el && (this._el.classList.remove(v.eyeLoading), this._el.classList.remove(v.disabled), this._updateStatusWidgetVisibility(this._disabled.value()), this._updateTitleMaxWidth())
                }
                _updateDisabledOnIntervalState() {
                    var e;
                    null === (e = this._el) || void 0 === e || e.classList.toggle(v.disabledOnInterval, this._disabledOnInterval.value())
                }
                ...
                _updateActionVisibilities(e) {
                    null !== this._actionsParentEl && this._actionsParentEl.querySelectorAll("." + v.button)[e].classList.toggle(w.blockHidden, !this._actionsSpawnArray[e].visible.value())
                }
                _updateActionTitle(e) {
                    const t = this._actionsSpawnArray[e].title;
                    null !== this._actionsParentEl && null !== t && this._actionsParentEl.querySelectorAll("." + v.button)[e].setAttribute("title", t.value())
                }
                _updateCustomTextColor() {
                    const e = this._customTextColor.value() || "";
                    for (const t of this._titleElements) null !== t && (t.style.color = e);
                    const t = (0, i.ensureNotNull)(this._valuesParentEl).querySelectorAll("." + v.valueTitle);
                    for (let s = 0; s < t.length; s++) t[s].style.color = e;
                    (0, i.ensureNotNull)(this._el).classList.toggle(v.withCustomTextColor, Boolean(e))
                }
                _updateStatusWidgetVisibility(e) {
                    null !== this._statusesWrapper && this._statusesWrapper.classList.toggle(w.blockHidden, e)
                }
            }
            class M extends y {
                constructor(e, t, s) {
                ...
                _render() {
                    ...
                    e.classList.add(v.item, v.series),
                        e.classList.toggle(v.onlyOneButtonCanBeStick, this._model.isOneButtonCanBeStick()), e.dataset.name = "legend-series-item"
                }
                _updateStates() {
                ...
                _renderValues() {
                    ...
                    for (const s of t) {
                        ...
                        t.classList.add(v.valueItem), t.classList.toggle(w.blockHidden, !s.visible.value()), t.classList.toggle(v.unimportant, s.unimportant.value());
                        const i = document.createElement("div"),
                            l = s.title.value() || "";
                        i.classList.add(v.valueTitle), i.classList.toggle(w.blockHidden, 0 === l.length), i.appendChild(document.createTextNode(l)), t.appendChild(i);
                        const o = document.createElement("div");
                        o.classList.add(v.valueValue), o.style.color = s.color.value() || "", o.appendChild(document.createTextNode(s.value.value())), t.appendChild(o), this._valuesElements.push({
                            title: i,
                            value: o
                        }), e.appendChild(t)
                    }
                ...
                _createTitlesSpawns() {
                    ...
                    this._titlesSpawns = [{
                        ...
                        class: v.intervalTitle
                    }, {
                        title: e.provider.spawn(),
                        class: v.providerTitle
                    }, {
                        title: e.exchange.spawn(),
                        class: v.exchangeTitle
                    }, {
                ...
                _updateValuesTitleHTMLElHandler(e, t = "") {
                    ...
                    (0, b.updateTextNode)(s, t), s.classList.toggle(w.blockHidden, 0 === t.length), this._updateShowValues()
                }
                _isWidthButtonsMode() {
                ...
                _updateFlaggedState() {
                    ...
                    (0, i.ensureNotNull)(this._el).classList.toggle(v.flagged, Boolean(this._flagged.value())), this._updateTitleMaxWidth()
                }
            }
            ...
            class C extends y {
                ...
                _renderValues() {
                    ...
                    for (const s of t) {
                        const t = document.createElement("div");
                        t.classList.add(v.valueItem), t.classList.toggle(w.blockHidden, !s.visible.value());
                        const i = document.createElement("div");
                        i.classList.add(v.valueValue), i.style.color = s.color.value() || "", i.appendChild(document.createTextNode(s.value.value()));
                ...
                _update5ButtonsStyles(e) {
                    null !== this._el && (this._el.classList.toggle(v.has5Buttons, e), this._updateAllButtonsWidth())
                }
                _onWheelClicked(e) {
            ...
            var x = s(96676),
                ...
                W = s(30630),
                L = s(93530);
            const A = (0, E.t)("Hide Indicator Legend"),
                H = (0, E.t)("Show Indicator Legend"),
                B = (0, E.t)("Show Object Tree");
            class D {
                constructor(e, t, s) {
                    this._el = null, this._counterEl = null, this._arrowIconEL = null, this._objectTreeEl = null, this._mode = 0, this._parentEl = e, this._themedColor = t.spawn(), this._themedColor.subscribe(this._updateThemedColor.bind(this)), this._sourceCount = s.visibleDataSourceCount.spawn(), this._sourceCount.subscribe(this._updateSourceCount.bind(this)), this._isStateOpen = s.isDataSourcesCollapsed.spawn(), this._isStateOpen.subscribe(this._updateState.bind(this)), this._showObjectsTree = s.showObjectsTree.spawn(), this._showObjectsTree.subscribe(this._updateObjectTreeVisibility.bind(this)), this._render(), this._updateState(), this._updateThemedColor(this._themedColor.value()), this._updateObjectTreeVisibility(this._showObjectsTree.value()), this._toggleStateHandler = (0,
                        m.wrapHandlerWithPreventEvent)(s.onCollapseDataSources), this._showObjectTreeHandler = (0, m.wrapHandlerWithPreventEvent)(s.onShowObjectsTreeDialog), null !== this._el && (this._el.addEventListener("touchend", this._toggleStateHandler), this._el.addEventListener("click", this._toggleStateHandler), this._el.addEventListener("contextmenu", e => {
                        e.preventDefault(), e.stopPropagation()
                ...
                _render() {
                    this._el = document.createElement("div"), this._el.className = v.toggler + " apply-common-tooltip", this._arrowIconEL = document.createElement("div"), this._arrowIconEL.classList.add(v.iconArrow), this._arrowIconEL.innerHTML = u.trackingModeIsAvailable ? T : x, this._el.appendChild(this._arrowIconEL), this._objectTreeEl = document.createElement("div"), this._objectTreeEl.classList.add(v.objectTree), this._objectTreeEl.innerHTML = u.trackingModeIsAvailable ? L : W, this._el.appendChild(this._objectTreeEl), this._counterEl = document.createElement("div"), this._counterEl.classList.add(v.counter), this._counterEl.appendChild(document.createTextNode(String(this._sourceCount.value()))), this._el.appendChild(this._counterEl), this._parentEl.appendChild(this._el)
                }
                ...
                _updateSourceCount(e) {
                    const t = (0, i.ensureNotNull)(this._counterEl);
                    (0, b.updateTextNode)(t, String(e));
                    const s = (0, i.ensureNotNull)(this._el),
                        l = e < 1;
                    s.classList.toggle(w.blockHidden, l);
                    const o = 1 === e;
                    s.classList.toggle(v.onlyOneSourceShown, o)
                }
                _updateState() {
                    const e = !this._isStateOpen.value();
                    this._parentEl.classList.toggle(v.closed, e), this._updateTooltip(), V((e ? "Hide" : "Show") + " not main sources")
                }
                _tooltip() {
                ...
                _updateObjectTreeVisibility(e) {
                    (0, i.ensureNotNull)(this._el).classList.toggle(v.objectsTreeCanBeShown, e)
                }
            }
            var P = s(44471),
                O = s(21709);
            ...
            const I = u.trackingModeIsAvailable ? 44 : 28,
                N = d.enabled("object_tree_legend_mode");
            class R {
                constructor(e, t) {
                    this._renderToggler = null, this._mainDataSourceRenderer = null, this._dataSourceRenderers = [],
                        this._parentEl = document.createElement("div"), this._mainDataSourceEl = null, this._dataSourcesEl = null, this._dataSourcesAdditionalWrapperEl = null, this._collapsedDataSourcesWrapperEl = null, this._collapsedDataSourcesEl = null, this._outsideEventForCollapsedTooltip = null, this._options = e, this._togglerOptions = t, this._isStudiesLegendHidden = e.isStudiesLegendHidden.spawn(), this._isStudiesLegendHidden.subscribe(this._updateLegendVisibility.bind(this)), this._isAllLegendHidden = e.isAllLegendHidden.spawn(), this._isAllLegendHidden.subscribe(this._updateLegendVisibility.bind(this)), this._updateLegendVisibility(), this._hideAllExceptFirstLine = e.hideAllExceptFirstLine.spawn(), this._hideAllExceptFirstLine.subscribe(this._updateAllHiddenExeptFirstLine.bind(this)), this._themedColor = e.themedColor.spawn(), this._themedColor.subscribe(this._setCustomBg.bind(this)), this._showBackground = e.showBackground.spawn(), this._showBackground.subscribe(this._setCustomBg.bind(this)), this._backgroundTransparency = e.backgroundTransparency.spawn(), this._backgroundTransparency.subscribe(this._setCustomBg.bind(this)), this._collapsedDataSourcesCountSpawn = e.collapsedDataSourcesCount.spawn(), this._collapsedDataSourcesCountSpawn.subscribe(this._updateCollapsedSourcesCount.bind(this)), this._showCollapsedDataSourcesTooltipHandler = this._showCollapsedDataSourcesTooltip.bind(this), this._parentEl.classList.add(v.legend), this._parentEl.classList.toggle(v.noWrap, !u.trackingModeIsAvailable), this._parentEl.classList.toggle(v.noActions, !this._options.withActions), this._parentEl.classList.toggle(v.touchMode, u.trackingModeIsAvailable), this._parentEl.classList.toggle(v.wrappable, !this._hideAllExceptFirstLine.value()), this._parentEl.dataset.name = "legend", this._parentEl.style.setProperty("--legend-source-item-button-width", I + "px");
                    const s = t => {
                ...
                destroy() {
                    if (this._isStudiesLegendHidden.destroy(), this._isAllLegendHidden.destroy(), this._hideAllExceptFirstLine.destroy(), this._themedColor.destroy(), this._showBackground.destroy(), this._backgroundTransparency.destroy(), this._collapsedDataSourcesCountSpawn.destroy(), u.trackingModeIsAvailable && null !== this._collapsedDataSourcesWrapperEl && this._collapsedDataSourcesWrapperEl.removeEventListener("touchend", this._showCollapsedDataSourcesTooltipHandler), this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), null !== this._dataSourcesAdditionalWrapperEl && (this._dataSourcesAdditionalWrapperEl.innerHTML = "", this._dataSourcesAdditionalWrapperEl = null), null !== this._dataSourcesEl && (this._dataSourcesEl.innerHTML = "", this._dataSourcesEl = null), null !== this._renderToggler && (this._renderToggler.destroy(), this._renderToggler = null), null !== this._mainDataSourceRenderer && (this._mainDataSourceRenderer.destroy(), this._mainDataSourceRenderer = null), 0 !== this._dataSourceRenderers.length) {
                ...
                addMainDataSource(e, t) {
                    this._renderMainDataSourceEl(), this._mainDataSourceRenderer = new M(e, (0, i.ensureNotNull)(this._mainDataSourceEl), {
                ...
                addDataSources(e, t) {
                    ...
                    for (let i = 0; i < e.length; i++) {
                        ...
                        this._dataSourceRenderers.push(o), this._updateLegendVisibility(), l.onDestroy().subscribe(this, () => {
                            const e = this._dataSourceRenderers.indexOf(o); - 1 !== e && (this._dataSourceRenderers[e].destroy(), this._dataSourceRenderers.splice(e, 1))
                        }, !0)
                    }
                }
                addCustomWidget(e, t) {
                ...
                updateMode(e) {
                    const t = N && e < 133 ? 1 : e < 205 ? 2 : e < 222 ? 3 : 4;
                    ...
                    this._parentEl.classList.toggle(v.medium, 3 === t), this._parentEl.classList.toggle(v.minimized, 2 === t), this._parentEl.classList.toggle(v.micro, 1 === t), null !== this._renderToggler && this._renderToggler.setMode(1 === t);
                    const s = !this._hideAllExceptFirstLine.value() && (u.trackingModeIsAvailable || e < 542);
                    this._parentEl.classList.toggle(v.directionColumn, s), this._parentEl.classList.toggle(v.hideUniportantValueItems, !h.CheckMobile.any() && e <= 272)
                }
                getMainSourceHeight() {
                ...
                _renderMainDataSourceEl() {
                    null === this._mainDataSourceEl && (this._mainDataSourceEl = document.createElement("div"), this._mainDataSourceEl.classList.add(v.legendMainSourceWrapper), this._parentEl.insertBefore(this._mainDataSourceEl, this._dataSourcesEl))
                }
                _renderDataSourcesEl() {
                    null === this._dataSourcesEl && (this._dataSourcesEl = document.createElement("div"), this._dataSourcesEl.classList.add(v.sourcesWrapper), this._renderToggle(this._dataSourcesEl), this._dataSourcesAdditionalWrapperEl = document.createElement("div"), this._dataSourcesAdditionalWrapperEl.classList.add(v.sources),
                        this._dataSourcesEl.appendChild(this._dataSourcesAdditionalWrapperEl), this._renderCollapsedCounter(this._dataSourcesAdditionalWrapperEl), this._parentEl.appendChild(this._dataSourcesEl))
                }
                _renderToggle(e) {
                ...
                _addOutsideEventForHideTooltip() {
                    null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), this._outsideEventForCollapsedTooltip = (0, O.addOutsideEventListener)(new CustomEvent("timestamp").timeStamp, this._collapsedDataSourcesWrapperEl, () => {
                ...
                _updateCollapsedSourcesCount(e) {
                    ...
                    const t = 0 === e;
                    this._collapsedDataSourcesWrapperEl.classList.toggle(w.blockHidden, t), t || ((0, b.updateTextNode)(this._collapsedDataSourcesEl, "+" + e), this._collapsedDataSourcesEl.setAttribute("title", this._options.collapsedDataSourcesTitle.value()))
                }
                ...
                _updateAllHiddenExeptFirstLine() {
                    this._parentEl.classList.toggle(v.wrappable, !this._hideAllExceptFirstLine.value())
                }
                _setCustomBg() {
            ...
            const Z = new U.TranslatedString("show {title}", (0, E.t)("show {title}")),
                J = new U.TranslatedString("hide {title}", (0, E.t)("hide {title}")),
                Q = (0, E.t)("Show"),
                ee = (0, E.t)("Hide");
            class te {
                constructor(e, t, s, i, l) {
                    this._values = new(o())([]), this._actions = [], this._onDestroy = new(q()), this._loading = new(o())(!1), this._moreActionCM = null, this._updateLoadingStatus = () => {
                            this._loading.setValue(this._source.isLoading())
                        }, this._model = e, this._source = t,
                        this._options = s, this._callbacks = i, this._contextMenuOptions = l, this._disabled = new(o())(this._getDisabledState()), this._disabledOnInterval = new(o())(this._getDisabledOnIntervalState()), this._selected = new(o())(!1), this._isTitleHidden = new(o())(this._getTitleHiddenValue()), this._isValuesHidden = new(o())(this._getValuesHiddenValue()), this._isRowHidden = new(o())(this._getRowHiddenValue()), (0, $.combine)(() => ({}), this._isTitleHidden, this._isValuesHidden, this._disabled).subscribe(this._updateRowVisibilities.bind(this)), this._values.subscribe(() => {
                ...
                onToggleDisabled() {
                    const e = this._source.properties().childs().visible,
                        t = !e.value();
                    this._model.setProperty(e, t, (t ? Z : J).format({
                        title: new U.TranslatedString(this._source.name(), this._source.title())
                    })), V((t ? "Show" : "Hide") + " source")
                }
                onShowSettings(e) {
                    this._source.userEditEnabled() && (this.setSourceSelected(), this._callbacks.showChartPropertiesForSource(this._source, e), V("Settings for source"))
                }
                onShowMoreActions(e) {
                    return this._options.readOnlyMode ? Promise.resolve(null) : (this._callbacks.updateActions(), V("Show source context menu"), this._callbacks.showContextMenuForSources([this._source], this._calcNewPosition(e), this._contextMenuOptions))
                }
                setSourceSelected() {
                ...
                _getEyeTitle() {
                    return this._disabled.value() ? Q : ee
                }
                _getDisabledState() {
                ...
                _calcNewPosition(e) {
                    ...
                    if (e.hasOwnProperty("touches") && e.touches.length > 0) t = {
                        ...
                        t = {
                            clientX: (0, G.isRtl)() ? s.right : s.left,
            ...
            var se = s(18431),
                ...
                ae = s(83031);
            const ne = (0, E.t)("More"),
                re = (0, E.t)("Flag Symbol"),
                de = (0, E.t)("Unflag Symbol"),
                he = d.enabled("show_hide_button_in_legend"),
                ue = d.enabled("hide_resolution_in_legend");
            class ce extends te {
                constructor(e, t, s, i, l) {
                    super(e, t, s, i, l), this._titles = {
                        ...
                        chartStyle: new(o())(""),
                        branding: new(o())("")
                    }, this._symbolMarker = null, this._symbolMarkerIcon = null, this._flagged = new(o())(null), this._symbolAction = null, this._symbol = null, this._isOneButtonCanBeStick = !1, this._createActions(), this._updateSymbolMarker();
                    ...
                    }), this._valuesVisibleProperty = (0, F.combineProperty)((e, t, s) => e || t || s, a.showSeriesOHLC, a.showBarChange, a.showVolume), this._valuesVisibleProperty.subscribe(null, () => {
                        this._isValuesHidden.setValue(this._getValuesHiddenValue())
                ...
                onShowSettings() {
                    this._source.userEditEnabled() && this._callbacks.showGeneralChartProperties(se.TabNames.symbol)
                }
                ...
                _updateTitles() {
                    ...
                    this._titles.title.setValue((0, j.clean)(t.title, !0)), this._titles.description.setValue((0, j.clean)(t.description, !0)), ue || this._titles.interval.setValue((0, j.clean)(t.interval, !0)), this._titles.provider.setValue((0, j.clean)(t.provider, !0)), this._titles.exchange.setValue((0, j.clean)(t.exchange, !0)), this._titles.chartStyle.setValue((0, j.clean)(t.chartStyle, !0)), this._titles.branding.setValue((0, j.clean)(null !== (e = t.branding) && void 0 !== e ? e : "", !0))
                }
                _updateValues() {
                    ...
                    if (0 === t.length) {
                        ...
                        for (let e = 0; e < l.length; e++) {
                            ...
                            t[e + 1].value.setValue(s.value()),
                                t[e + 1].color.setValue(K(s.color())), t[e + 1].visible.setValue(s.visible()), t[e + 1].title.setValue(s.title())
                        }
                    }
                }
                _updateStates() {
                ...
                _getMarkerTitle() {
                    return null !== this._symbolMarker ? this._symbolMarker.isMarked() ? de : re : ""
                }
                _symbolActionHandler() {
                    null !== this._symbolMarker && (this._updateSymbolMarker(), V("Change flag state"))
                }
                _updateSymbolMarker() {
            ...
            var me = s(70473),
                ...
                ye = s(63002),
                Me = s(30647);
            (0, ge.getLogger)("Chart.LegendWidget");
            const fe = (0, E.t)("Settings"),
                Ce = (0, E.t)("Source code"),
                Ee = (0, E.t)("Remove"),
                ke = (0, E.t)("More"),
                Ve = ((0, E.t)("Error"), (0, E.t)("Could not get Pine source code."), (0, E.t)("Show interval settings")),
                xe = (d.enabled("study_buttons_in_legend"), d.enabled("show_hide_button_in_legend")),
                Te = d.enabled("property_pages"),
                We = d.enabled("format_button_in_legend"),
            ...
            class Ae extends te {
                constructor(e, t, s, i, l) {
                    super(e, t, s, i, l), this._titles = {
                        title: new(o())(""),
                        args: new(o())("")
                    }, this._error = new(o())(!1), this._isPineScriptDataSource = new(o())(!1), this._pineAction = null, this._globalVisibility = new(o())(!0), this._createActions();
                    const a = this._model.model().properties().childs().paneProperties.childs().legendProperties.childs(),
                ...
                onRemoveSource() {
                    var e;
                    this._source.isUserDeletable() && (this._source.hasChildren() ? (e = this._model.removeSource.bind(this._model, this._source, !1), (0, pe.showConfirm)({
                        title: (0, E.t)("Confirm Remove Study Tree"),
                        text: (0, E.t)("Do you really want to delete study and all of it's children?"),
                        onConfirm: ({
                            dialogClose: t
                        }) => {
                            e(), t()
                        }
                    })) : this._model.removeSource(this._source, !1), V("Remove sources"))
                }
                onShowSourceCode() {
                    0
                }
                ...
                _updateValues() {
                    ...
                    if (0 === t.length) {
                        ...
                        for (let e = 0; e < s.length; e++) {
                            const i = t[e],
                                l = s[e];
                            i.value.setValue(l.value()), i.color.setValue(K(l.color())), i.visible.setValue(l.visible()), i.title.setValue(l.title())
                        }
                    }
                }
                _updateStates() {
                ...
                _getDisabledOnIntervalState() {
                    return !(!(0, _e.isStudy)(this._source) && !(0, _e.isStudyStub)(this._source)) && !this._source.isActualInterval()
                }
                _getValuesHiddenValue() {
                ...
                _isSymbolLikeStudy() {
                    return this._source instanceof ye.study_Overlay || this._source instanceof Me.StudyCompare
                }
                    ...
                    if (!this._options.readOnlyMode) {
                        if (this._pineAction = {
                            ...
                            const t = {
                                ...
                                action: (0, m.wrapHandlerWithPreventEvent)(this.onShowSettings.bind(this, se.TabNames.visibility)),
                                visible: new(o())(this._getDisabledOnIntervalState()),
                                className: v.intervalEye,
                                title: new(o())(Ve),
                                dataset: {
                        ...
                        Te && We && (!(0, _e.isStudy)(this._source) || new me.MetaInfoHelper(this._source.metaInfo()).hasUserEditableOptions()) && this._actions.push({
                            iconMap: new Map([
                                ["large", be],
                                ["small", be]
                            ]),
            ...
            const Ne = new U.TranslatedString("change symbol description visibility", (0, E.t)("change symbol description visibility")),
                Re = new U.TranslatedString("change open market status visibility", (0, E.t)("change open market status visibility")),
                je = new U.TranslatedString("change OHLC values visibility", (0, E.t)("change OHLC values visibility")),
                Fe = new U.TranslatedString("change bar change visibility", (0, E.t)("change bar change visibility")),
                Ye = new U.TranslatedString("change indicator titles visibility", (0, E.t)("change indicator titles visibility")),
                Ue = new U.TranslatedString("change indicator arguments visibility", (0, E.t)("change indicator arguments visibility")),
                Xe = new U.TranslatedString("change indicator values visibility", (0, E.t)("change indicator values visibility")),
                qe = new U.TranslatedString("change volume values visibility", (0, E.t)("change volume values visibility")),
                Ge = (0, E.t)("Symbol"),
                $e = (0, E.t)("Open market status"),
                Ke = (0, E.t)("OHLC values"),
                Ze = (0, E.t)("Bar change values"),
                Je = (0, E.t)("Volume"),
                Qe = (0, E.t)("Indicator titles"),
                et = (0, E.t)("Indicator arguments"),
                tt = (0, E.t)("Indicator values"),
                st = (0, Pe.appendEllipsis)((0, E.t)("Settings"));
            var it = s(42894),
                lt = s(3960),
                ot = s(1397),
                at = s(46031),
            ...
            function pt(e) {
                ...
                const t = e % 60,
                    s = (e - t) / 60;
                return (0, ot.numberToStringWithLeadingZero)(s, 2) + ":" + (0, ot.numberToStringWithLeadingZero)(t, 2)
            }
            const mt = {
                [nt.WeekDays.MONDAY]: {
                    title: at.weekDaysShortNames[nt.WeekDays.MONDAY],
                    isActive: !1,
                    entries: []
                },
                [nt.WeekDays.TUESDAY]: {
                    title: at.weekDaysShortNames[nt.WeekDays.TUESDAY],
                    isActive: !1,
                    entries: []
                },
                [nt.WeekDays.WEDNESDAY]: {
                    title: at.weekDaysShortNames[nt.WeekDays.WEDNESDAY],
                    isActive: !1,
                    entries: []
                },
                [nt.WeekDays.THURSDAY]: {
                    title: at.weekDaysShortNames[nt.WeekDays.THURSDAY],
                    isActive: !1,
                    entries: []
                },
                [nt.WeekDays.FRIDAY]: {
                    title: at.weekDaysShortNames[nt.WeekDays.FRIDAY],
                    isActive: !1,
                    entries: []
                },
                [nt.WeekDays.SATURDAY]: {
                    title: at.weekDaysShortNames[nt.WeekDays.SATURDAY],
                    isActive: !1,
                    entries: []
                },
                [nt.WeekDays.SUNDAY]: {
                    title: at.weekDaysShortNames[nt.WeekDays.SUNDAY],
                    isActive: !1,
                    entries: []
                }
            };
            ...
            function vt(e) {
                const t = e.start(),
                    ...
                    o = pt(t),
                    a = pt(t + s);
                return s > rt.minutesPerDay ? `${at.weekDaysShortNames[i]} ${o} — ${at.weekDaysShortNames[l]} ${a}` : `${o} — ${a}`
            }

            function wt(e, t, s, i) {
                return Math.abs(i - s) > 1 ? `${at.weekDaysShortNames[s]} ${e.title} — ${at.weekDaysShortNames[i]} ${t.title}` : `${e.title} — ${t.title}`
            }
            ...
            function St(e, t, s) {
                for (const i of t) {
                    ...
                    const l = i.start(),
                        ...
                        a = l + o,
                        n = [];
                    if (a <= rt.minutesPerDay) n.push([l, a]);
                    else {
                        const e = Math.min(rt.minutesPerDay - l, o);
                        n.push([l, l + e]), n.push([0, o - e])
                    }
                    for (let l = 0; l < n.length; l++) {
                        const o = n[l],
                            [a, r] = o,
                            d = a / rt.minutesPerDay,
            ...
            class yt {
                constructor(e) {
                    this.sessionsDays = new(o())((0, a.clone)(mt)), this.todaySession = new(o())((0, a.clone)({
                        entries: []
                ...
                _updateEntriesBySubSessions(e) {
                    ...
                    const s = this._createSubSessionSpecs(e),
                        l = (o = (null === (t = this._todayInExchangeTime) || void 0 === t ? void 0 : t.getUTCDay()) || (new Date).getDay()) < nt.WeekDays.SATURDAY ? o + 1 : nt.WeekDays.SUNDAY;
                    var o;
                    const n = (0, a.clone)(mt);
                    n[l].isActive = !0;
                    for (const e of Array.from(s.keys())) {
                        St(n, (0, i.ensureDefined)(s.get(e)).getEntriesForWeekByCalendar((0, i.ensureNotNull)(this._todayInExchangeTime)), e)
                    }! function(e) {
                        const t = pt(0),
                        ...
                        for (const o of Object.keys(e)) {
                            ...
                            for (let e = 0; e < p; e++) {
                                ...
                                const r = o ? c.entries[c.entries.length - 1] : (0, i.ensureNotNull)(l),
                                    d = {
                                        ...
                                        type: 3,
                                        tooltip: wt(r.end, s.start, c.dayIndex, a),
                                        showStartForLastEntry: !1,
                                        showEndForFirstEntry: !1
                                    };
                            ...
                            1 !== g.end.value && n.push({
                                ...
                                type: 3,
                                tooltip: wt(g.end, _.entries[0].start, a, _.dayIndex),
                                showStartForLastEntry: !1,
                                showEndForFirstEntry: !1
                            })
                        }
                    ...
                    function(e) {
                        for (const i of Object.keys(e)) {
                            ...
                            const a = ht(l),
                                ...
                                r = o[0],
                                d = o[o.length - 1];
                            r.start.isFirstOrLastPoint || (r.showStartForLastEntry = (t = o, s = e[a].entries, gt(t[t.length - 1], s[s.length - 1]))), d.end.isFirstOrLastPoint || (d.showEndForFirstEntry = bt(o, e[n].entries))
                        }
                        var t, s
            ...
            const Tt = new Map([
                ...
                Wt = new Map([
                    ...
                    [1, (0, E.t)("Pre-market")],
                    [2, (0, E.t)("Post-market")],
                    [3, (0, E.t)("Market closed")]
                ]),
                Lt = (0, E.t)("Exchange timezone");
            ...
            function At(e) {
                const {
                    ...
                    forceStart: s,
                    forceEnd: i
                } = e, l = t.end.value - t.start.value, o = l < .03, a = {
                    left: 100 * t.start.value + "%",
                    width: `calc(${100*l}% + ${o?2:0}px)`
                }, n = ft(kt.segment, Tt.get(t.type), (s || t.start.isFirstOrLastPoint) && kt.start, (i || t.end.isFirstOrLastPoint) && kt.end, o && kt.small, "common-tooltip-html", "apply-common-tooltip"), r = function(e, t) {
                    return `<div class="${kt.tooltip}">\n\t\t<span class="${Tt.get(t)}">${Wt.get(t)}</span>\n\t\t<span class="${kt.time}">${e}</span>\n\t</div>`
                }(t.tooltip, t.type);
            ...
            function Ht(e) {
                const {
                    sessionDay: t
                } = e, s = t.entries.map((e, s) => Mt.createElement(At, {
                    key: xt(e) + "Segment",
                    segment: e,
            ...
            function Bt(e) {
                const {
                    sessionDays: t,
                    currentTimeMark: s
                } = e, i = [], l = parseInt(Object.keys(t).filter(e => t[parseInt(e)].isActive)[0]), o = t[l], a = o.entries.filter(e => e.start.value <= s && e.end.value >= s)[0];
            ...
            class Dt {
                constructor(e) {
                    this._fullSessionScheduleViewModel = new yt(e)
                }
                destroy() {
                ...
                renderer(e, t) {
                    return function(e) {
                        const {
                            ...
                            now: i,
                            timezone: l
                        } = e, o = (0, Ct.useWatchedValueReadonly)({
                            watchedValue: e.sessionDays
                        }), a = Object.values(o).filter(e => e.isActive)[0], n = ft(s, kt.wrapper);
                        return Mt.createElement("div", {
                            key: t,
                            className: n
                        }, Mt.createElement("div", {
            ...
            class It {
                constructor(e) {
                    this.isBlinkingMode = new(o())(!1), this._status = new(o())(null), this._fullTooltip = new(o())(null), this._iconClassNames = new(o())(null), this._visible = new(o())(!1), this._tooltip = new(o())(null), this._icon = new(o())(null), this._className = new(o())(null), this._infoMaps = e, this._size = e.size || "small", this._status.subscribe(this._updateByStatus.bind(this), {
                        callWithLast: !0
                ...
                async _getHtml(e) {
                    var t, s, i;
                    return null !== (i = null === (s = null === (t = this._infoMaps.htmlMap) || void 0 === t ? void 0 : t.get(e)) || void 0 === s ? void 0 : s.map(Ot.htmlEscape)) && void 0 !== i ? i : null
                }
                _getAction(e) {
                    var t, s;
            ...
            function jt() {
                return Nt.getJSON("tv.alreadyBlinkedStatuses", Rt)
            }
            const Ft = new(o())(jt());

            function Yt(e) {
                const t = Nt.getJSON("tv.alreadyBlinkedStatuses", Rt);
                t.includes(e) || (t.push(e), Nt.setJSON("tv.alreadyBlinkedStatuses", t), Ft.setValue(jt()))
            }
            Nt.onSync.subscribe(null, () => Ft.setValue(jt()));
            const Ut = Ft;
            var Xt = s(37978),
                qt = s(12142),
                Gt = s(52633),
                ...
                Jt = s(70077);
            const Qt = (0,
                    ge.getLogger)("Chart.LegendWidget"),
                ...
                is = new Map([
                    ["DelayToRealtime", Pt.colorsPalette["color-delay-mode"]],
                    ["DelayNoRealtime", Pt.colorsPalette["color-delay-mode"]],
                    ["TFEXDelayForGuest", Pt.colorsPalette["color-delay-mode"]],
                    ["MOEXDelayForGuest", Pt.colorsPalette["color-delay-mode"]],
                    ["CHIXAuDelayForGuest", Pt.colorsPalette["color-delay-mode"]],
                    ["LSEDelayForGuest", Pt.colorsPalette["color-delay-mode"]],
                    ["NGMDelayForGuest", Pt.colorsPalette["color-delay-mode"]],
                    ["ICESGDelayForGuest", Pt.colorsPalette["color-delay-mode"]],
                    ["DEForGuest", Pt.colorsPalette["color-delay-mode"]],
                    ["EOD", Pt.colorsPalette["color-eod-mode"]],
                    ["TickByTick", Pt.colorsPalette["color-notaccurate-mode"]],
                    ["BATSToRealtime", Pt.colorsPalette["color-notaccurate-mode"]],
                    ["DelayWithoutMarketAgreement", Pt.colorsPalette["color-delay-mode"]]
                ]),
                ls = (0, E.t)("Data is delayed"),
                os = (0, E.t)("End of day data"),
                as = (0, E.t)("One update per second"),
                ns = (0, E.t)("Cboe BZX"),
                rs = (0, E.t)("{exchange} by {originalExchange}"),
                ds = (0, Ot.htmlEscape)((0, E.t)("{symbolName} data is delayed by {time} minutes.")),
                hs = (0, Ot.htmlEscape)((0, E.t)("{listedExchange} real-time data is available for free to registered users.")),
                us = (0, Ot.htmlEscape)((0, E.t)("To get real-time data for {description}, please buy the real-time data package.")),
                cs = (0, Ot.htmlEscape)((0, E.t)("Real-time data for {description} is not supported right now. We may support it in the future.")),
                _s = (0, Ot.htmlEscape)((0, E.t)("Data is updated once a day.")),
                ps = (0, Ot.htmlEscape)((0,
                    E.t)("Data on our Basic plan is updated once per second, even if there are more updates on the market.")),
                ms = (0, Ot.htmlEscape)((0, E.t)("Data is updated once per second, even if there are more updates on the market.")),
                gs = (0, Ot.htmlEscape)((0, E.t)("Paid plans feature faster data updates.")),
                bs = (0, Ot.htmlEscape)((0, E.t)("Real-time data for {symbolName} is provided by {exchange} exchange.")),
                vs = (0, Ot.htmlEscape)((0, E.t)("This data is real-time, but it’s slightly different to its official counterpart coming from primary exchanges.")),
                ws = (0, Ot.htmlEscape)((0, E.t)("This data is real-time, but it’s slightly different to its official counterpart coming from {exchange}.")),
                Ss = (0, Ot.htmlEscape)((0, E.t)("If you'd like {listedExchange} real-time data you'll need to complete an Exchange Agreement. Don't worry, it only takes a few clicks"));
            (0, E.t)("Create a free account"), (0, E.t)("Learn more"), (0, Ot.htmlEscape)((0, E.t)("Fill out Exchange Agreements"));
            class ys extends It {
                constructor(e, t, s) {
                    super({
                        iconMap: ts,
                        ...
                        titleColorMap: is,
                        size: t
                    }), this._dataUpdatedMode = new(o())(null).spawn(), this._options = s, this._model = e, this._dataModeBlinkingStatuses = Ut.spawn(), this._dataModeBlinkingStatuses.subscribe(this._updateBlinkingMode.bind(this)), this.turnOffBlinkingMode = this._turnOffBlinking.bind(this), this.setModel(e)
                }
                destroy() {
                    this._dataUpdatedMode.destroy(), this._dataModeBlinkingStatuses.destroy()
                }
                setModel(e) {
                    if (this._dataUpdatedMode.destroy(), null === e) return this._model = e, void(this._dataUpdatedMode = new(o())(null).spawn());
                ...
                async _getHtmls() {
                    ...
                    try {
                        ...
                        Qt.logError("Can't get exchange description, reason: " + (0, Xt.errorToString)(e))
                    }
                    for (const o of e)
                        if (t[o] = [], ["DelayToRealtime", "DelayNoRealtime", "DelayWithoutMarketAgreement", ...es].includes(o) && (t[o].push(ds.format({
                                    symbolName: s,
                                    time: this._model.time().toString()
                                })), this._options.subscriptionFullInfo && null !== i && "DelayToRealtime" === o && t[o].push(us.format({
                                    description: `<b>${i}</b>`
                                })), null !== i && "DelayNoRealtime" === o && t[o].push(cs.format({
                                    description: `<b>${i}</b>`
                                })),
                                "DelayWithoutMarketAgreement" === o && t[o].push(Ss.format({
                                    listedExchange: this._model.listedExchange()
                                })), this._options.subscriptionFullInfo && es.includes(o) && t[o].push(hs.format({
                                    listedExchange: this._model.listedExchange()
                                }))), "EOD" === o && (t[o] = [_s]), "TickByTick" === o && (t[o].push(this._options.subscriptionFullInfo ? ps : ms), this._options.subscriptionFullInfo && t[o].push(gs)), null !== l && "BATSToRealtime" === o) {
                            let e = this._model.listedExchange();
                            0, t[o].push(bs.format({
                                symbolName: s,
                                exchange: l
                            }), "" !== e ? ws.format({
                                exchange: e
                ...
                _getShortTexts() {
                    ...
                    const s = {};
                    for (const i of t)
                        if (["DelayToRealtime", "DelayNoRealtime", ...es, "DelayWithoutMarketAgreement"].includes(i) && (s[i] = ls), "EOD" === i && (s[i] = os), "TickByTick" === i && (s[i] = as), "BATSToRealtime" === i) {
                ...
                _turnOffBlinking() {
                    const e = this._dataUpdatedMode.value();
                    if (null !== e)
                        for (const t of e) Yt(t)
                }
            }
            var Ms = s(50975),
                fs = s(28839);
            const Cs = (0, E.t)("Study Error"),
                Es = new Map([
                    [!0, new Map([
                        ["small", Ms],
                        ["medium", fs],
                ...
                Ts = new Map([
                    [!0, Pt.colorsPalette["color-data-problem"]],
                    [!1, null]
                ]);
            class Ws extends It {
                constructor(e, t, s) {
                    super({
                        ...
                        titleColorMap: Ts,
                        size: t
                    }), this._dataSourceErrorStatus = new(o())(null).spawn(), this._lastError = null, this._options = s, this.setSource(e)
                }
                destroy() {
                ...
                async _getHtml(e) {
                    const t = this._dataSourceErrorStatus.value();
                    return null !== t ? [(0, Ot.htmlEscape)(t.error)] : null
                }
                _getAction(e) {
            ...
            const Ls = (0,
                ...
                Ds = new Map([
                    ["high", Pt.colorsPalette["color-data-problem"]],
                    ["low", Pt.colorsPalette["color-data-problem"]]
                ]);
            class Ps extends It {
                constructor(e, t) {
                    super({
                        ...
                        titleColorMap: Ds,
                        size: t
                    }), this._dataProblem = new(o())(null).spawn(), this._isDataProblemCritical = new(o())(!1), this.setModel(e)
                }
                destroy() {
                ...
                async _getHtml(e) {
                    ...
                    return null === t ? null : [(0, Ot.htmlEscape)(t.text)]
                }
                _updateStatus(e) {
                    var t;
            ...
            var zs = s(35561),
                Is = s(49189);
            const Ns = (0, E.t)("Invalid Symbol"),
                Rs = (0, E.t)("This symbol doesn't exist, please pick another one."),
                js = new Map([
                    [!0, new Map([
                        ["small", zs],
                        ["medium", Is],
                ...
                Xs = new Map([
                    [!0, Pt.colorsPalette["color-invalid-symbol"]],
                    [!1, null]
                ]),
                qs = new Map([
                    [!0, [Rs]],
            ...
            class Ks {
                ...
                addStatusModel(e) {
                    this._iconsRenderers.push(new $s({
                        visible: e.visible,
                        icon: e.model.icon(),
            ...
            var Zs = s(22527),
                ...
                ii = s(59508),
                li = s(67951);
            const oi = (0, E.t)("Market open"),
                ai = (0, E.t)("Pre-market"),
                ni = (0, E.t)("Post-market"),
                ri = (0, E.t)("Market closed"),
                di = (0, E.t)("Holiday"),
                hi = (0, E.t)("All's well — Market is open."),
                ui = (0, E.t)("Morning. Market is open for pre-market trading."),
                ci = (0, E.t)("Evening. Market is open for post-market trading."),
                _i = (0, E.t)("Time for a walk — this market is closed."),
                pi = (0, E.t)("Market is currently on holiday. Lucky them."),
                mi = (0, E.t)("less than 1 minute"),
                gi = (0, E.t)("{days} and {hours}"),
                bi = (0, E.t)("{hours} and {minutes}"),
                vi = (0, E.t)("Market opens in {remainingTime}."),
                wi = (0, E.t)("Market closes in {remainingTime}."),
                Si = (0, E.t)("It'll go to post-market trading in {remainingTime}."),
                yi = (0,
                    E.t)("It'll open for pre-market trading in {remainingTime}."),
                Mi = new Map([
                    ["market", new Map([
                        ["small", Js],
                        ["medium", Qs],
                ...
                ki = new Map([
                    ["market", Pt.colorsPalette["color-market-open"]],
                    ["pre_market", Pt.colorsPalette["color-pre-market"]],
                    ["post_market", Pt.colorsPalette["color-post-market"]],
                    ["out_of_session", Pt.colorsPalette["color-market-closed"]],
                    ["holiday", Pt.colorsPalette["color-market-holiday"]]
                ]),
                Vi = {
                    market: hi,
                    pre_market: ui,
            ...
            const Li = {
                    market: e => ("post_market" === e.status ? Si : wi).format({
                        remainingTime: Wi(e.remainingSeconds)
                    }),
                    ...
                    out_of_session: e => ("pre_market" === e.status ? yi : vi).format({
                        remainingTime: Wi(e.remainingSeconds)
                    }),
                    holiday: e => ("pre_market" === e.status ? yi : vi).format({
                        remainingTime: Wi(e.remainingSeconds)
                    })
                },
                Ai = new Map([
            ...
            class Hi extends It {
                constructor(e, t) {
                    super({
                        ...
                        actionMap: Ai,
                        size: t
                    }), this._model = null, this._marketStatus = new(o())(null).spawn(), this._sessionEdge = new(o())(null).spawn(), this._updateTooltip = () => {
                        const e = this._status.value();
                        null !== e && this._updateFullTooltipByStatus(e)
                    }, this.setModel(e), De.showMarketOpenStatusProperty.subscribe(this, this._showMarketOpenStatusPropertyChanged)
                }
                destroy() {
                    this._marketStatus.destroy(), this._sessionEdge.destroy(), this._model = null, De.showMarketOpenStatusProperty.unsubscribeAll(this)
                }
                setModel(e) {
                    if (this._marketStatus.destroy(), this._sessionEdge.destroy(), null === e) return this._marketStatus = new(o())(null).spawn(), void(this._sessionEdge = new(o())(null).spawn());
                    this._model = e, this._marketStatus = e.status().spawn(),
                ...
                _shouldBeHiddenByStatus(e) {
                    return !De.showMarketOpenStatusProperty.value() && "market" === e
                }
                _updateStatus(e) {
            ...
            class Bi {
                constructor(e, t) {
                    var s, i;
                    this.visibleWidgetsCount = new(o())(0), this.errorWidgetIsShown = new(o())(!1), this._size = u.trackingModeIsAvailable ? "medium" : "small", this._tooltips = new(o())([]), this._visibilitySpawns = [], this._tooltipSpawns = [], this._statusWidgetInfos = [], this._renderer = new Ks(this._size, this.visibleWidgetsCount, this._tooltips, {
                        onClick: this._handleToggleDropdown.bind(this)
                    }), this._symbolInvalidViewModel = null, this._dataSourceErrorStatusViewModel = null, this._marketStatusViewModel = null, this._dataUpdatedModeViewModel = null, this._dataProblemViewModel = null, this._sessionWidget = null, this._dataSourceHasErrorVisible = null, this._dataSourceErrorCanBeShown = new(o())(!1), this._marketStatusCanBeShown = new(o())(!1), this._dataUpdatedModeCanBeShown = new(o())(!1), this._dataProblemCanBeShown = new(o())(!1), this._isDataProblemCritical = null, this._container = document.createElement("div"), this._menuOpened = !1, this._menuPosition = null, this._handleDropdownMenuClose = () => {
                        var e;
                ...
                _recreateWidgets() {
                    ...
                    if (this._options.sourceStatusesEnabled) {
                        ...
                        if (null !== e)
                            if (null === this._symbolInvalidViewModel) {
                                this._symbolInvalidViewModel = new Os(e, {
                                    tooltipMap: Ys,
                                    iconMap: js,
                                    classNameMap: Fs,
                                    titleMap: Us,
                        ...
                        if (null === this._dataSourceErrorStatusViewModel) {
                            this._dataSourceErrorStatusViewModel = new Ws(this._source, this._size, this._options.sourceStatuses), this._dataSourceHasErrorVisible = (0, $.combine)(() => this._dataSourceErrorCanBeShown.value() && (0, i.ensureNotNull)(this._dataSourceErrorStatusViewModel).visible().value(), this._dataSourceErrorCanBeShown, this._dataSourceErrorStatusViewModel.visible()), this._visibilitySpawns.push(this._dataSourceHasErrorVisible), this._tooltipSpawns.push(this._dataSourceErrorStatusViewModel.tooltip().spawn());
                            const e = {
                    ...
                    if (this._options.marketStatusEnabled) {
                        ...
                        if (null === this._marketStatusViewModel) {
                            this._marketStatusViewModel = new Hi(t, this._size);
                            const e = (0, $.combine)(() => this._marketStatusCanBeShown.value() && (0,
                                i.ensureNotNull)(this._marketStatusViewModel).visible().value(), this._marketStatusCanBeShown, this._marketStatusViewModel.visible());
                            ...
                            null !== t && (this._sessionWidget = new Dt(this._source), s.additionalWidgets = [this._sessionWidget]), this._statusWidgetInfos.push(s), this._renderer.addStatusModel(s)
                    ...
                    if (this._options.dataUpdateModeEnabled) {
                        ...
                        if (null === this._dataUpdatedModeViewModel) {
                            this._dataUpdatedModeViewModel = new ys(e, this._size, this._options.dataUpdateMode);
                            const t = (0, $.combine)(() => this._dataUpdatedModeCanBeShown.value() && (0, i.ensureNotNull)(this._dataUpdatedModeViewModel).visible().value(), this._dataUpdatedModeCanBeShown, this._dataUpdatedModeViewModel.visible());
                    ...
                    if (this._options.dataProblemEnabled) {
                        ...
                        if (null === this._dataProblemViewModel) {
                            this._dataProblemViewModel = new Ps(e, this._size), this._isDataProblemCritical = this._dataProblemViewModel.isDataProblemCritical().spawn();
                            const t = (0, $.combine)(() => this._dataProblemCanBeShown.value() && (0, i.ensureNotNull)(this._dataProblemViewModel).visible().value(), this._dataProblemCanBeShown, this._dataProblemViewModel.visible());
                ...
                _updateDropdownMenu() {
                    Promise.all([s.e(5514), s.e(2e3), s.e(3466), s.e(4102), s.e(8643)]).then(s.bind(s, 36636)).then(e => {
            ...
            class Pi {
                constructor(e, t) {
                    this._symbol = null, this._symbolInfo = new(o())(null).spawn(), this._source = e, e.properties().hasChild("symbol") && (this._symbol = (0, F.createWVFromGetterAndSubscription)(() => e.properties().symbol.value(), e.properties().symbol.listeners()));
                    const s = [];
                    if ((0, _e.isStudy)(e) || (0, _e.isStudyStub)(e)) this._isSymbolInvalid = (0, Di.createWVFromGetterAndSubscriptions)(() => e.isSymbolInvalid() && e.isActualInterval(), s), s.push(e.onStatusChanged(), e.onIsActualIntervalChange());
                    else {
                        (0, i.assert)(e === t.mainSeries());
                        const l = t.mainSeries();
                        this._isSymbolInvalid = (0, F.createWVFromGetterAndSubscription)(() => l.isSymbolInvalid(), l.onStatusChanged()), s.push(l.onStatusChanged()), this._symbolInfo = (0, F.createWVFromGetterAndSubscription)(l.symbolInfo.bind(l), l.dataEvents().symbolResolved())
                    }
                    this._dataSourceErrorStatus = (0, Di.createWVFromGetterAndSubscriptions)(() => this._source.statusProvider({}).errorStatus(), s)
                }
                destroy() {
                    var e, t;
            ...
            var Oi = s(82059);
            const zi = (0, E.t)("Replay mode"),
                Ii = (0, E.t)("You're in Replay mode. You're in Replay mode. You're in Replay mode.");
            new Map([
                [!0, new Map([
                    ["small", Oi],
                    ["medium", Oi],
                ...
                [!0, Pt.colorsPalette["color-replay-mode"]],
                [!1, null]
            ]), new Map([
                [!0, [Ii]],
                [!1, null]
            ...
            class Ni extends Bi {
                constructor(e, t, s) {
                    super(new Pi(e, t), s), this._isInReplay = new(o())(!1).readonly().spawn(), this._isInReplayCanBeShown = null, this._inited = !1
                }
                destroy() {
                    super.destroy()
                }
            ...
            class qi {
                constructor(e, t, s, i, l, n, r, d) {
                    ...
                    this._isDataSourcesCollapsed = new(o())(h.value()), h.subscribe(this, () => {
                    ...
                    m.subscribe(this, () => {
                        g.setValue(m.value())
                    }), this._hideNotMainSources = i, this._hideNotMainSources.subscribe(this._updateLegendVisibilities.bind(this)), this._hideAllExceptFirstLine = l, this._hideAllExceptFirstLine.subscribe(this._updateCollapsedSourcesMode.bind(this)), this._hideWholeLegend = n, this._hideWholeLegend.subscribe(this._updateLegendVisibilities.bind(this)), this._isPaneMain = new(o())(this._getIsPaneMainValue()), this._updateCollapsedSourcesModeThrottle = (0, ji.default)(this._updateCollapsedSourcesMode.bind(this), 100), this._renderer = new R({
                ...
                onShowLegendWidgetContextMenu(e, t) {
                    if (this._options.readOnlyMode || !Ui) return Promise.resolve();
                    V("Show legend context menu");
                    const s = new Map;
                    ...
                    return function(e, t, s, i, l, o) {
                        ...
                        if (a.push(new He.Action({
                                ...
                                onExecute: () => Ie(e, r.showBarChange, Fe)
                            })), a.push(new He.Action({
                                ...
                                onExecute: () => Ie(e, r.showVolume, qe)
                            })), a.push(new He.Separator), void 0 !== n) {
                            const e = n.get(0);
                            void 0 !== e && e.length > 0 && (a.push(...e), a.push(new He.Separator))
                        }
                        const d = i.get(1);
                        ...
                        if (e.model().priceDataSources().some(e => !(0, Oe.isSymbolSource)(e) && e.showInObjectTree()) && (a.push(new He.Action({
                                actionId: "Chart.Legend.ToggleIndicatorTitlesVisibility",
                                checkable: !0,
                                checked: r.showStudyTitles.value(),
                                label: Qe,
                                statName: "Show Indicator Titles",
                                onExecute: () => Ie(e, r.showStudyTitles, Ye)
                            })), a.push(new He.Action({
                                ...
                                onExecute: () => Ie(e, r.showStudyArguments, Ue)
                            })), a.push(new He.Action({
                                ...
                                onExecute: () => Ie(e, r.showStudyValues, Xe)
                            }))), void 0 !== d) {
                            const e = d.get(0);
                            void 0 !== e && e.length > 0 && (a.push(...e), a.push(new He.Separator))
                        }
                        return t.settings && (a[a.length - 1] instanceof He.Separator || a.push(new He.Separator), a.push(new He.Action({
                            actionId: "Chart.Dialogs.ShowGeneralSettings.LegendTab",
                            label: st,
                            icon: ze,
                            statName: "Settings...",
                            onExecute: () => s(se.TabNames.legend)
                        }))), Be.ContextMenuManager.showMenu(a, l, void 0, {
                ...
                updateLayout() {
                    ...
                    const t = this._model.mainSeries(),
                        s = e.indexOf(t);
                    s > -1 ? (e.splice(s, 1), Yi || null !== this._mainSeriesViewModel || (this._mainSeriesViewModel = new ce(this._model, t, this._mainSeriesViewModelsOptions, this._callbacks, this._options.contextMenu), this._mainSeriesStatusWidget = new Ni(t, this._model.model(), this._options.statusesWidgets), this._renderer.addMainDataSource(this._mainSeriesViewModel, this._mainSeriesStatusWidget)), this._addCustomWidgetForLayerBlock(0)) : null !== this._mainSeriesViewModel && (this._destroyMainDataSource(), this._destroyCustomWidgetFromLayerBlock(0));
                    const l = [],
                        o = [],
                        a = this._dataSourceViewModels.length;
                    if (0 === a)
                        for (let t = e.length - 1; t >= 0; t--) l.push(new Ae(this._model, e[t], this._dataSourceViewModelsOptions, this._callbacks, this._options.contextMenu)), o.push(new Bi(new Pi(e[t], this._model.model()), this._options.statusesWidgets));
                    else {
                        let t = 0;
                        for (let s = e.length - 1; s >= 0; s--) this._dataSourceViewModels[t] ? (this._dataSourceViewModels[t].updateSource(e[s]), this._dataSourcesStatusesWidgets[t].updateSource(new Pi(e[s], this._model.model()))) : (l.push(new Ae(this._model, e[s], this._dataSourceViewModelsOptions, this._callbacks, this._options.contextMenu)), o.push(new Bi(new Pi(e[s], this._model.model()), this._options.statusesWidgets))), t++;
                ...
                addMargin(e) {
                    ...
                    this._margin = e;
                    this._renderer.getElement().style.maxWidth = 0 === this._margin ? "" : `calc(100% - ${this._margin+Xi}px)`, this._updateWidgetModeBySize()
                }
                ...
                _addCustomWidgetForLayerBlock(e) {
                    ...
                    for (const l of Array.from(t.keys())) {
                        ...
                        for (let t = o.length; t < a.length; t++) {
                            ...
                            0 === e && 0 === l && s.setGlobalVisibility((0, $.combine)((e, t) => !e && !t, this._hideNotMainSources, this._hideAllExceptFirstLine)), o.push(s), this._renderer.addCustomWidget(s, {
                                block: e,
                                position: l
                            }), i = !0
                        }
                ...
                _availableWidth() {
                    return null === this._size ? 0 : this._size.w - this._margin - Xi
                }
            }
        },
        6313: (e, t, s) => {
        ...
        33480: (e, t, s) => {
            ...
            var i = s(6313),
                l = s(40541);
            class o extends i.LoaderBaseRenderer {
                _renderLoading(e) {
        ...
        42812: (e, t, s) => {
            ...
            class p {
                constructor(e, t, s) {
                    ...
                    this._render(), this._updatePaneControlsWidgetVisibility(), this._updateThemedColor(this._themedColor.value()),
                        this._parentEl.classList.toggle(c.touchMode, h.trackingModeIsAvailable), this._parentEl.addEventListener("contextmenu", e => e.preventDefault())
                }
                destroy() {
                ...
                bottomWithMargin() {
                    const e = this._parentEl.classList.contains(c.touchMode) ? Number(c.css_value_pane_controls_button_touch_size) : Number(c.css_value_pane_controls_button_size);
                ...
                _renderActions() {
                    null === this._listActionsWrapperEl && (this._listActionsWrapperEl = document.createElement("div"), this._listActionsWrapperEl.classList.add(c.buttonsWrapper), this._parentEl.append(this._listActionsWrapperEl));
                    const e = h.trackingModeIsAvailable ? "large" : "small";
                    this._listActionsElements.up = (0, u.createActionElement)(this._actions.up, c.button, c.buttonIcon, _.blockHidden, e), this._listActionsElements.down = (0, u.createActionElement)(this._actions.down, c.button, c.buttonIcon, _.blockHidden, e), this._listActionsElements.collapse = (0, u.createActionElement)(this._actions.collapse, c.button, c.buttonIcon, _.blockHidden, e), this._listActionsElements.restore = (0, u.createActionElement)(this._actions.restore, c.button, c.buttonIcon, _.blockHidden, e), this._listActionsElements.close = (0, u.createActionElement)(this._actions.close, c.button, c.buttonIcon, _.blockHidden, e), this._listActionsElements.maximize = (0, u.createActionElement)(this._actions.maximize, c.button, c.buttonIcon, _.blockHidden, e), this._listActionsElements.minimize = (0, u.createActionElement)(this._actions.minimize, c.button, c.buttonIcon, _.blockHidden, e), this._listActionsWrapperEl.append(this._listActionsElements.up, this._listActionsElements.down, this._listActionsElements.close, this._listActionsElements.collapse, this._listActionsElements.restore, this._listActionsElements.maximize, this._listActionsElements.minimize), this._listActionsElements.more = (0,
                        u.createActionElement)(this._actions.more, c.button, c.buttonIcon, _.blockHidden, e);
                    for (const e of Object.keys(this._listActionsElements))(0, r.ensureNotNull)(this._listActionsElements[e]).classList.add(c.newButton);
                ...
                _updatePaneControlsWidgetVisibility() {
                    ...
                    this._parentEl.classList.toggle(c.hidden, !e), this._parentEl.classList.toggle(c.forceHidden, !this._globalVisibility.value() || t)
                }
                _updateThemedColor(e) {
                    if (e.length > 0) {
                        const [t, s, i] = (0, d.parseRgb)(e);
                        this._parentEl.style.color = (0, d.rgbaToString)([t, s, i, (0, d.normalizeAlphaComponent)(.8)])
            ...
            class K {
                ...
                updateThemedColors(e) {
                    null === e && (e = (0, x.getStdThemedValue)("chartProperties.paneProperties.background", this._backgroundThemeName.value())), this._themedColor.setValue(e || "")
                }
                ...
                _getCloseButtonVisibility() {
                    ...
                    let t = !1;
                    return e.containsMainSeries() || e.maximized().value() || I || (t = e.dataSources().some(e => (0, n.isStudy)(e))), t
                }
                _onCloseButton() {
                ...
                _getUpButtonVisibility() {
                    const e = this._paneWidget.state();
                    return this._model.model().panes().indexOf(e) > 0 && !e.maximized().value() && !I
                }
                _getDownButtonVisibility() {
                    const e = this._paneWidget.state(),
                        t = this._model.model().panes();
                    return t.indexOf(e) < t.length - 1 && !e.maximized().value() && !I
                }
                _onUpDownButton(e) {
                ...
                _getMaximizeButtonVisibility() {
                    const e = this._paneWidget.state();
                    return this._model.model().panes().length > 1 && !e.maximized().value() && !I
                }
                ...
                _showButtonsInContextMenu(e) {
                    e.preventDefault(), this._moreCMShown || function(e, t, s) {
                        ...
                        return g.ContextMenuManager.showMenu(i, {
                            clientX: l.right,
        ...
        37969: (e, t, s) => {
            ...
            const i = s(1227).CheckMobile.any()
        },
        21709: (e, t, s) => {
            "use strict";
            ...
            function i(e, t, s, i, l) {
                ...
                return l.click && i.addEventListener("click", o, !1), l.mouseDown && i.addEventListener("mousedown", o, !1), l.touchEnd && i.addEventListener("touchend", o, !1), l.touchStart && i.addEventListener("touchstart", o, !1), () => {
        ...
        46031: (e, t, s) => {
            ...
            l.Months.JANUARY, (0, i.t)("January"), l.Months.FEBRUARY, (0, i.t)("February"), l.Months.MARCH, (0, i.t)("March"), l.Months.APRIL, (0, i.t)("April"), l.Months.MAY, (0, i.t)("May"), l.Months.JUNE, (0, i.t)("June"), l.Months.JULY, (0, i.t)("July"), l.Months.AUGUST, (0, i.t)("August"), l.Months.SEPTEMBER, (0, i.t)("September"), l.Months.OCTOBER, (0, i.t)("October"), l.Months.NOVEMBER, (0, i.t)("November"), l.Months.DECEMBER, (0, i.t)("December"), l.Months.JANUARY, (0, i.t)("Jan"), l.Months.FEBRUARY, (0, i.t)("Feb"), l.Months.MARCH, (0, i.t)("Mar"),
                l.Months.APRIL, (0, i.t)("Apr"), l.Months.MAY, (0, i.t)("May", {
                    context: "short"
