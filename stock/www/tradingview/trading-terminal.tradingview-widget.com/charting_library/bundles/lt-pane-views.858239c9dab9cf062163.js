(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [1583], {
        ...
        22529: (e, t, i) => {
            ...
            function s(e, t, i = r) {
                let s = n.get(e);
                return void 0 === s && (s = new Promise((e, n) => {
                    const r = new Image;
                    r.onload = () => {
            ...
            class p extends u.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    if (this._points.length >= 5) {
                        ...
                        const n = i(o.add(c).scaled(.5), this._numericFormatter.format(this._xdRetracement));
                        this._xdLabelRenderer.setData(n), t.append(this._xdLabelRenderer), this._bdTrend.setData(a(d, c)), t.append(this._bdTrend)
                    }
                    const g = i(o, "X");
        ...
        35672: (e, t, i) => {
            ...
            class _ extends c.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    const _ = i(a, "A");
                    o.y > a.y ? (_.vertAlign = "bottom", _.offsetY = 5) : (_.vertAlign = "top", _.offsetY = 5), this._textRendererALabel.setData(_), t.append(this._textRendererALabel);
                    const p = i(o, "B");
                    if (o.y < a.y ? (p.vertAlign = "bottom", p.offsetY = 5) : (p.vertAlign = "top", p.offsetY = 5), this._textRendererBLabel.setData(p), t.append(this._textRendererBLabel), this._points.length > 2) {
                        const e = i(d, "C");
        ...
        91435: (e, t, i) => {
            ...
            class _ extends c.ScaledPaneRenderer {
                ...
                hitTest(e) {
                    ...
                    if (l < 1) return l = (0, n.distanceToLine)(i, a, e).distance, l < t ? new h.HitTestResult(h.HitTestResult.MOVEPOINT) : null;
                    ...
                    e = (0, s.transformPoint)(x, e), x = (0, s.rotationMatrix)(-v), e = (0, s.transformPoint)(x, e), p = (0, s.transformPoint)(x, p);
                    const w = 1 - Math.sqrt(3) / 2;
                    if (x = (0, s.scalingMatrix)(1, c * w / l), e = (0, s.transformPoint)(x, e), p = (0, s.transformPoint)(x, p), e.y * p.y < 0) return null;
                    let m;
                    m = e.y < 0 ? new r.Point(.5 * c, c * Math.sqrt(3) / 2) : new r.Point(.5 * c, -c * Math.sqrt(3) / 2);
                ...
                _drawImpl(e) {
                    ...
                    if (this._data.points.length < 3) return e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, e.beginPath(), e.moveTo(t.x, t.y), e.lineTo(i.x, i.y), void e.stroke();
                    let a = this._data.points[2];
                    const o = (0, n.distanceToLine)(t, i, a).distance;
                    if (o < 1) return e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, e.beginPath(), e.moveTo(t.x, t.y), e.lineTo(i.x, i.y), void e.stroke();
                    ...
                    f = (0, s.transformPoint)(v, f), v = (0, s.rotationMatrix)(-g), f = (0, s.transformPoint)(v, f), v = (0, s.scalingMatrix)(1, u / (2 * o)), f = (0, s.transformPoint)(v, f), f.y < 0 ? this._data.clockwise = !0 : this._data.clockwise = !1, e.save(), e.beginPath(), e.translate(t.x, t.y), e.rotate(g);
                    const x = 1 - Math.sqrt(3) / 2;
                    e.scale(1, o / (u * x)), this._data.clockwise ? e.arc(.5 * u, u * Math.sqrt(3) / 2, u, -2 * Math.PI / 3, -Math.PI / 3, !1) : e.arc(.5 * u, -u * Math.sqrt(3) / 2, u, Math.PI / 3, 2 * Math.PI / 3, !1), e.restore(),
                        e.stroke(), this._data.fillBackground && (e.fillStyle = (0, d.generateColor)(this._data.backcolor, this._data.transparency), e.fill())
                }
            }
            class p extends l.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    b = (0, s.transformPoint)(L, b), L = (0, s.rotationMatrix)(-T), b = (0, s.transformPoint)(L, b), L = (0, s.scalingMatrix)(1, m / (2 * g)), b = (0, s.transformPoint)(L, b);
                ...
                draw(e, t) {
                    if (null !== this._data) {
                        switch (e.save(), e.fillStyle = this._data.color, this._data.direction) {
                            ...
                            case "down":
                                ! function(e, t, i, n) {
                                    const r = Math.max(1, Math.floor(n)) % 2 ? .5 : 0,
                                        s = "up" === i ? 1 : -1,
                                        a = s * Math.round(12 * n),
        ...
        42740: (e, t, i) => {
            ...
            class c extends o.ScaledPaneRenderer {
                ...
                _drawImpl(e) {
                    ...
                    }(t.length()), e.beginPath(), e.moveTo(n.x, n.y);
                ...
                _arrowGeometry(e) {
                    const t = h(e),
                        i = [],
                        n = e >= 35 ? .1 : 0;
                    return i.push(new a.Point(0, 0)), i.push(new a.Point(e - t + t * n, 1.22 * t / 4)), i.push(new a.Point(e - t, 1.22 * t / 2)), i.push(new a.Point(e, 0)), i
                }
                _hittestGeometry(e) {
                    const t = h(e),
                        i = [];
            ...
            class p extends n.LineSourcePaneView {
                ...
                renderer(e, t) {
                    ...
                    return this._textRendererData.points && this._textRendererData.points.length > 0 && n.showLabel.value() && (this._textRenderer.setData({ ...this._textRendererData
                ...
                _updateImpl() {
                    ...
                    if (this._arrowRendererData.color = t.backgroundColor.value(), this._arrowRendererData.points = e, this._textRendererData.text = t.text.value(), this._textRendererData.color = t.textColor.value(), this._textRendererData.font = _.CHART_FONT_FAMILY, this._textRendererData.bold = t.bold.value(), this._textRendererData.italic = t.italic.value(), this._textRendererData.fontsize = t.fontsize.value(), e.length >= 2) {
                        ...
                        if (this._drawAsCircle = 0 === n && Math.abs(r) < 1e-8, this._textRendererData.points = [e[0]], this._drawAsCircle) {
                            ...
                            Math.abs(t.x) >= Math.abs(t.y) ? (e[1].x > e[0].x ? this._textRendererData.horzAlign = "right" : this._textRendererData.horzAlign = "left",
                                this._textRendererData.vertAlign = "middle") : (e[1].y > e[0].y ? this._textRendererData.vertAlign = "bottom" : this._textRendererData.vertAlign = "top", this._textRendererData.horzAlign = "center")
                        }
                    }
                }
            }
            ...
            class _ extends c.ScaledPaneRenderer {
                ...
                hitTest(e, t) {
                    ...
                    const i = this._data.points[0].x - (this._geometryCache.paddingLeft + 20),
                        ...
                        r = (0, o.box)(new o.Point(i, n), new o.Point(i + this._geometryCache.innerWidth, n + this._geometryCache.innerHeight));
                    return (0, l.pointInBox)(e, r) ? new u.HitTestResult(u.HitTestResult.MOVEPOINT, {
                ...
                _drawImpl(e, t) {
                    ...
                    e.translate(o, l), e.beginPath(), e.moveTo(24, r), e.lineTo(15, r), e.arcTo(-1e3, 0, 1e3, 0, r / 2), e.lineTo(s - 15, 0), e.arcTo(1e3, r, -1e3, r, r / 2), e.lineTo(33, r), e.quadraticCurveTo(33, r + 4, 35, r + 9), e.quadraticCurveTo(27, r + 6, 24, r), e.fillStyle = this._data.backgroundColor, e.fill(), e.strokeStyle = this._data.borderColor, e.lineWidth = 2, e.stroke(), e.closePath(), e.textBaseline = "middle", e.fillStyle = this._data.color, e.fillText(this._data.label, n + a, r / 2)
                }
                _measureInfo(e, t, i) {
        ...
        92292: (e, t, i) => {
            ...
            class x extends p.LineSourcePaneView {
                constructor() {
                    super(...arguments), this._vertLineRenderer1 = new _.VerticalLineRenderer, this._vertLineRenderer2 = new _.VerticalLineRenderer, this._medianRenderer = new u.TrendLineRenderer, this._renderer = null
                }
                renderer() {
                    return this._invalidated && this._updateImpl(), this._renderer
                }
        ...
        78050: (e, t, i) => {
            ...
            class _ extends s.ScaledPaneRenderer {
                ...
                hitTest(e, t) {
                    ...
                    if (4 === i.points.length) {
                        const t = (0, u.interactionTolerance)().curve,
                            [n, r, s, l] = i.points,
                            d = l.subtract(n),
                            h = s.subtract(d.scaled(.25)),
                            _ = s.add(d.scaled(.25)),
                            p = r.subtract(s),
                            g = l.subtract(p.scaled(.25)),
                            f = l.add(p.scaled(.25));
                        if ((0, o.quadroBezierHitTest)(s, n, h, e, t) || (0, o.cubicBezierHitTest)(s, l, _, g, e, t) || (0, o.quadroBezierHitTest)(l, r, f, e, t)) return new a.HitTestResult(a.HitTestResult.MOVEPOINT);
                ...
                _drawImpl(e, t) {
                    ...
                    e.lineCap = "butt", e.strokeStyle = this._data.color, e.lineWidth = this._data.lineWidth, (0, l.setLineStyle)(e, this._data.lineStyle);
                    const i = this._data.points[0],
                        n = this._data.points[1];
                    if (2 === this._data.points.length) e.beginPath(), e.moveTo(i.x, i.y), e.lineTo(n.x, n.y), e.stroke(), this._data.leftEnd === h.LineEnd.Arrow && (0, d.drawArrow)(n, i, e, e.lineWidth, t.pixelRatio), this._data.rightEnd === h.LineEnd.Arrow && (0, d.drawArrow)(i, n, e, e.lineWidth, t.pixelRatio);
                    else {
                        const r = this._data.points[2],
                            s = this._data.points[3],
                            a = s.subtract(i),
                            o = r.subtract(a.scaled(.25)),
                            l = r.add(a.scaled(.25)),
                            u = n.subtract(r),
                            _ = s.subtract(u.scaled(.25)),
                            p = s.add(u.scaled(.25));
                        this._data.fillBack && this._data.points.length > 2 && (e.fillStyle = this._data.backColor, e.beginPath(), e.moveTo(i.x, i.y), e.quadraticCurveTo(o.x, o.y, r.x, r.y), e.bezierCurveTo(l.x, l.y, _.x, _.y, s.x, s.y), e.quadraticCurveTo(p.x, p.y, n.x, n.y), e.fill()), e.beginPath(), (0, c.buildExtendedSegments)(e, this._data.extendLeftPoints), e.moveTo(i.x, i.y), e.quadraticCurveTo(o.x, o.y, r.x, r.y), e.bezierCurveTo(l.x, l.y, _.x, _.y, s.x, s.y), e.quadraticCurveTo(p.x, p.y, n.x, n.y), (0, c.buildExtendedSegments)(e, this._data.extendRightPoints), e.stroke(), this._data.leftEnd === h.LineEnd.Arrow && (0, d.drawArrow)(o, i, e, e.lineWidth, t.pixelRatio), this._data.rightEnd === h.LineEnd.Arrow && (0, d.drawArrow)(p, n, e, e.lineWidth, t.pixelRatio)
                    }
                }
            }
            var p = i(4547),
            ...
            class v extends r.LineSourcePaneView {
                constructor() {
                    super(...arguments), this._bezierCubicRenderer = new _, this._renderer = null, this._extendedSegmentLeftCache = null, this._extendedSegmentRightCache = null
                }
                renderer(e, t) {
                ...
                _updateImpl(e, t) {
                    ...
                    if (4 === this._source.points().length) {
                        const n = (0, f.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[0])),
                            ...
                            l = (0,
                                f.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[3])),
                            d = l.subtract(n),
                            h = o.subtract(d.scaled(.25)),
                            c = a.subtract(o),
                            u = l.add(c.scaled(.25));
                        i.extendLeft.value() && (r = this._extendSegmentLeft(o, n, h, t, e)), i.extendRight.value() && (s = this._extendSegmentRight(l, a, u, t, e))
                    }
                ...
                _updateImpl(e, t) {
                    ...
                    if (3 === this._source.points().length) {
                        const r = (0, n.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[0])),
                            ...
                            c = l.add(d.scaled(.25));
                        i.extendLeft.value() && (s = this._extendSegmentLeft(l, r, h, t, e)), i.extendRight.value() && (o = this._extendSegmentRight(l, a, c, t, e))
                    }
                    ...
                    const h = {
                        ...
                        fillBack: i.fillBackground.value(),
                        backColor: (0,
                            r.generateColor)(i.backgroundColor.value(), i.transparency.value()),
        ...
        38926: (e, t, i) => {
            ...
            class _ extends r.ScaledPaneRenderer {
                ...
                hitTest(e, t) {
                    if (null !== this._data && 3 === this._data.points.length) {
                        const t = (0, h.interactionTolerance)().curve,
                            ...
                            d = r.add(s.scaled(.25));
                        if ((0, l.quadroBezierHitTest)(r, i, a, e, t) || (0, l.quadroBezierHitTest)(r, n, d, e, t)) return new o.HitTestResult(o.HitTestResult.MOVEPOINT);
                ...
                _drawImpl(e, t) {
                    ...
                    if (e.lineCap = "butt", e.strokeStyle = this._data.color, e.lineWidth = this._data.lineWidth, (0, a.setLineStyle)(e, this._data.lineStyle), 2 === this._data.points.length) e.beginPath(), e.moveTo(i.x, i.y), e.lineTo(n.x, n.y), e.stroke();
                    else {
                        const a = n.subtract(i),
                            o = r.subtract(a.scaled(.25)),
                            l = r.add(a.scaled(.25));
                        this._data.fillBack && this._data.points.length > 2 && (e.fillStyle = this._data.backColor, e.beginPath(), e.moveTo(i.x, i.y), e.quadraticCurveTo(o.x, o.y, r.x, r.y), e.quadraticCurveTo(l.x, l.y, n.x, n.y), e.fill()), e.beginPath(), u(e, this._data.extendLeftSegments), e.moveTo(i.x, i.y), e.quadraticCurveTo(o.x, o.y, r.x, r.y), e.quadraticCurveTo(l.x, l.y, n.x, n.y), u(e, this._data.extendRightSegments), e.stroke(), this._data.leftEnd === s.LineEnd.Arrow && (0, d.drawArrow)(o, i, e, e.lineWidth, t.pixelRatio), this._data.rightEnd === s.LineEnd.Arrow && (0, d.drawArrow)(l, n, e, e.lineWidth, t.pixelRatio)
                    }
                }
            }
        },
        5470: (e, t, i) => {
            ...
            class d extends l.LineSourcePaneView {
                constructor() {
                    super(...arguments), this._polygonRenderer = new r.PolygonRenderer,
                ...
                _updateImpl() {
                    ...
                    if (this._polygonRenderer.setData(n), this._renderer = new a.CompositeRenderer, this._renderer.append(this._polygonRenderer), this._source.finished()) {
        ...
        30633: (e, t, i) => {
            "use strict";
            var n, r = i(86441).Point,
                s = i(74173).LineSourcePaneView,
                a = i(91084).HitTestResult,
                o = i(91084).AreaName,
                l = i(4547).CompositeRenderer,
                d = i(76036),
                h = i(57147).CalloutConsts,
                c = i(69639).calcTextHorizontalShift,
                u = i(34581).isRtl,
                _ = i(40778).ScaledPaneRenderer,
                p = i(66425);
            class g extends _ {
                constructor(e) {
                ...
                wordWrap(e, t) {
                    var i;
                    n || ((i = document.createElement("canvas")).width = 0, i.height = 0, n = i.getContext("2d"), i = null), t = +t;
                    var r = (e += "").split(/[^\S\r\n]*(?:\r\n|\r|\n|$)/);
                ...
                hitTest(e) {
                    ...
                    return e.x >= n && e.x <= n + this._textSizeCache.totalWidth && e.y >= r && e.y <= r + this._textSizeCache.totalHeight ? new a(a.MOVEPOINT, {
                        areaName: o.Text
                    }) : null
                }
                fontStyle() {
                ...
                _drawImpl(e) {
                    if (!(null === this._data || this._data.points.length < 2)) {
                        ...
                        var n = this._data.fontSize * this._data.lines.length,
                            r = this._data.wordWrapWidth || this._data.lines.reduce((function(t, i) {
                        ...
                        var x = c(e, r);
                        t.x > _ + o ? g = 20 : t.x > _ && (g = 10), t.y > p + l ? g += 2 : t.y > p && (g += 1), e.save(), e.translate(_, p), t.x -= _, t.y -= p, i.x -= _, i.y -= p, e.beginPath(), e.moveTo(s, 0), 10 === g ? f ? (e.lineTo(i.x - s, 0), e.lineTo(t.x, t.y), e.lineTo(i.x + s, 0), e.lineTo(o - s, 0)) : (e.lineTo(t.x, t.y), e.lineTo(o - s, 0)) : e.lineTo(o - s, 0), 20 === g ? (e.lineTo(t.x, t.y), e.lineTo(o, s)) : e.arcTo(o, 0, o, s, s), 21 === g ? v ? (e.lineTo(o, i.y - s), e.lineTo(t.x, t.y), e.lineTo(o, i.y + s), e.lineTo(o, l - s)) : (e.lineTo(t.x, t.y), e.lineTo(o, l - s)) : e.lineTo(o, l - s), 22 === g ? (e.lineTo(t.x, t.y), e.lineTo(o - s, l)) : e.arcTo(o, l, o - s, l, s), 12 === g ? f ? (e.lineTo(i.x + s, l), e.lineTo(t.x, t.y), e.lineTo(i.x - s, l), e.lineTo(s, l)) : (e.lineTo(t.x, t.y), e.lineTo(s, l)) : e.lineTo(s, l), 2 === g ? (e.lineTo(t.x, t.y), e.lineTo(0, l - s)) : e.arcTo(0, l, 0, l - s, s), 1 === g ? v ? (e.lineTo(0, i.y + s), e.lineTo(t.x, t.y), e.lineTo(0, i.y - s), e.lineTo(0, s)) : (e.lineTo(t.x, t.y), e.lineTo(0, s)) : e.lineTo(0, s), 0 === g ? (e.lineTo(t.x, t.y), e.lineTo(s, 0)) : e.arcTo(0, 0, s, 0, s), e.stroke(), e.fillStyle = d.generateColor(this._data.backcolor, this._data.transparency), e.fill(), e.fillStyle = this._data.color, p = s + a + this._data.fontSize, _ = s + a + x;
                        for (var w = 0; w < this._data.lines.length; w++) e.fillText(this._data.lines[w], _, p), p += this._data.fontSize;
                        e.restore()
                    }
                }
            }
            t.CalloutPaneView = class extends s {
                constructor(e, t) {
                    super(e, t), this._textSizeCache = {}, this._calloutRenderer = new g(this._textSizeCache), this._renderer = null
                }
                _updateImpl() {
                    if (super._updateImpl(), this._source._calculatePoint2(), this._renderer = null,
        ...
        43905: (e, t, i) => {
            "use strict";
            var n = i(86441).Point,
                r = i(74173).LineSourcePaneView,
                s = i(3847).VerticalLineRenderer,
                a = i(86734).TrendLineRenderer,
                o = i(91084).HitTestResult,
                l = i(4547).CompositeRenderer,
                d = i(6605).LineEnd;
                    ...
                    if (super._updateImpl(), this._renderer = null, !(this._source.points().length < 2)) {
                        ...
                        if (this._source.priceScale() && !this._source.priceScale().isEmpty() && !e.isEmpty()) {
                            ...
                            if (this._lines = [], 0 !== r) {
                                ...
                                if (r > 0)
                                    for (var h = t.index; h <= a.lastBar(); h += r) this._lines.push({
                                        x: e.indexToCoordinate(h)
                                    });
                                else
                                    for (h = t.index; h >= a.firstBar(); h += r) this._lines.push({
                                        x: e.indexToCoordinate(h)
                                    });
        ...
        63741: (e, t, i) => {
            ...
            class h {
                ...
                draw(e, t) {
                    ...
                    e.strokeStyle = s, e.lineWidth = p, e.beginPath(), e.moveTo(c + f, u), e.arc(c, u, f, 0, 2 * Math.PI, !1), e.stroke(), e.restore()
                }
                hitTest(e, t) {
                    if (null === this._data) return null;
                    const {
                        center: i,
                        radius: n
                    } = this._data, r = (0, d.interactionTolerance)().curve;
                    if (!(0, l.pointInCircle)(e, i, n + r)) return null;
                    const s = n > r && (0, l.pointInCircle)(e, i, n - r) ? o.HitTestResult.MOVEPOINT_BACKGROUND : o.HitTestResult.MOVEPOINT;
        ...
        16130: (e, t, i) => {
            ...
            class l extends n.LineSourcePaneView {
                constructor(e, t) {
                    super(e, t), this._renderer = null, this._horizLineRenderer = new r.HorizontalLineRenderer, this._vertLineRenderer = new s.VerticalLineRenderer, this._horizLineRenderer.setHitTest(new o.HitTestResult(o.HitTestResult.MOVEPOINT))
                }
                update() {
                    this._invalidated = !0
                }
                ...
                _updateImpl() {
                    ...
                    })), this._vertLineRenderer.setData(t), this._vertLineRenderer.setHitTest(new o.HitTestResult(o.HitTestResult.MOVEPOINT, {
        ...
        82295: (e, t, i) => {
            ...
            class b extends o.LineSourcePaneView {
                ...
                _updateImpl(e, t) {
                    ...
                    O && O !== this._lastSymbolInfo && (this._pipFormatter = new f.PipFormatter(O.pricescale, O.minmov, O.type, O.minmove2), this._lastSymbolInfo = O);
                    const z = (0, n.ensureNotNull)(this._source.ownerSource()).formatter().format(M) + " (" + m.format(Math.round(100 * C) / 100) + ") " + (this._pipFormatter ? this._pipFormatter.format(M) : "");
                    let H = (0, a.forceLTRStr)(z) + "\n" + y.format({
                        count: k
                    }) + B;
                    const V = this._source.volume();
                    let W;
                    Number.isNaN(V) || (H += `\n${T} ${R.format(V)}`), W = S > P ? new r.Point(.5 * (o.x + d.x), d.y - 2 * s.fontsize.value()) : new r.Point(.5 * (o.x + d.x), d.y + .7 * s.fontsize.value());
                    const F = {
                            x: 0,
                            y: 10
                        },
                        ...
                        j = {
                            ...
                            fontsize: Y,
                            backgroundRoundRect: 4,
                            backgroundHorzInflate: .4 * Y,
                            backgroundVertInflate: .2 * Y
                        };
                    (null === (i = s.fillLabelBackground) || void 0 === i ? void 0 : i.value()) && (j.boxShadow = {
                        shadowColor: s.shadow.value(),
                        shadowBlur: 4,
                        shadowOffsetY: 1
                    }, j.backgroundColor = s.labelBackgroundColor.value()), this._textRenderer.setData(j);
        ...
        39722: (e, t, i) => {
            ...
            class w extends a.LineSourcePaneView {
                constructor() {
                    super(...arguments), this._leftBorderRenderer = new d.TrendLineRenderer, this._rightBorderRenderer = new d.TrendLineRenderer, this._distancePriceRenderer = new d.TrendLineRenderer, this._backgroundRenderer = new l.RectangleRenderer, this._textRenderer = new o.TextRenderer, this._renderer = new h.CompositeRenderer
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(e, t), this._renderer
                }
                _updateImpl(e, t) {
                    ...
                    m(this._leftBorderRenderer, new n.Point(d.x, p), new n.Point(d.x, w)), m(this._rightBorderRenderer, new n.Point(h.x, p), new n.Point(h.x, w));
                    ...
                    (null === (i = r.fillLabelBackground) || void 0 === i ? void 0 : i.value()) && (E.boxShadow = {
                        shadowColor: r.shadow.value(),
                        shadowBlur: 4,
                        shadowOffsetY: 1
                    }, E.backgroundColor = r.labelBackgroundColor.value()), this._textRenderer.setData(E);
        ...
        32677: (e, t, i) => {
            "use strict";
            var n = i(50536).DisjointChannelRenderer,
                r = i(86734).TrendLineRenderer,
                s = i(45916).TextRenderer,
                a = i(4547).CompositeRenderer,
                o = i(28303).PaneCursorType,
                l = i(66425),
                d = i(51515).AlertableLineSourcePaneView,
                h = [o.Default, o.Default, o.VerticalResize, o.Default];
            t.DisjointChannelPaneView = class extends d {
                constructor(e, t) {
                    super(e, t), this._label = null, this._trendLineRendererPoints12 = new r, this._trendLineRendererPoints43 = new r, this._disjointChannelRenderer = new n, this._p1LabelRenderer = new s, this._p2LabelRenderer = new s, this._p3LabelRenderer = new s, this._p4LabelRenderer = new s, this._renderer = null
                }
                _updateImpl() {
                    if (super._updateImpl(), this._renderer = null, this._label = null, !(this._source.points().length < 2) && this._source.priceScale()) {
                        ...
                        if (!(this._points.length < 2)) {
                            ...
                            if (this._trendLineRendererPoints12.setData(x(e, t)), o.append(this._trendLineRendererPoints12), m(this._p1LabelRenderer, this._p2LabelRenderer, e, t, this._price1, this._price2), 2 === this._points.length) return this.addAnchors(o), void(this._renderer = o);
                            this._trendLineRendererPoints43.setData(x(s, n)), o.append(this._trendLineRendererPoints43), m(this._p3LabelRenderer, this._p4LabelRenderer, n, s, this._price3, this._price4);
                            var R = [e, t, n, s];
        ...
        97839: (e, t, i) => {
            ...
            class f extends p.ScaledPaneRenderer {
                ...
                hitTest(e) {
                    ...
                    v = (0, c.rotationMatrix)(-f), e = (0, c.transformPoint)(v, e), x = (0, c.transformPoint)(v, x), v = (0, c.scalingMatrix)(1, h / (2 * a)), e = (0, c.transformPoint)(v, e), x = (0, c.transformPoint)(v, x);
                    const w = e.length(),
                        m = (0, g.interactionTolerance)().curve;
                    return Math.abs(w - .5 * h) <= m ? new _.HitTestResult(_.HitTestResult.MOVEPOINT) : this._data.fillBackground && !this._data.noHitTestOnBackground && w <= .5 * h ? new _.HitTestResult(_.HitTestResult.MOVEPOINT_BACKGROUND) : null
                }
                _drawImpl(e) {
                    if (null === this._data || this._data.points.length < 2) return;
                    const t = this._data.points[0],
                    ...
                    let s = this._data.points[2];
                    const a = (0, n.distanceToLine)(t, i, s).distance;
                    if (a < 1) return e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, e.beginPath(), e.moveTo(t.x, t.y), e.lineTo(i.x, i.y), void e.stroke();
                    ...
                    f = (0, c.transformPoint)(v, f), v = (0, c.rotationMatrix)(-g), f = (0, c.transformPoint)(v, f), v = (0, c.scalingMatrix)(1, h / (2 * a)), f = (0, c.transformPoint)(v, f), f.y < 0 ? this._data.clockwise = !0 : this._data.clockwise = !1, e.save(), e.beginPath(), e.translate(l.x, l.y), e.rotate(g), e.scale(1, 2 * a / h), e.arc(0, 0, .5 * h, this._data.angleFrom, this._data.angleTo, this._data.clockwise), e.restore(), e.stroke(), this._data.fillBackground && (e.fillStyle = (0, u.generateColor)(this._data.backcolor, this._data.transparency), e.fill())
                }
            }
            class v extends h.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    m.data = 3, t.showLabel.value() && (null === (e = t.text) || void 0 === e ? void 0 : e.value()) && this._updateTextRenderer(v, x, w, m) && s.append(this._textRenderer);
                ...
                _updateTextRenderer(e, t, i, n) {
                    ...
                    const {
                        ...
                        bold: c,
                        italic: u
                    } = this._source.properties().childs(), _ = Math.sqrt(2), p = {
                        points: [o],
                        text: l.value(),
                        color: d.value(),
                        fontSize: h.value(),
        ...
        40364: (e, t, i) => {
            ...
            class l extends o {
                ...
                _drawArrow(e, t, i) {
                    ...
                    e.translate(t - 2, i), "buy" !== r && (e.rotate(Math.PI), e.translate(-4, 0)), CanvasEx.drawArrow(e, 0, 0, 0, n, 4), e.restore()
                }
                _drawText(e, t, i) {
                ...
                _drawImpl(e, t) {
                    ...
                    if (0 !== r) {
                        ...
                        this._drawText(e, Math.round(i + .5 - r / 2), d)
                    }
                }
                hitTest(e) {
                    var t, i, n = Math.round(this._data.points[0].x),
                        r = Math.round(this._data.points[0].y),
                        s = this._adapter.getArrowHeight();
                    if ("buy" === this._adapter.getDirection() ? (t = r, i = r + s) : (t = r - s, i = r), e.x >= n - 2 && e.x <= n + 2 && e.y >= t && e.y <= i) {
            ...
            class d extends r {
                ...
                renderer(e, t) {
                    ...
                    var s = i._adapter,
                        ...
                        o = this._source._model.paneForSource(this._source).executionsPositionController().getXYCoordinate(s, a, r[0].index);
                    if (!isFinite(o.y) || o.y < 0 || o.y > e || o.x < 0) return this._renderer = null, null;
                    var d = {
                        points: [new n(o.x, o.y)]
                    };
            ...
            class c extends d.LineToolPaneViewFibWithLabels {
                ...
                _updateImpl() {
                    ...
                    if (this._points.length < 3) {
                        ...
                        return this._baseLineRenderer.setData(e), r.append(this._baseLineRenderer), this.addAnchors(r), void(this._renderer = r)
                    }
        ...
        27761: (e, t, i) => {
            ...
            var s = i(86734).TrendLineRenderer,
                a = i(91084).HitTestResult,
                o = i(4547).CompositeRenderer,
                l = i(69611).EllipseRendererSimple,
                d = i(6605).LineEnd;
                        ...
                        for (var s = this._source.properties(), h = this._source.levelsCount(), c = 1; c <= h; c++) {
                            ...
                            if (u.visible.value()) {
                                var _ = u.coeff.value(),
                                    p = u.color.value(),
                                    g = [];
                                g.push(new n(this._center.x - .5 * i * _, this._center.y - .5 * r * _)), g.push(new n(this._center.x + .5 * i * _, this._center.y + .5 * r * _));
                                var f = new n(this._center.x, this._center.y + .5 * r * _);
                                this._levels.push({
                                    color: p,
                                    points: g,
                                    labelPoint: f,
                        ...
                        if (!(this._points.length < 2)) {
                            ...
                            for (c = 0; c < this._levels.length; c++) {
                                var m = this._levels[c],
                                    R = {};
                                R.points = m.points, R.color = m.color, R.linewidth = m.linewidth, R.backcolor = m.color,
                                    c > 0 && (R.wholePoints = this._levels[c - 1].points), R.fillBackground = x, R.transparency = w;
        ...
        25841: (e, t, i) => {
            ...
            class u extends c.LineToolPaneViewFibWithLabels {
                constructor(e, t) {
                    super(e, t), this._trendLineRenderer = new s.TrendLineRenderer, this._renderer = new l.CompositeRenderer, this._levels = [], this._labelsRenderers = new Array(e.levelsCount()).fill(null).map(() => new a.TextRenderer)
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(e, t), this._renderer
                }
                _updateImpl(e, t) {
                    ...
                    if (null == l) return;
                    const [c, u] = this._source.points(), _ = this._source.properties().childs(), p = _.reverse.value();
                    ...
                    for (let i = 0; i < this._levels.length; i++) {
                        ...
                        if (b) {
                            ...
                            l.setData(n), l.setHitTest(new o.HitTestResult(o.HitTestResult.MOVEPOINT, {
                                snappingPrice: this._levels[i].price
                            }, this._levels[i].index)), this._renderer.append(l)
                        } {
        ...
        7368: (e, t, i) => {
            "use strict";
            i.r(t), i.d(t, {
                FibSpeedResistanceArcsPaneView: () => p
            });
            var n = i(86441),
                r = i(97280),
                s = i(91084),
            ...
            class u extends c.ScaledPaneRenderer {
                ...
                _drawImpl(e) {
                    const t = this._data;
                    null !== t && (e.lineCap = "butt", e.strokeStyle = t.color, e.lineWidth = t.linewidth, e.translate(t.center.x, t.center.y), e.beginPath(), t.fullCircles ? e.arc(0, 0, t.radius, 2 * Math.PI, 0, !1) : t.dir > 0 ? e.arc(0, 0, t.radius, 0, Math.PI, !1) : e.arc(0, 0, t.radius, Math.PI, 0, !1), e.stroke(), t.fillBackground && (t.radius2 && (t.fullCircles ? e.arc(0, 0, t.radius2, 2 * Math.PI, 0, !0) : t.dir > 0 ? e.arc(0, 0, t.radius2, Math.PI, 0, !0) : e.arc(0, 0, t.radius2, 0, Math.PI, !0)), e.fillStyle = (0, d.generateColor)(t.color, t.transparency, !0), e.fill()))
                }
            }
            var _ = i(27206);
        ...
        52698: (e, t, i) => {
            "use strict";
            i.r(t), i.d(t, {
                FibSpeedResistanceFanPaneView: () => p
            });
            var n = i(88537),
                r = i(86441),
                s = i(8329),
                    ...
                    for (let e = 0; e < g.length; e++) {
                        ...
                        if (e > 0 && N) {
                            ...
                            const i = {
                                ...
                                n = new c.TrendLineRenderer;
                            n.setData(i), n.setHitTest(new a.HitTestResult(a.HitTestResult.MOVEPOINT, void 0, {
                                type: "h",
                                index: g[e].index
                            })), R.append(n)
                        }
        ...
        69864: (e, t, i) => {
            ...
            class u extends h.ScaledPaneRenderer {
                ...
                hitTest(e) {
                    ...
                    for (let e = 0; e < 4; e++) {
                        const t = h * o / (.5 * Math.PI);
                        let n = this._continiusFib(t + 4 * e);
                        if (null !== n && (n = n * i.length() / 5, Math.abs(n - c) < u)) return new l.HitTestResult(l.HitTestResult.MOVEPOINT)
                    }
                    return null
                }
                _drawImpl(e) {
                    ...
                    n = n.normalized();
                    let s = Math.acos(n.x);
                    Math.asin(n.y) < 0 && (s = 2 * Math.PI - s), e.rotate(s), e.scale(r / 5, r / 5), e.lineWidth = this._data.linewidth, (0, o.setLineStyle)(e, this._data.linestyle);
                    const a = Math.PI / 100;
                    e.moveTo(0, 0);
        ...
        38113: (e, t, i) => {
            ...
            var n = i(86441).Point,
                r = i(74173).LineSourcePaneView,
                s = i(3847).VerticalLineRenderer,
                a = i(45916).TextRenderer,
                o = i(35836).RectangleRenderer,
                l = i(86734).TrendLineRenderer,
                d = i(91084).HitTestResult,
                h = i(4547).CompositeRenderer,
                c = i(6605).LineEnd,
                u = i(66425);
                        ...
                        if (null !== this._model.timeScale().visibleBarsStrictRange()) {
                            ...
                            for (var r = x ? x.index - e.index : 1, l = 1; l <= 11; l++) {
                                ...
                                if (_.visible.value()) {
                                    ...
                                    t.showLabels.value() && (g.text = _.coeff.value(), g.y = this._source.priceScale().height()), this._levels.push(g)
                                }
                            }
                            var f = new h;
                            if ((t = this._source.properties()).fillBackground.value())
                                for (l = 1; l < this._levels.length; l++) {
                                    var v = this._levels[l - 1],
                                        ...
                                        w = {};
                                    w.points = [e, x], w.color = this._levels[l].color, w.linewidth = 0, w.backcolor = this._levels[l].color, w.fillBackground = !0, w.transparency = t.transparency.value(), w.extendLeft = !1, w.extendRight = !1, (R = new o(void 0, void 0, !0)).setData(w), f.append(R)
                                }
                            for (l = 0; l < this._levels.length; l++) {
                                var m = {};
                                m.x = this._levels[l].x, m.color = this._levels[l].color, m.linewidth = this._levels[l].width, m.linestyle = this._levels[l].style;
                                var R, y = new d(d.MOVEPOINT, null, this._levels[l].index);
                                if ((R = new s).setData(m), R.setHitTest(y), f.append(R), void 0 !== this._levels[l].text) {
                                    var T, b = t.horzLabelsAlign.value();
                                    switch (b = "left" === b ? "right" : "right" === b ? "left" : "center", t.vertLabelsAlign.value()) {
                                        case "top":
                                            T = new n(this._levels[l].x, 0);
                                            break;
                                        case "middle":
                                            T = new n(this._levels[l].x, .5 * this._levels[l].y);
                                            break;
                                        case "bottom":
        ...
        91199: (e, t, i) => {
            ...
            var r = i(86441).Point,
                s = i(86734).TrendLineRenderer,
                a = i(91084).HitTestResult,
                o = i(4547).CompositeRenderer,
                l = i(4044).ArcWedgeRenderer,
                d = i(6605).LineEnd;
            t.FibWedgePaneView = class extends n {
                        ...
                        for (var c = this._source.properties(), u = 1; u <= this._source.levelsCount(); u++) {
                            ...
                            if (_.visible.value()) {
                                var p = _.coeff.value(),
                                    ...
                                    v = s.add(a).scaled(.5).normalized().scaled(f),
                                    x = t.add(v);
                                this._levels.push({
                                    coeff: p,
                                    color: g,
                ...
                _updateRenderer() {
                    if (!((v = this._points).length < 2)) {
                        ...
                        if (this._baseTrendRenderer.setData(r), e.append(this._baseTrendRenderer), v.length < 3) return this.addAnchors(e), void(this._renderer = e);
                        var s = v[2],
                            h = s.data,
                            c = n.subtract(i).length(),
                            u = s.subtract(i).normalized();
                        (s = i.add(u.scaled(c))).data = h, r = {
                            points: [i, s],
                            width: this._model.timeScale().width(),
                            height: this._source.priceScale().height(),
                            color: t.trendline.color.value(),
                        ...
                        for (var _ = this._levels.length - 1; _ >= 0; _--) {
                            var p = this._levels[_],
                                g = {};
                            g.center = this._points[0], g.radius = p.radius, g.prevRadius = _ > 0 ? this._levels[_ - 1].radius : 0, g.edge = this._edge, g.color = p.color, g.linewidth = p.linewidth, g.edge1 = this._edge1, g.edge2 = this._edge2, g.p1 = p.p1, g.p2 = p.p2, g.fillBackground = t.fillBackground.value(), g.transparency = t.transparency.value();
                            var f = new l;
                        ...
                        var v = [i, n];
                        this._model.lineBeingCreated() !== this._source && v.push(s), e.append(this.createLineAnchor({
                            points: v
                        }, 0)), this._renderer = e
                    }
                }
        ...
        33344: (e, t, i) => {
            ...
            var n = i(50536).DisjointChannelRenderer,
                ...
                a = i(4547).CompositeRenderer,
                o = i(66425),
                l = i(51515).AlertableLineSourcePaneView;
            t.FlatBottomPaneView = class extends l {
                constructor(e, t) {
                    super(e, t), this._label1 = null, this._label2 = null, this._trendLineRendererPoints12 = new r, this._trendLineRendererPoints43 = new r, this._disjointChannelRenderer = new n, this._p1LabelRenderer = new s, this._p2LabelRenderer = new s, this._p3LabelRenderer = new s, this._p4LabelRenderer = new s, this._renderer = null
                }
                _updateImpl() {
        ...
        8229: (e, t, i) => {
            ...
            class o extends a.ScaledPaneRenderer {
                ...
                _drawImpl(e) {
                    if (null === this._data) return;
                    e.lineCap = "butt", e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, e.translate(this._data.center.x, this._data.center.y);
                    const t = this._data.edge.subtract(this._data.center),
                        i = t.y / t.x;
                    ...
                    Math.abs(a) > d && (e.rect(0, 0, d, d), e.clip()), this._data.fillBack && (this._data.point.x < this._data.center.x && (a = -a, l = -l), e.beginPath(), e.moveTo(l, 0), e.lineTo(a, 0), e.arcTo(a, a, 0, a, Math.abs(a)), e.lineTo(0, l), e.arcTo(l, l, l, 0, Math.abs(l)), e.fillStyle = (0, r.generateColor)(this._data.color, this._data.transparency, !0), e.fill()), e.beginPath(), this._data.point.x > this._data.center.x ? e.arc(0, 0, Math.abs(a), 0, Math.PI / 2, !1) : e.arc(0, 0, Math.abs(a), -Math.PI / 2, -Math.PI, !0), e.scale(1, 1 / i), e.stroke()
                }
            }
        },
        63639: (e, t, i) => {
            ...
            class u extends r.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    const _ = [i, n];
                    c.lineBeingCreated() === r && _.pop(), e.append(this.createLineAnchor({
                        points: _
                    }, 0)), this._renderer = e
                }
                _initRenderers() {
                ...
                _prepareLabels(e, t) {
                    ...
                    p.horzAlign = h > 0 ? "right" : "left", p.vertAlign = d > 0 ? "bottom" : "top", p.offsetX = 10, p.offsetY = d > 0 ? 8 : 10, p.forceTextAlign = !0, this._priceDiffTextRenderer.setData(p), e.append(this._priceDiffTextRenderer);
                ...
                _updateImpl() {
                    ...
                    for (let e = 1; e <= 9; e++) {
                        ...
                        const s = r.coeff1.value(),
                            ...
                            d = s + "/" + a;
                        let c, p;
                        s > a ? (c = i.x, p = t.y + _ / o) : (c = t.x + u * o, p = i.y), h.push({
                            label: d,
                            color: l,
                            x: c,
                            y: p,
                    ...
                    for (let e = 0; e < h.length; e++) {
                        ...
                        if (f)
                            ...
                            s.setData(n), s.setHitTest(new r.HitTestResult(r.HitTestResult.MOVEPOINT, void 0, h[e].index)), g.append(s)
                        }
        ...
        31425: (e, t, i) => {
            ...
            class h extends r.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    const f = [l, s[1]];
                    p.lineBeingCreated() === e && f.pop(), o.append(this.createLineAnchor({
                        points: f
                    }, 0)), this._renderer = o
                }
                _initRenderers() {
        ...
        63871: (e, t, i) => {
            ...
            var n = i(86441).Point,
                r = i(74173).LineSourcePaneView,
                s = i(45916).TextRenderer,
                a = i(35836).RectangleRenderer,
                o = i(86734).TrendLineRenderer,
                l = i(4547).CompositeRenderer,
                d = i(8329).NumericFormatter,
                h = i(6605).LineEnd,
                c = i(66425);
            t.GannSquarePaneView = class extends r {
                ...
                _updateImpl() {
                    if (super._updateImpl(), this._renderer = null, !(this._source.points().length < 2) && this._source.priceScale() && !this._source.priceScale().isEmpty() && !this._model.timeScale().isEmpty()) {
                        ...
                        this._hlevels = [];
                        for (var r = i ? e.price - t.price : t.price - e.price, d = i ? t.price : e.price, u = this._source.ownerSource().firstValue(), _ = 1; _ <= 7; _++) {
                        ...
                        for (_ = 0; _ < this._hlevels.length; _++) {
                            if (_ > 0 && C) {
                                ...
                                (O = {}).points = [e, t], O.color = this._hlevels[_].color, O.linewidth = 0, O.backcolor = this._hlevels[_].color, O.fillBackground = !0, O.transparency = I, O.extendLeft = !1, O.extendRight = !1, (H = new a(void 0, void 0, !0)).setData(O), T.append(H)
                            }
                            var D = {
                        ...
                        for (_ = 0; _ < this._vlevels.length; _++) {
                            ...
                            if (_ > 0 && N) {
                                k = this._vlevels[_ - 1];
                                var O, z = new n(k.x, L);
                                (O = {}).points = [z, t], O.color = this._vlevels[_].color, O.linewidth = 0, O.backcolor = this._vlevels[_].color, O.fillBackground = !0, O.transparency = A, O.extendLeft = !1, O.extendRight = !1, (H = new a(void 0, void 0, !0)).setData(O), T.append(H)
                            }
                            var H;
                            D = {
                                points: [e, t],
            ...
            class g extends u.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    if (this._polyLineRenderer.setData(m), v.append(this._polyLineRenderer), this._points.length >= 5) {
                        ...
                        d.extendleft = r, d.extendright = a, this._trendLineRenderer.setData(d), v.append(this._trendLineRenderer);
                        const u = w(o, l, c);
                    ...
                    if (this._points.length >= 2) {
                        ...
                        a.y < i.y ? (e.vertAlign = "bottom", e.offsetY = 5) : (e.vertAlign = "top", e.offsetY = 5), this._leftShoulderLabelRenderer.setData(e), v.append(this._leftShoulderLabelRenderer)
                    }
                    if (this._points.length >= 4) {
                        const e = x(l, p.head);
                        l.y < o.y ? (e.vertAlign = "bottom", e.offsetY = 5) : (e.vertAlign = "top", e.offsetY = 5), this._headLabelRenderer.setData(e), v.append(this._headLabelRenderer)
                    }
                    if (this._points.length >= 6) {
                        const e = x(u, p.rightShoulder);
                        u.y < c.y ? (e.vertAlign = "bottom", e.offsetY = 5) : (e.vertAlign = "top", e.offsetY = 5), this._rightShoulderLabelRenderer.setData(e), v.append(this._rightShoulderLabelRenderer)
                    }
                    this.addAnchors(v), this._renderer = v
                }
            }
        ...
        36679: (e, t, i) => {
            ...
            class u extends h.AlertableLineSourcePaneView {
                constructor(e, t) {
                    super(e, t), this._renderer = null, this._labelRenderer = new a.TextRenderer, this._lineRenderer = new o.HorizontalLineRenderer, this._lineRenderer.setHitTest(new r.HitTestResult(r.HitTestResult.MOVEPOINT))
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(e, t), this._renderer
                }
                _updateImpl(e, t) {
                    ...
                    this._lineRenderer.setData(a), this._lineRenderer.setHitTest(new r.HitTestResult(r.HitTestResult.MOVEPOINT, {
                        snappingPrice: this._source.points()[0].price
                    }));
                    const o = a.linewidth / 2 + 1;
                    let h = a.y < -o || a.y > e + o;
                    if (s.append(this._lineRenderer), i.showLabel.value() && 1 === this._points.length && i.text.value().length > 0) {
                        const r = i.vertLabelsAlign.value(),
                            a = i.horzLabelsAlign.value();
                        let o = 0,
                            l = 0;
                        "left" === a ? l = 3 : "right" === a ? (l = this._model.timeScale().width(), o = 3) : l = this._model.timeScale().width() / 2;
                        const c = {
                        ...
                        this._labelRenderer.setData(c), s.append(this._labelRenderer), h = h && this._labelRenderer.isOutOfScreen(t, e)
                    }
                    if (!h) {
        ...
        69052: (e, t, i) => {
            ...
            class u {
                ...
                draw(e, t) {
                    ...
                    e.lineCap = "butt", e.strokeStyle = this._data.color, e.lineWidth = Math.max(1, Math.floor(this._data.linewidth * i)), void 0 !== this._data.linestyle && (0, d.setLineStyle)(e, this._data.linestyle), (0, h.drawHorizontalLine)(e, Math.round(r * i), Math.round(s * i), Math.round(a * i))
                }
                hitTest(e) {
                    if (null === this._data || 0 === this._data.points.length) return null;
            ...
            class _ extends l.AlertableLineSourcePaneView {
                constructor(e, t) {
                    super(e, t), this._horzRayRenderer = new u, this._labelRenderer = new s.TextRenderer, this._renderer = null, this._horzRayRenderer = new u, this._labelRenderer = new s.TextRenderer, this._renderer = null
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(e, t), this._renderer
                }
                _updateImpl(e, t) {
                    ...
                    this.addAnchors(s), 1 === this._points.length && this._addAlertRenderer(s, [l.points[0]]),
                        this._renderer = s
                }
            }
        },
            ...
            class f extends _.ScaledPaneRenderer {
                ...
                hitTest(e, t) {
                    ...
                    const {
                        ...
                        angle: s,
                        point: a
                    } = this._data, o = 65536 * i + n, l = this._cache[o] + 30, d = n + 30, h = (0, r.rotationMatrix)(-s), c = (0, r.transformPoint)(h, e.subtract(a));
                    return Math.abs(c.y) <= l / 2 && Math.abs(c.x) <= d / 2 ? new p.HitTestResult(p.HitTestResult.MOVEPOINT) : null
                }
                _drawImpl(e, t) {
                    if (null === this._data) return;
                    const {
                        ...
                        background: o,
                        selected: l
                    } = this._data, d = String.fromCharCode(n);
                    e.font = i + "px FontAwesome";
                    const h = e.measureText(d).width;
                    e.textBaseline = "middle", e.translate(r.x, r.y), e.rotate(s - Math.PI / 2), e.textAlign = (0, c.isRtl)() ? "right" : "left";
                    const _ = (0, u.calcTextHorizontalShift)(e, h),
                        p = 65536 * n + i;
                    if (this._cache[p] = h, l) {
                        const t = h + 30,
                            n = i + 30;
                        e.fillStyle = o, e.strokeStyle = g, e.beginPath(), e.rect(-t / 2, -n / 2, t, n), e.closePath(), e.fill(), e.stroke()
                    }
        ...
        27206: (e, t, i) => {
            ...
            class d extends r.LineSourcePaneView {
                constructor(e, t) {
                    super(e, t), this._labelsRenderers = new Array(e.levelsCount()).fill(null).map(() => new s.TextRenderer), this._numericFormatter = new a.NumericFormatter, this._percentageFormatter = new o.PercentageFormatter
                }
                _updateLabelForLevel({
                    ...
                    let S = "";
                    if (w) {
                        S += null !== (f = null === (g = x.coeffsAsPercents) || void 0 === g ? void 0 : g.value()) && void 0 !== f && f ? this._percentageFormatter.format(100 * P, !1, 2) : this._numericFormatter.format(P)
                    }
                    return m && (S += "(" + v.formatPrice(s, R) + ")"), this._labelsRenderers[e].setData({
        ...
        28187: (e, t, i) => {
            ...
            class g {
                ...
                drawOn(e) {
                    ...
                    e.drawImage((0, o.ensureNotNull)(this._sourceCanvas), Math.round(i.x * this._renderParams.pixelRatio), Math.round(i.y * this._renderParams.pixelRatio), Math.round(t.width * this._renderParams.pixelRatio), Math.round(t.height * this._renderParams.pixelRatio))
                }
                hasPoint(e) {
                    const t = (0, o.ensureNotNull)(this._data),
                ...
                _createSource(e, t, i) {
                    this._sourceCanvas = (0, c.createDisconnectedCanvas)(document, new c.Size(e, t), this._renderParams.pixelRatio), this._translate = new _.Point(-e / 2, .5 - t), this._translate.x % 1 == 0 && (this._translate = new _.Point(this._translate.x + .5, this._translate.y));
            ...
            class f {
                ...
                draw(e, t) {
                    var i;
                    if (null === this._data) return;
                    null !== this._source && (0, u.areEqualPaneRenderParams)(this._source.renderParams(), t) || (null === (i = this._source) || void 0 === i || i.destroy(), this._source = new g(t), this._source.update(this._data));
                    this._source.drawOn(e), this._data.tooltipVisible && this._drawTooltipOn(e, t)
                }
                hitTest(e) {
                    return null !== this._data && null !== this._source && this._source.hasPoint(e) ? new a.HitTestResult(a.HitTestResult.MOVEPOINT) : null
                }
                _drawTooltipOn(e, t) {
                    ...
                    f < 10 ? f = a.y + 13 : x = "bottom", g < 10 ? g += Math.abs(g - 10) : g + _ + 10 > i.vpWidth && (g -= g + _ + 10 - i.vpWidth), e.fillStyle = (0, d.generateColor)(i.backgroundColor, i.backgroundTransparency), e.strokeStyle = i.borderColor, e.lineWidth = 1, e.beginPath();
                    ...
                    e.moveTo(m, R), v || "top" !== x || (e.lineTo(w - y, R), e.lineTo(w, R - y), e.lineTo(w + y, R)), e.lineTo(m + _, R), e.lineTo(m + _, R + p), v || "bottom" !== x || (e.lineTo(w + y, R + p), e.lineTo(w, R + p + y), e.lineTo(w - y, R + p)), e.lineTo(m, R + p), e.closePath(), e.fill(), e.stroke(), e.textBaseline = "middle", e.fillStyle = i.textColor, e.textAlign = (0, h.isRtl)() ? "right" : "left";
            ...
            class x extends n.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    this._noteRenderer.setData(l), i.append(this._noteRenderer), i.append(new s.SelectionRenderer({
                        points: t,
                        bgColors: this._lineAnchorColors(t),
                        visible: this.areAnchorsVisible(),
                        barSpacing: this._model.timeScale().barSpacing(),
        ...
        26850: (e, t, i) => {
            ...
            class g extends d.ScaledPaneRenderer {
                ...
                _drawImpl(e, t) {
                    ...
                    this._cache.bodyRight = d + n, this._cache.quantityRight = d + n + r, this._cache.top = c, this._cache.bottom = c + this._height(), this._cache.left = d, this._cache.right = l, this._drawLines(e, d, l, h, i);
                    let u = !1;
                    0 !== n && (this._drawBody(e, d, c), this._adapter.hasMoveCallback() && this._drawMovePoints(e, d, c), this._drawBodyText(e, d, c), u = !0), 0 !== r && (this._drawQuantity(e, d + n, c, u), this._drawQuantityText(e, d + n, c), u = !0), 0 !== this._cancelButtonWidth() && this._drawCancelButton(e, d + n + r, c, u)
                }
                _height() {
                ...
                _drawCancelButton(e, t, i, r) {
                    ...
                    const s = this._cancelButtonWidth(),
                        a = this._height();
                    e.fillRect(t + .5, i + .5, s - 1, a - 1), this._adapter.getBlocked() && (e.fillStyle = "rgba(140, 140, 140, 0.75)", e.fillRect(t + .5, i + .5, s - 1, a - 1)), e.save(), r && e.clip && (e.beginPath(), e.rect(t + .5, i - .5, s + 1, a + 1), e.clip()), e.strokeRect(t, i, s, a), e.restore();
                    const o = t + s,
                        d = i + a;
                    e.strokeStyle = this._adapter.getCancelButtonIconColor();
                    const h = (this._cancelButtonWidth() - 8) / 2,
                        c = (this._height() - 8) / 2;
                    (0, l.drawPoly)(e, [new n.Point(t + h, i + c), new n.Point(o - h, d - c)], !0), (0, l.drawPoly)(e, [new n.Point(o - h, i + c), new n.Point(t + h, d - c)], !0)
                }
            }
            var f = i(64446);
            class v extends r.LineSourcePaneView {
        ...
        66962: (e, t, i) => {
            ...
            var n = i(86441),
                ...
                a = i(42779),
                o = i(51515);
            const l = [r.PaneCursorType.Default, r.PaneCursorType.Default, r.PaneCursorType.Default, r.PaneCursorType.Default, r.PaneCursorType.VerticalResize, r.PaneCursorType.VerticalResize];
            ...
            class _ extends h {
                ...
                _updateRenderer() {
                    ...
                    if (3 === this._points.length) {
                        ...
                        const n = this._points[2].subtract(this._points[1]).scaled(.5),
        ...
        19098: (e, t, i) => {
            ...
            var n = i(25177).t,
                ...
                s = i(90789),
                a = i(91084).HitTestResult,
                o = i(72249).splitThousands,
                l = i(34581),
                d = i(18833).appendEllipsis,
                h = i(40778).ScaledPaneRenderer;
            class c extends h {
                constructor(e, t) {
                ...
                _drawLines(e, t, i, n, r) {
                    e.save(), e.strokeStyle = this._adapter.getLineColor(), e.lineStyle = this._adapter.getLineStyle(), e.lineWidth = this._adapter.getLineWidth(),
                        CanvasEx.drawLine(e, i, n, r, n), this._adapter.getExtendLeft() && CanvasEx.drawLine(e, 0, n, t, n), e.restore()
                }
                _drawBody(e, t, i) {
                    e.strokeStyle = this._adapter.getBodyBorderColor(), e.fillStyle = this._adapter.getBodyBackgroundColor();
                ...
                _drawReverseButton(e, t, i) {
                    ...
                    var s = function(e, t) {
                            CanvasEx.setLineStyle(e, CanvasEx.LINESTYLE_SOLID), CanvasEx.drawLine(e, 0, 0, 0, t), CanvasEx.drawLine(e, -1, 1, 1, 1), CanvasEx.drawLine(e, -2, 2, 2, 2)
                        },
                        a = t + Math.round((this._reverseButtonWidth() - 6) / 2),
                        o = i + 5;
                    e.save(), e.translate(a, o), s(e, 10), e.translate(6, 10), e.rotate(Math.PI), s(e, 10), e.restore(), this._adapter._blocked && (e.fillStyle = "rgba(140, 140, 140, 0.75)", e.fillRect(t + .5, i + .5, n - 1, r - 1)), e.restore()
                }
                ...
                _drawImpl(e) {
                    if (null !== this._data && this._data.points && !(this._data.points.length < 1)) {
                        var t = this._data.width,
                            ...
                            h = Math.round(this._data.points[0].y),
                            c = Math.round(h - (this._height() + 1) / 2);
                        this._cache.bodyRight = d + i, this._cache.quantityRight = this._cache.bodyRight + n, this._cache.reverseButtonRight = this._cache.quantityRight + r, this._cache.top = c, this._cache.bottom = c + this._height(), this._cache.left = d, this._cache.right = l, this._drawLines(e, d, l, h, t), 0 !== i && (this._drawBody(e, d, c),
                            this._drawBodyText(e, d, c)), 0 !== n && (this._drawQuantity(e, this._cache.bodyRight, c), this._drawQuantityText(e, this._cache.bodyRight, c)), 0 !== r && this._drawReverseButton(e, this._cache.quantityRight, c), 0 !== this._closeButtonWidth() && this._drawCloseButton(e, this._cache.reverseButtonRight, c)
                    }
                }
                hitTest(e) {
                    return null === this._data || 0 === this._data.points.length || e.y < this._cache.top || e.y > this._cache.bottom || e.x < this._cache.left || this._cache.right < e.x ? null : this._adapter._blocked ? new a(a.CUSTOM, {}) : e.x >= this._cache.bodyRight && e.x < this._cache.quantityRight && this._adapter._onModifyCallback ? new a(a.CUSTOM, {
                        clickHandler: this._adapter.callOnModify.bind(this._adapter),
                        tapHandler: this._adapter.callOnModify.bind(this._adapter),
                        tooltip: {
        ...
        63154: (e, t, i) => {
            ...
            var n = i(86441).Point,
                ...
                d = i(22529).getImage,
                h = i(97280),
                c = i(42419).PercentageFormatter,
                u = i(52647).DateFormatter,
                _ = i(89963).TimeFormatter,
                p = i(36111).TimeSpanFormatter,
                g = i(76036),
                f = i(50375),
                v = i(69639).calcTextHorizontalShift,
                x = i(34581).isRtl,
                w = i(30551).drawRoundRect,
                m = i(42265).makeFont,
                R = i(40778).ScaledPaneRenderer,
                y = i(34581),
                T = y.forceLTRStr,
                b = y.startWithLTR,
                L = i(66425).CHART_FONT_FAMILY;
            class P extends R {
                constructor() {
                    super(), this._data = null, this._font = L, this._targetFontSize1 = 14, this._targetFontSize2 = 11, this._sourceFontSize1 = 12, this._sourceFontSize2 = 10, this._arrowOffset = 6, this._arrowWidth = 5, this._arrowHeight = 5, this._radius = 3,
                        this._sourceWidth = void 0, this._sourceHeight = void 0, this._sourceRectLeftOffset = void 0, this._targetWidth = void 0, this._targetHeight = void 0, this._targetRectLeftOffset = void 0
                }
                setData(e) {
                    this._data = e
                }
                drawBalloon(e, t, i, r, s, a) {
                    ...
                    if (e.beginPath(), "down" === s) {
                        ...
                        return e.moveTo(l.x + this._radius, l.y), e.lineTo(l.x + i - this._radius, l.y), e.arcTo(l.x + i, l.y, l.x + i, l.y + this._radius, this._radius), e.lineTo(l.x + i, l.y + r - this._radius), e.arcTo(l.x + i, l.y + r, l.x + i - this._radius, l.y + r, this._radius), e.lineTo(l.x + o + this._arrowWidth, l.y + r), e.lineTo(l.x + o, l.y + r + this._arrowHeight), e.lineTo(l.x + o - this._arrowWidth, l.y + r), e.lineTo(l.x + this._radius, l.y + r), e.arcTo(l.x, l.y + r, l.x, l.y + r - this._radius, this._radius), e.lineTo(l.x, l.y + this._radius), e.arcTo(l.x, l.y, l.x + this._radius, l.y, this._radius), l
                    }
                    var d = new n(t.x - o, t.y + this._arrowOffset + this._arrowHeight + r);
                    return e.moveTo(d.x + this._radius, d.y), e.lineTo(d.x + i - this._radius, d.y), e.arcTo(d.x + i, d.y, d.x + i, d.y - this._radius, this._radius), e.lineTo(d.x + i, d.y - r + this._radius), e.arcTo(d.x + i, d.y - r, d.x + i - this._radius, d.y - r, this._radius), e.lineTo(d.x + o + this._arrowWidth, d.y - r), e.lineTo(d.x + o, d.y - r - this._arrowHeight), e.lineTo(d.x + o - this._arrowWidth, d.y - r), e.lineTo(d.x + this._radius, d.y - r), e.arcTo(d.x, d.y - r, d.x, d.y - r + this._radius, this._radius), e.lineTo(d.x, d.y - this._radius), e.arcTo(d.x, d.y, d.x + this._radius, d.y, this._radius), new n(d.x, d.y - r)
                }
                drawTargetLabel(e) {
                    e.save(), e.translate(.5, .5);
                    ...
                    this._targetWidth = Math.max(l + d + h, c + u + p + 2 * _) + 8 + 4, this._targetHeight = this._targetFontSize1 + this._targetFontSize2 + 9 + 4;
                    ...
                    e.fillStyle = g.generateColor(this._data.targetBackColor, this._data.transparency), e.fill(), e.lineWidth = 2, e.strokeStyle = g.generateColor(this._data.targetStrokeColor, this._data.transparency), e.stroke();
                    e.beginPath(), e.arc(R.x, R.y, 3, 0, 2 * Math.PI, !1), e.fillStyle = this._data.centersColor, e.fill(), e.textBaseline = "top", e.fillStyle = this._data.targetTextColor;
                    var L = 2 + b.x + 4,
                        P = 2 + b.y + 3,
                    ...
                    if (e.fillText(o, L + c + p + 2 * _ + k, I), this._data.status) {
                        ...
                        switch (e.font = m(this._targetFontSize1, this._font, "bold"), this._data.status) {
                            case f.AlertStatus.Success:
                                D = r("SUCCESS"), E = g.generateColor(this._data.successBackground, this._data.transparency), B = this._data.successTextColor, O = this._data.successIcon;
                                break;
                            case f.AlertStatus.Failure:
                                D = r("FAILURE"), E = g.generateColor(this._data.failureBackground, this._data.transparency), B = this._data.failureTextColor, O = this._data.failureIcon
                        }
                        var z = this._targetFontSize1 + 4,
                            H = e.measureText(D).width,
                            V = Math.round((this._targetWidth - H) / 2),
                            W = v(e, H);
                        e.fillStyle = E, "up" === this._data.direction ? (w(e, b.x - 1, b.y - z - 2, this._targetWidth + 2, z, 5), e.fill(), e.fillStyle = B, e.fillText(D, b.x + V + W, b.y - z + 1), O && e.drawImage(O, b.x + V - O.width - 4, b.y - z - 2 + Math.abs(z - O.height) / 2)) : (w(e, b.x - 1, b.y + this._targetHeight + 2, this._targetWidth + 2, z, 5), e.fill(), e.fillStyle = B, e.fillText(D, b.x + V + W, b.y + this._targetHeight + 5), O && e.drawImage(O, b.x + V - O.width - 4, b.y + this._targetHeight + 10 - Math.abs(z - O.height) / 2)), e.restore()
                    } else e.restore()
                }
                drawStartLabel(e) {
                    e.save(), e.translate(.5, .5);
                    ...
                    e.fillStyle = g.generateColor(this._data.sourceBackColor, this._data.transparency), e.fill(), e.lineWidth = 2, e.strokeStyle = g.generateColor(this._data.sourceStrokeColor, this._data.transparency), e.stroke(), e.textAlign = x() ? "right" : "left", e.textBaseline = "top", e.fillStyle = this._data.sourceTextColor;
                ...
                _drawImpl(e) {
                    if (!(null === this._data || this._data.points.length < 2)) {
                        ...
                        var t = this._data.points[0],
                            i = this._data.points[1],
                            n = i.subtract(t);
                        Math.abs(n.x) < 1 || Math.abs(n.y) < 1 ? (e.beginPath(), e.moveTo(t.x, t.y), e.lineTo(i.x, i.y), e.stroke()) : (e.save(), e.beginPath(), e.translate(t.x, t.y), e.scale(1, n.y / n.x), e.moveTo(0, 0), e.arcTo(n.x, 0, n.x, n.x, Math.abs(n.x)), e.lineTo(n.x, n.x), e.restore(), e.stroke()), this.drawTargetLabel(e), this.drawStartLabel(e);
            ...
            t.PredictionPaneView = class extends s {
                constructor(e, t) {
                    ...
                    this._clockWhite = null, this._successIcon = null, this._failureIcon = null, d("prediction-clock-white", i(15050)).then((function(e) {
                        n._clockWhite = e, r()
                    })), d("prediction-success-white", i(65625)).then((function(e) {
                        n._successIcon = e, r()
                    })), d("prediction-failure-white", i(90076)).then((function(e) {
                        n._failureIcon = e, r()
                    })), this._percentageFormatter = new c, this._predictionRenderer = new P, this._renderer = null
                }
                iconsReady() {
                ...
                _updateImpl() {
                    if ((super._updateImpl(), this._renderer = null, this._targetLine1 = "", this._targetLine2 = "", this._targetLine3 = "", this._targetLine4 = "", !(this._source.points().length < 2)) && this._source.priceScale()) {
                        ...
                        i.time && t.time && (o = TradingView.isString(i.time) ? new Date(Date.parse(i.time)) : i.time, d = TradingView.isString(t.time) ? new Date(Date.parse(t.time)) : t.time);
        ...
        72719: (e, t, i) => {
            ...
            var n = i(86441),
                ...
                o = i(74173).LineSourcePaneView,
                l = i(64446).SelectionRenderer,
                d = i(91084).HitTestResult,
                h = i(4547).CompositeRenderer,
                c = i(76036),
                u = i(69639).calcTextHorizontalShift,
                _ = i(34581).isRtl,
                p = i(40778).ScaledPaneRenderer,
                g = i(66425);
            class f extends p {
                constructor(e, t) {
        ...
        16777: (e, t, i) => {
            ...
            class x {
                constructor() {
                    this._data = null, this._priceLabelRenderer = new o.TextRenderer(void 0, new p.HitTestResult(p.HitTestResult.MOVEPOINT, {
                ...
                setData(e) {
                    ...
                    this._priceLabelRenderer.setData({ ...v(n),
                        points: [i],
                        text: e.text,
                        color: e.textColor,
                        font: u.CHART_FONT_FAMILY,
                ...
                draw(e, t) {
                    ...
                    e.lineCap = "butt", (0, c.setLineStyle)(e, h.LINESTYLE_SOLID), e.strokeStyle = i.lineColor, e.fillStyle = i.lineColor, e.lineWidth = Math.round(1 * n);
                    const l = (0, f.fillScaledRadius)(2, n);
                    (0, g.createCircle)(e, r, s, l), e.fill(), (0, c.drawLine)(e, r, s, a, o), this._priceLabelRenderer.draw(e, t);
                    const d = 1 * n;
            ...
            class w extends l.LineSourcePaneView {
                constructor() {
                    super(...arguments), this._renderer = new a.CompositeRenderer, this._priceNoteRenderer = new x, this._customLabelRenderer = new o.TextRenderer
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(), this._renderer
                }
                _updateImpl() {
                    ...
                    if (this._priceNoteRenderer.setData({
                        ...
                        }), this._renderer.append(this._priceNoteRenderer), this._renderer.append(this.createLineAnchor({
                            points: t
        ...
        92193: (e, t, i) => {
            ...
            class v extends a.LineSourcePaneView {
                constructor() {
                    super(...arguments), this._topBorderRenderer = new d.TrendLineRenderer, this._bottomBorderRenderer = new d.TrendLineRenderer, this._distanceRenderer = new d.TrendLineRenderer, this._backgroundRenderer = new l.RectangleRenderer, this._labelRenderer = new o.TextRenderer, this._renderer = new h.CompositeRenderer, this._pipFormatter = null, this._lastSymbolInfo = null
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(e, t), this._renderer
                }
                _updateImpl(e, t) {
                    ...
                    const a = this._source.properties().childs(),
                        ...
                        v = Math.min(h.x, c.x),
                        x = Math.max(h.x, c.x);
                    a.fillBackground.value() && (this._backgroundRenderer.setData({
                    ...
                    let m = v,
                        R = x;
                    m === R && (l && (m -= 1), d && (R += 1)), w(this._topBorderRenderer, new r.Point(m, h.y), new r.Point(R, h.y)), w(this._bottomBorderRenderer, new r.Point(m, c.y), new r.Point(R, c.y));
                    ...
                    C && C !== this._lastSymbolInfo && (this._pipFormatter = new p.PipFormatter(C.pricescale, C.minmov, C.type, C.minmove2), this._lastSymbolInfo = C);
                    const I = (0, s.forceLTRStr)((0, n.ensureNotNull)(this._source.ownerSource()).formatter().format(S) + " (" + f.format(M) + ") " + (this._pipFormatter ? this._pipFormatter.format(S) : ""));
                    let N;
                    N = P > L ? new r.Point(.5 * (h.x + c.x), c.y - 2 * a.fontsize.value()) : new r.Point(.5 * (h.x + c.x), c.y + .7 * a.fontsize.value());
                    const A = {
                            x: 0,
                            y: 10
                        },
                        ...
                        D = {
                            ...
                            fontsize: k,
                            backgroundRoundRect: 4,
                            backgroundHorzInflate: .4 * k,
                            backgroundVertInflate: .2 * k
                        };
                    (null === (i = a.fillLabelBackground) || void 0 === i ? void 0 : i.value()) && (D.boxShadow = {
                        shadowColor: a.shadow.value(),
                        shadowBlur: 4,
                        shadowOffsetY: 1
                    }, D.backgroundColor = a.labelBackgroundColor.value()), this._labelRenderer.setData(D);
                    const E = this._labelRenderer.measure(),
                        B = (0, o.calculateLabelPosition)(E, h, c, A, e);
                    this._labelRenderer.setPoints([B]), this._renderer.append(this._labelRenderer), this.addAnchors(this._renderer)
                }
            }
        },
        17178: (e, t, i) => {
            "use strict";
            var n = i(4044).ArcWedgeRenderer,
                r = i(91199).FibWedgePaneView,
                s = i(86734).TrendLineRenderer,
                a = i(4547).CompositeRenderer,
                o = i(6605).LineEnd;
        ...
        80119: (e, t, i) => {
            ...
            class h extends l.LineSourcePaneView {
                ...
                _addAnchors(e, t, i) {
                    ...
                    s.data = 3;
                    const a = new n.Point(e.x, .5 * (e.y + t.y));
                    a.data = 4;
                    const o = new n.Point(t.x, .5 * (e.y + t.y));
                    o.data = 5;
                    const l = new n.Point(.5 * (e.x + t.x), e.y);
                    l.data = 6;
                    const h = new n.Point(.5 * (e.x + t.x), t.y);
                    h.data = 7, [a, o, l, h].forEach(e => e.square = !0);
                    const c = e.x - t.x,
                        u = e.y - t.y,
                        _ = Math.sign(c * u),
                        p = [_ < 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize, _ < 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize, _ > 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize, _ > 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize, d.PaneCursorType.HorizontalResize, d.PaneCursorType.HorizontalResize, d.PaneCursorType.VerticalResize, d.PaneCursorType.VerticalResize];
                    i.append(this.createLineAnchor({
            ...
            class g extends p.LineSourcePaneView {
                ...
                _updateImpl() {
                    ...
                    for (let n = 0; n < i.length; n++) {
                        ...
                        r.setData(p[n]), r.setHitTest(new s.HitTestResult(s.HitTestResult.REGULAR)), e.append(r), 0 !== n && (t = t.concat(i[n].points))
                    }
                ...
                _getTransparencyResetLines() {
                    return (0, n.ensureNotNull)(this._data).lines.map(e => ({ ...e,
        ...
        61962: (e, t, i) => {
            ...
            var n = i(86441),
                ...
                R = i(66425),
                y = i(46750);
            const T = [w.PaneCursorType.Default, w.PaneCursorType.HorizontalResize, w.PaneCursorType.VerticalResize, w.PaneCursorType.VerticalResize],
            ...
            class N extends a.LineSourcePaneView {
                ...
                _updateImpl(e, t) {
                    ...
                    const w = this._points[v.RiskRewardPointIndex.Entry].y,
                        ...
                        P = this._points[v.RiskRewardPointIndex.ActualEntry] ? this._points[v.RiskRewardPointIndex.ActualEntry].x : this._points[v.RiskRewardPointIndex.Close].x,
                    ...
                    let k = M < -5 || L > t + 5;
                    if (this._createBackgroundRenderers(A, this._renderer), this._createLinesRenderers(A, this._renderer), this._createLabelsRenderers(A, this._renderer, f), f !== this._lastSymbolInfo && (this._pipFormatter = new p.PipFormatter(f.pricescale, f.minmov, f.type, f.minmove2),
                            this._lastSymbolInfo = f), k = [this._profitLabelRenderer, this._stopLabelRenderer, this._middleLabelRenderer].reduce((i, n) => i && n.isOutOfScreen(t, e), k), k) return;
                ...
                _creareMiddleLabel(e, t, i) {
                    ...
                    return e.pl < 0 ? p = a.stopBackground.value() : e.pl > 0 && (p = a.profitBackground.value()), this._addCenterLabel(t, this._middleLabelRenderer, {
                        p: l,
                        txt: d,
                        color: p,
                        vertAlign: "middle",
                ...
                _createStopLabel(e, t) {
                    ...
                    return d = i.compact.value() ? h + " (" + c + ") " + i.amountStop.value() : M.format({
                ...
                _createTargetLabel(e, t) {
                    ...
                    const h = s.formatter().format(a),
                        c = this._percentageFormatter.format(o);
                    return d = i.compact.value() ? h + " (" + c + ") " + i.amountTarget.value() : C.format({
                ...
                _createLabelsRenderers(e, t, i) {
                    ...
                    if (h - d - c <= 8 && (l && (l.offsetY += c + 8, this._profitLabelRenderer.setData(l)), o && (o.offsetY += c + 8, this._stopLabelRenderer.setData(o)), a)) {
                        ...
                        const i = e.profitLevel < e.stopLevel ? 1 : -1,
                            o = (0, r.ensureDefined)(a.points)[0].add(new n.Point(0, i * t * (.5 * this._middleLabelRenderer.measure().height + c + 8)));
        ...
        58402: (e, t, i) => {
            ...
            var n = i(86441).Point,
                ...
                s = i(74173).LineSourcePaneView,
                a = i(74173).thirdPointCursorType,
                o = i(86734).TrendLineRenderer,
                l = i(8422).PolygonRenderer,
                d = i(4547).CompositeRenderer,
                h = i(6605).LineEnd,
                c = i(28303).PaneCursorType;
                ...
                _updateImpl() {
                    if (super._updateImpl(), this._renderer = null, this._distance = 0, 3 === this._points.length && (this._distance = r(this._points[0], this._points[1], this._points[2]).distance), 0 !== this._points.length) {
                        var e, t, i, s, l = new d,
                            ...
                            p = this._points[1];
                        if (2 === this._points.length) {
                            (f = {}).points = this._points, f.floatPoints = this._floatPoints, f.width = this._model.timeScale().width(), f.height = this._source.priceScale().height(), f.color = u.color.value(), f.linewidth = 1, f.linestyle = CanvasEx.LINESTYLE_SOLID, f.extendleft = !1, f.extendright = !1, f.leftend = h.Normal, f.rightend = h.Normal;
                            var g = new o;
                            g.setData(f), l.append(g)
                        } else if (3 === this._points.length) {
                            var f, v = p.subtract(_),
                                x = new n(v.y, -v.x).normalized().scaled(this._distance),
                                w = x.scaled(-1);
                            e = _.add(x), t = p.add(x), i = _.add(w), s = p.add(w), (f = {}).points = [e, t, s, i], f.color = u.color.value(), f.linewidth = this._source.properties().linewidth.value(), f.linestyle = CanvasEx.LINESTYLE_SOLID, f.filled = !0, f.backcolor = u.backgroundColor.value(), f.fillBackground = u.fillBackground.value(), f.transparency = u.transparency.value(), this._poligonRenderer.setData(f), l.append(this._poligonRenderer)
                        }
                        var m = [];
        ...
        72024: (e, t, i) => {
            ...
            function w(e, t) {
                let i = x.get(e);
                return void 0 !== i && i.width === t || (i = function(e, t) {
                    ...
                    return a.imageSmoothingEnabled = !0, a.imageSmoothingQuality = "high", a.drawImage(e, r, s, n, n, 0, 0, t, t), i
                }(e, t), x.set(e, i)), i
            }
            ...
            class b {
                ...
                hitTest(e, t) {
                    ...
                    if (i || r || s) {
                        ...
                        return s ? e.areaName = o.AreaName.Text : r && (e.areaName = o.AreaName.Style), new o.HitTestResult(this._hitTestResult, e)
                    }
                    return null
                }
                draw(e, t) {
                    ...
                    const {
                        poleColor: i,
                        emojiRadius: n
                    } = this._data, r = t.pixelRatio, s = Math.max(1, Math.floor(r)), a = s % 2 ? .5 : 0;
                    e.beginPath(), e.strokeStyle = i, e.lineWidth = s;
                    const o = Math.round(this._data.x * r) + a;
                    e.moveTo(o, Math.round(R(this._data) * r)), e.lineTo(o, Math.round(y(this._data) * r)), void 0 !== this._data.plate && 0 !== this._data.plate.poleTailHeight && (e.moveTo(o, Math.round(T(this._data) * r)), e.lineTo(o, Math.round(function(e) {
                        var t, i;
                        ...
                        const h = (0, v.fillScaledRadius)(a, s),
                            ...
                            p = c + _,
                            g = u + _;
                        if (e.shadowOffsetY = 1, e.shadowColor = i.shadowColor, e.shadowBlur = 4, e.beginPath(), e.arc(p, g, h, 0, 2 * Math.PI, !0), e.closePath(), e.fill(), e.shadowColor = "transparent", null !== t.image) {
                        ...
                        if (e.lineWidth = f, e.beginPath(), e.arc(p, g, x, 0, 2 * Math.PI, !0), e.closePath(), e.stroke(), i.outsideBorderWidth) {
                            e.save();
                            const t = Math.round(i.outsideBorderWidth * s),
                                n = x + f / 2 + t / 2;
                            e.lineWidth = t, e.strokeStyle = i.outsideBorderColor, e.beginPath(), e.arc(p, g, n, 0, 2 * Math.PI, !0), e.closePath(), e.stroke(), e.restore()
                        }
            ...
            class S extends l.LineSourcePaneView {
                constructor(e, t) {
                    super(e, t), this._renderer = new s.CompositeRenderer, this._signpostRenderer = new b(o.HitTestResult.MOVEPOINT, e.isPhantom())
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(e, t), this._renderer
                }
        ...
        1465: (e, t, i) => {
            ...
            class d extends a.ScaledPaneRenderer {
                ...
                hitTest(e, t) {
                    ...
                    return n = this._data.point.y + n + this._data.height / 2, Math.abs(n - e.y) <= 3 ? new o.HitTestResult(o.HitTestResult.MOVEPOINT) : null
                }
                _drawImpl(e, t) {
                    e.strokeStyle = this._data.color, e.lineWidth = this._data.lineWidth, (0, l.setLineStyle)(e, this._data.lineStyle), e.beginPath(), e.moveTo(this._data.point.x, this._data.point.y);
        ...
        21881: (e, t, i) => {
            "use strict";
            i.r(t), i.d(t, {
                StudyLineDataSourceAnchorsPaneView: () => r
            });
            var n = i(74173);
            class r extends n.LineSourcePaneView {
                renderer() {
        ...
        20318: (e, t, i) => {
            ...
            class p extends u.LineSourcePaneView {
                constructor(e, t, i, n, r, s, a, l) {
                    super(e, t), this._textRenderer = new o.TextRenderer, this._noSelection = !1, this._renderer = null, this._offsetX = i, this._offsetY = n, this._vertAlign = r, this._horzAlign = s, this._forceTextAlign = Boolean(a), this._noSelection = !1, this._renderer = null, this._recalculateSourcePointsOnFirstUpdate = l
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(e, t), this._renderer
                }
                ...
                _updateImpl(e, t) {
                    ...
                    if (p.points = i.isFixed() ? i.fixedPoints() : this._points, o.fillBackground && o.fillBackground.value() && (p.backgroundColor = o.backgroundColor.value()), o.drawBorder && o.drawBorder.value() && (p.borderColor = o.borderColor.value()), o.wordWrap && o.wordWrap.value() && (p.wordWrapWidth = o.wordWrapWidth.value()), p.bold = o.bold && o.bold.value(), p.italic = o.italic && o.italic.value(), p.highlightBorder = u.selection().isSelected(i), !i.isFixed() && o.fixedSize && !o.fixedSize.value()) {
                        ...
                        i.isPriceDencityLog() && !a.isLog() && (t = a.height() / ((0, h.toLog)(e.maxValue(), r) - (0, h.toLog)(e.minValue(), r))), !i.isPriceDencityLog() && a.isLog() && (t = a.height() / ((0, h.fromLog)(e.maxValue(), r) - (0, h.fromLog)(e.minValue(), r)));
                        const s = i.priceDencity();
                        void 0 !== s && (p.scaleY = t / s), (void 0 === s || void 0 === p.scaleY || p.scaleY <= 0) && delete p.scaleY
                    }
        ...
        17125: (e, t, i) => {
            ...
            var n = i(86441).Point,
                r = i(74173).LineSourcePaneView,
                s = i(91084).HitTestResult,
                a = i(4547).CompositeRenderer,
                o = i(76036),
                l = i(40778).ScaledPaneRenderer;
            class d extends l {
                constructor() {
                    super(), this._data = null
                }
                ...
                _drawImpl(e) {
                    null !== this._data && (e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, CanvasEx.setLineStyle(e, this._data.linestyle), e.save(), e.translate(this._data.point.x + 1, this._data.point.y), e.scale(this._data.width, this._data.height), e.beginPath(), e.arc(.5, 0, .5, Math.PI, 0, !1), e.restore(), e.stroke(), this._data.fillBackground && (e.fillStyle = o.generateColor(this._data.backcolor, this._data.transparency), e.fill()))
                }
                hitTest(e) {
        ...
        81940: (e, t, i) => {
            ...
            var n = i(86441).Point,
                r = i(25177).t,
                s = i(2965).TrendLineStatsRenderer,
                a = i(45916).TextRenderer,
                o = i(86734).TrendLineRenderer,
                l = i(4547).CompositeRenderer,
                d = i(42419).PercentageFormatter,
                h = i(64446).SelectionRenderer,
                c = i(9525).PipFormatter,
                u = i(6605).LineEnd,
                _ = i(24546).LabelSettings,
                p = i(66425),
                g = i(91084).HitTestResult,
                f = i(51515).AlertableLineSourcePaneView,
                v = i(40778).ScaledPaneRenderer,
                x = i(40778).ScaledPaneRendererWrapper,
                w = i(34581).forceLTRStr;
            class m extends v {
                constructor() {
                    super(), this._data = null
                }
            ...
            t.TrendAnglePaneView = class extends f {
                constructor(e, t) {
                    super(e, t), this._label = null, this._rendererCache = {}, this._pipFormatter = null, this._lastSymbolInfo = null, this._trendLineRenderer = new o, this._angleRenderer = new m, this._angleLabelRenderer = new a, this._renderer = null
                }
                _updateImpl() {
                    if (super._updateImpl(), this._renderer = null, this._points.length > 0 && void 0 !== this._source._angle) {
                        var e = this._points[0],
                            ...
                            a = new n(t, i);
                        this._secondPoint = e.addScaled(a, this._source._distance), this._secondPoint.data = 1, this._middlePoint = this._source.calcMiddlePoint(this._points[0], this._secondPoint)
                    }
                    if (this._label = null, !(this._source.points().length < 2)) {
                        e = this._source.points()[0];
                        var o, f, v = this._source.points()[1],
                            m = [];
                        ...
                        if (this._secondPoint && this._points.length > 0) {
                            ...
                            if (P.points = [this._points[0], this._secondPoint], P.width = this._model.timeScale().width(), P.height = this._source.priceScale().height(), P.color = C, P.linewidth = this._source.properties().linewidth.value(), P.linestyle = this._source.properties().linestyle.value(), P.extendleft = this._source.properties().extendLeft.value(), P.extendright = this._source.properties().extendRight.value(), P.leftend = u.Normal, P.rightend = u.Normal, this._trendLineRenderer.setData(P), L.append(this._trendLineRenderer), S && this._label && 2 === this._points.length) {
                                var I = this._source.properties().statsPosition.value(),
                                    ...
                                    B = _.offset;
                                E.offsetX = B, E.offsetY = B, (this._points[1].y < this._points[0].y && this._points[1].x < this._points[0].x || this._points[1].y > this._points[0].y && this._points[1].x > this._points[0].x) && (E.vertAlign = "bottom"),
                                    L.append(new x(new s(E, this._rendererCache)))
                            }
                            this._middlePoint && L.append(new h({
                            ...
                            var O = {};
                            O.point = this._points[0], O.angle = this._source._angle, O.color = this._source.properties().linecolor.value(), O.size = 50, this._angleRenderer.setData(O), L.append(this._angleRenderer);
                        ...
                        P.points && P.points.length >= 2 && this._addAlertRenderer(L, P.points), this._secondPoint && this._points.length > 0 && L.append(this.createLineAnchor({
        ...
        97636: (e, t, i) => {
            "use strict";
            var n = i(86441).Point,
                r = i(35836).RectangleRenderer,
                s = i(86734).TrendLineRenderer,
                a = i(91084).HitTestResult,
                o = i(4547).CompositeRenderer,
                l = i(6605).LineEnd,
                d = i(62744).fibLevelCoordinate,
                h = i(62744).fibLevelPrice,
                c = i(27206).LineToolPaneViewFibWithLabels;
            t.TrendBasedFibExtensionPaneView = class extends c {
                constructor(e, t) {
                    super(e, t), this._trendLineRendererPoints12 = new s, this._trendLineRendererPoints23 = new s, this._renderer = null
                }
                _updateImpl() {
                    if (super._updateImpl(), this._renderer = null, 3 === this._source.points().length) {
                        ...
                        for (var m = {
                                ...
                                price: x,
                                coordinate: p
                            }, y = this._source.levelsCount(), T = 1; T <= y; T++) {
                            var b = C["level" + T];
                            if (b.visible.value()) {
                                var L = b.coeff.value(),
                                    P = b.color.value(),
                    ...
                    if (!(this._points.length < 2)) {
                        ...
                        if (D)
                            for (T = 0; T < this._levels.length; T++)
                                if (T > 0 && D) {
                                    ...
                                    H.points = [i, c], H.color = this._levels[T].color, H.linewidth = 0, H.backcolor = this._levels[T].color, H.fillBackground = !0, H.transparency = E, H.extendLeft = B, H.extendRight = O;
                        ...
                        for (T = 0; T < this._levels.length; T++) {
                            ...
                            var Y = new s;
                            Y.setData(N), Y.setHitTest(new a(a.MOVEPOINT, {
                                snappingPrice: this._levels[T].price
                            }, this._levels[T].index)), I.append(Y);
                            const e = this._updateLabelForLevel({
                                i: T,
        ...
        23094: (e, t, i) => {
            ...
            t.TrendBasedFibTimePaneView = class extends s {
                constructor(e, t) {
                    super(e, t), this._trendLineRendererPoints12 = new l, this._trendLineRendererPoints23 = new l, this._renderer = null
                }
                _updateImpl() {
                    if (super._updateImpl(), this._renderer = null, 3 === this._source.points().length) {
                    ...
                    if (!(this._points.length < 2)) {
                        ...
                        if (y)
                            for (p = 1; p < this._levels.length; p++) {
                                ...
                                S.points = [e, t], S.color = this._levels[p].color, S.linewidth = 0, S.backcolor = this._levels[p].color, S.fillBackground = !0, S.transparency = T, S.extendLeft = !1, S.extendRight = !1, (A = new o(void 0, void 0, !0)).setData(S), m.append(A)
                            }
                        for (p = 0; p < this._levels.length; p++) {
                            if (void 0 !== this._levels[p].text) {
                                var M, C = l.horzLabelsAlign.value();
                                switch (C = "left" === C ? "right" : "right" === C ? "left" : "center", l.vertLabelsAlign.value()) {
                                    case "top":
                                        M = new n(this._levels[p].x, 0);
                                        break;
                                    case "middle":
                                        M = new n(this._levels[p].x, .5 * this._levels[p].y);
                                        break;
                                    case "bottom":
                            ...
                            var N = {};
                            N.width = b, N.height = L, N.x = this._levels[p].x, N.color = this._levels[p].color, N.linewidth = this._levels[p].linewidth, N.linestyle = this._levels[p].linestyle;
                            var A, k = new d(d.MOVEPOINT, null, this._levels[p].index);
        ...
        61288: (e, t, i) => {
            ...
            var n = i(88537).ensureNotNull,
                r = i(86441).Point,
                s = i(25177).t,
                a = i(20652).PaneRendererCachedImage,
                o = i(4547).CompositeRenderer,
                l = i(42419).PercentageFormatter,
                d = i(8329).NumericFormatter,
                h = i(36111).TimeSpanFormatter,
                c = i(9525).PipFormatter,
                u = i(64446).SelectionRenderer,
                _ = i(86734).TrendLineRenderer,
                p = i(45916).TextRenderer,
                g = i(24546).LabelSettings,
                f = i(66425),
                v = i(91084).HitTestResult,
                x = i(51515).AlertableLineSourcePaneView,
                w = i(95357).TrendLineStatsCache,
                m = i(73117).areEqualPaneRenderParams,
                R = i(2965).iconsContainer,
                y = i(34581),
                T = y.forceLTRStr,
                b = y.startWithLTR;
            t.TrendLinePaneView = class extends x {
                constructor(e, t) {
                    super(e, t), this._label = null, this._rendererCache = {}, this._cacheInvalidated = !0, this._percentageFormatter = new l, this._numericFormatter = new d, this._pipFormatter = null, this._lastSymbolInfo = null, this._trendRenderer = new _, this._labelRenderer = new p, this._renderer = null, this._cache = null, this._cacheDrawParams = null, this._iconsReady = !1, R.onAllIconsReady().subscribe(this, (function() {
                ...
                getCacheRects(e, t) {
                    ...
                    return s.left += g.paddingLeftRight, this._points[1].y < this._points[0].y && this._points[1].x < this._points[0].x || this._points[1].y > this._points[0].y && this._points[1].x > this._points[0].x ? s.top -= g.paddingLeftRight + s.height : s.top += g.paddingLeftRight, {
                        cacheRect: r,
                        targetRect: s
                    }
                }
                _createCacheIfRequired(e) {
                    null != this._cache && null != this._cacheDrawParams && m(e, this._cacheDrawParams) || (this._cache && this._cache.destroy(), this._cache = new w(e), this._statCache = this._cache.updateSource(this._source, function() {
                        return this._statLabelData()
                    }.bind(this)), this._cacheDrawParams = e, this._cacheInvalidated = !1), this._cacheInvalidated && (this._cacheState = this._cache.updateSource(this._source, function() {
                        return this._statLabelData()
                    ...
                    if (e && !e.isEmpty() && !t.isEmpty()) {
                        ...
                        if (null !== i) {
                            ...
                            if (!(n.length < 2)) {
                                ...
                                if ((!(s.index < i.firstBar() && l.index < i.firstBar()) || d.extendLeft.value() || d.extendRight.value()) && (super._updateImpl(), !(this._points.length < 2))) {
                                    var h = d.showBarsRange.value(),
                                        c = d.showDateTimeRange.value(),
                                        _ = d.showDistance.value(),
                                        p = d.showPriceRange.value(),
                                        g = d.showAngle.value();
                                    p || h || c || _ || g || (this._label = null, this._labelData && (this._labelData.text = "", this._labelData.lines = []));
                                    var x = new o,
                                        w = d.linecolor.value(),
                                        m = {};
                                    m.points = this._points, m.width = t.width(), m.height = e.height(), m.color = w, m.linewidth = d.linewidth.value(), m.linestyle = d.linestyle.value(), m.extendleft = d.extendLeft.value(), m.extendright = d.extendRight.value(), m.leftend = d.leftEnd.value(), m.rightend = d.rightEnd.value(), this._trendRenderer.setData(m), x.append(this._trendRenderer);
                                    var R = (this.isHoveredSource() || this.isSelectedSource()) && this.isEditMode() || d.alwaysShowStats.value(),
                                        y = (this.isHoveredSource() || this.isSelectedSource()) && d.showMiddlePoint.value();
                                    if (R && 2 === this._points.length) {
                                        var T = new a(this, 0);
                                        x.append(T)
                                    }
                                    if (this._middlePoint && x.append(new u({
                                            points: [this._middlePoint],
                                            bgColors: this._lineAnchorColors([this._middlePoint]),
                                            color: w,
                                            visible: y && this.areAnchorsVisible(),
                                            hittestResult: v.REGULAR
                                        })), this.addAnchors(x), m.points.length >= 2 && this._addAlertRenderer(x, m.points), d.showLabel && d.showLabel.value() && d.text.value().length > 0) {
                ...
                _statLabelData() {
                    var e, t, i, n, r, a, o, l = this._source.points(),
                        d = l[0],
                        u = l[1],
                        _ = this._source.properties(),
                        p = [];
                    if (_.showPriceRange.value() && this._source.priceScale()) {
                        ...
                        e = this._source.ownerSource().formatter().format(n) + " (" + this._percentageFormatter.format(100 * v) + ")";
                        var x = this._model.mainSeries().symbolInfo();
                        x && x !== this._lastSymbolInfo && (this._pipFormatter = new c(x.pricescale, x.minmov, x.type, x.minmove2), this._lastSymbolInfo = x), e += this._pipFormatter ? ", " + this._pipFormatter.format(n) : "", p.push("priceRange")
                    }
                    var w, m = _.showBarsRange.value(),
                    ...
                    if (m || R || y) {
                        if (t = "", m && (r = u.index - d.index, t += s("{count} bars").format({
                                count: T(r)
                            })), R) {
                        ...
                        y && (t && (t += ", "), t += s("distance: {number} px").format({
                            number: T(this._numericFormatter.format(Math.round(o)))
                        })), t && p.push("barsRange")
                    }
                    L && (o > 0 && (a = a.normalized(), w = Math.acos(a.x), a.y > 0 && (w = -w)), "number" != typeof w || TradingView.isNaN(w) || (i = Math.round(180 * w / Math.PI) + "º",
                        p.push("angle")));
                    this._label = [T(e), t, i].filter((function(e) {
                        return e
                    })).join("\n") || null, this._icons = p;
                    ...
                    return this._points[1].y < this._points[0].y && (D.vertAlign = "bottom"), this._points[1].x < this._points[0].x && (D.horzAlign = "right"), this._labelData = D, D
                }
                renderer(e, t) {
                    return this._invalidated && this._updateImpl(), this._renderer
                }
        ...
        95357: (e, t, i) => {
            ...
            class g {
                ...
                updateSource(e, t) {
                    ...
                    this._currentSymbol !== i && (_.logDebug("TrendLineCache. Clearing canvas because of changing symbol from " + this._currentSymbol + " to " + i), this._currentSymbol = i, this._sourcesToRow.clear(), this._rowsToSources.clear());
                    const n = e.id();
                    ...
                    if (void 0 === r) {
                        ...
                        r = {
                            ...
                            rowIndex: e,
                            width: 0
                        }, this._sourcesToRow.set(n, r), this._rowsToSources.set(e, n)
                    }
                ...
                _repaintSource(e, t, i) {
                    i.points[0] = new r.Point(0, 0), i.offsetX = 0, i.offsetY = 0, delete i.horzAlign, delete i.vertAlign, (0, d.drawScaled)(this._ctx, this._params.pixelRatio, () => {
                ...
                _recreateCanvas() {
                    this._canvas = (0, n.ensureNotNull)(document.createElement("canvas")), this._canvas.width = this._currentWidth * this._params.pixelRatio, this._canvas.height = this._maxRowHeight * this._actualCapacity * this._params.pixelRatio, this._ctx = (0, n.ensureNotNull)(this._canvas.getContext("2d")), this._ctx.font = `${h}px ${o.CHART_FONT_FAMILY}`, this._sourcesToRow.clear(), this._rowsToSources.clear()
                }
            }
        },
        15273: (e, t, i) => {
            "use strict";
            i.r(t), i.d(t, {
                LineToolTrianglePatternPaneView: () => _
            });
            var n = i(88537),
                r = i(86441),
                s = i(46750),
                ...
                _updateImpl() {
                    ...
                    if (4 === this._points.length) {
                        ...
                        if (_ < n) {
                            ...
                            n = Math.max(n, i.x), n = Math.max(n, o.x), d = new r.Point(n, e.y + (n - e.x) * s), c = new r.Point(n, t.y + (n - t.x) * h)
                        }
                        const p = e.y + (_ - e.x) * s;
                        l = new r.Point(_, p)
                    }
                    ...
                    const v = g(e, "A");
                    t.y > e.y ? (v.vertAlign = "bottom", v.offsetY = 5) : (v.vertAlign = "top", v.offsetY = 5), this._aLabelRenderer.setData(v), p.append(this._aLabelRenderer);
                    const x = g(t, "B");
                    if (t.y < e.y ? (x.vertAlign = "bottom", x.offsetY = 5) : (x.vertAlign = "top", x.offsetY = 5), this._bLabelRenderer.setData(x), p.append(this._bLabelRenderer), this._points.length > 2) {
                        const e = g(i, "C");
                        i.y < t.y ? (e.vertAlign = "bottom", e.offsetY = 5) : (e.vertAlign = "top", e.offsetY = 5), this._cLabelRenderer.setData(e), p.append(this._cLabelRenderer)
                    }
                    if (this._points.length > 3) {
                        const e = g(o, "D");
                        o.y < i.y ? (e.vertAlign = "bottom", e.offsetY = 5) : (e.vertAlign = "top", e.offsetY = 5), this._dLabelRenderer.setData(e), p.append(this._dLabelRenderer)
                    }
        ...
        24221: (e, t, i) => {
            "use strict";
            var n = i(74173).LineSourcePaneView,
                r = i(4547).CompositeRenderer,
                s = i(71227).TriangleRenderer;
        ...
        91892: (e, t, i) => {
            ...
            class u extends h.AlertableLineSourcePaneView {
                constructor(e, t, i) {
                    super(e, t), this._lineRenderer = new o.VerticalLineRenderer,
                ...
                _updateImpl(e, t) {
                    ...
                    const i = this._source.properties().childs(),
                        ...
                        a = s.linewidth / 2 + 1;
                    let o = s.x < -a || s.x > t + a;
                    this._lineRenderer.setData(s), this._lineRenderer.setHitTest(new d.HitTestResult(d.HitTestResult.MOVEPOINT, {
                        snappingIndex: this._source.points()[0].index
                    }));
                    const h = new r.CompositeRenderer;
                    ...
                    if (i.showLabel.value() && i.text.value().length > 0 && this._source.model().paneForSource(this._source) === this._pane) {
                        let r = 0,
                            s = 5,
                            a = "center",
                            d = "middle";
                        ...
                        this._labelRenderer.setData(_), h.append(this._labelRenderer), o = o && this._labelRenderer.isOutOfScreen(t, e)
                    }
                    if (!o) {
                        if (1 === this._points.length) {
                            const t = new n.Point(this._points[0].x, e / 2);
                            t.data = 0, t.square = !0, t.snappingIndex = this._source.points()[0].index, h.append(this.createLineAnchor({
                                points: [t],
                                pointsCursorType: c
                            }, 0))
                        }
        ...
        4044: (e, t, i) => {
            ...
            class a extends s.ScaledPaneRenderer {
                constructor() {
                    super(...arguments), this._data = null, this._hitTest = new n.HitTestResult(n.HitTestResult.MOVEPOINT), this._backHitTest = new n.HitTestResult(n.HitTestResult.MOVEPOINT_BACKGROUND)
                }
                setData(e) {
                    this._data = e
                }
                ...
                _drawImpl(e) {
                    if (null !== this._data && (e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, e.beginPath(), e.arc(this._data.center.x, this._data.center.y, this._data.radius, this._data.edge1, this._data.edge2, !0), e.stroke(), this._data.fillBackground)) {
                        if (e.arc(this._data.center.x, this._data.center.y, this._data.prevRadius, this._data.edge2, this._data.edge1, !1), this._data.gradient) {
                            ...
                            t.addColorStop(0, (0, r.generateColor)(this._data.color1, this._data.transparency)), t.addColorStop(1, (0, r.generateColor)(this._data.color2, this._data.transparency)), e.fillStyle = t
        ...
        96510: (e, t, i) => {
            ...
            class c extends h.ScaledPaneRenderer {
                ...
                hitTest(e, t) {
                    ...
                    return null !== i && (0, s.pointInPolygon)(e, i) ? new l.HitTestResult(l.HitTestResult.MOVEPOINT_BACKGROUND) : null
                }
                _drawImpl(e, t) {
                    if (null === this._data) return;
                    const i = this._visiblePolygon(t);
                ...
                _visiblePolygon(e) {
                    const t = (0, n.ensureNotNull)(this._data),
                        ...
                        o = t.p3,
                        l = t.p4;
                    if ((0, r.equalPoints)(i, s) || (0, r.equalPoints)(o, l) || (0, a.distanceToLine)(i, s, o).distance < 1e-6 && (0, a.distanceToLine)(i, s, l).distance < 1e-6) return null;
                    if (e.cssWidth <= 0 || e.cssHeight <= 0) return null;
                    let d = [new r.Point(0, 0), new r.Point(e.cssWidth, 0), new r.Point(e.cssWidth, e.cssHeight), new r.Point(0, e.cssHeight)];
                    return d = u(d, i, s, [l, o]), d = u(d, l, o, [i, s]), (0, r.equalPoints)(o, i) || t.extendLeft || (d = u(d, o, i, [s, l])), d
                }
            }

            function u(e, t, i, n) {
                const s = (0, r.equalPoints)(i, n[0]) ? (0, r.equalPoints)(i, n[1]) ? null : n[1] : n[0];
                return null !== e && null !== s ? (0, o.intersectPolygonAndHalfplane)(e, (0, r.halfplaneThroughPoint)((0, r.lineThroughPoints)(t, i), s)) : null
            }
        },
        50536: (e, t, i) => {
            "use strict";
            ...
            class _ {
                constructor() {
                    this._parallelChannelRenderer = new h.ParallelChannelRenderer, this._disjointChannelIntersectionRenderer = new p, this._selectedRenderer = this._disjointChannelIntersectionRenderer
                }
                setData(e) {
                    if (e.points.length < 4) return;
                    const [t, i, n, s] = e.points;
                    if ((0, r.equalPoints)(t, i) || (0, r.equalPoints)(n, s) || (0, a.distanceToLine)(t, i, n).distance < 1e-6 && (0, a.distanceToLine)(t, i, s).distance < 1e-6) this._selectedRenderer = null;
                    else {
                        null !== (0, o.intersectLines)((0, r.lineThroughPoints)(t, i), (0,
                            r.lineThroughPoints)(n, s)) ? (this._disjointChannelIntersectionRenderer.setData(e), this._selectedRenderer = this._disjointChannelIntersectionRenderer) : (this._parallelChannelRenderer.setData({
            ...
            class p extends u.ScaledPaneRenderer {
                ...
                _visiblePolygons(e) {
                    ...
                    if (null === d) return [];
                    const h = [new r.Point(0, 0), new r.Point(e.cssWidth, 0), new r.Point(e.cssWidth, e.cssHeight), new r.Point(0, e.cssHeight)],
                        c = []; {
                        let e = h;
            ...
            function f(e, t, i) {
                return null !== e ? (0, o.intersectPolygonAndHalfplane)(e, (0, r.halfplaneThroughPoint)((n = t, (0, r.line)(1, 0, -n)), new r.Point(i, 0))) : null;
                var n
            }
        ...
        69611: (e, t, i) => {
            ...
            class d extends l.ScaledPaneRenderer {
                constructor(e, t, i) {
                    super(), this._data = e, this._hitTest = t || new n.HitTestResult(n.HitTestResult.MOVEPOINT), this._backgroundHitTest = i || new n.HitTestResult(n.HitTestResult.MOVEPOINT_BACKGROUND)
                }
                hitTest(e) {
                    if (this._data.points.length < 2) return null;
                    const t = this._data.points[0],
                    ...
                    return c = (0,
                        r.sign)(c) * Math.sqrt(Math.abs(c / n)), Math.abs(c) < 3 ? this._hitTest : this._data.fillBackground && !this._data.noHitTestOnBackground && c < 3 ? this._backgroundHitTest : null
                }
                _drawImpl(e) {
                    e.lineCap = "butt", e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, void 0 !== this._data.linestyle && (0, o.setLineStyle)(e, this._data.linestyle);
                    const t = this._data.points[0],
                        i = this._data.points[1],
                        n = Math.abs(t.x - i.x),
                        r = Math.abs(t.y - i.y),
                    ...
                    e.save(), e.translate(s.x, s.y), e.scale(1, r / n), e.beginPath(), e.arc(0, 0, n / 2, 0, 2 * Math.PI, !1), e.restore(), e.stroke(), this._data.fillBackground && (this._data.wholePoints && (e.translate(s.x, s.y), e.scale(1, r / n), e.arc(0, 0, l / 2, 0, 2 * Math.PI, !0)), e.fillStyle = (0, a.generateColor)(this._data.backcolor, this._data.transparency, !0), e.fill())
                }
            }
        },
        47921: (e, t, i) => {
            ...
            function _(e, t, i, n) {
                e.globalAlpha = .2, u(e, t, i, n), e.stroke(), e.globalAlpha = 1
            }
            ...
            class v {
                ...
                draw(e, t) {
                    ...
                    i.length && (e.strokeStyle = this._data.color, this._drawPoints(e, t.pixelRatio, i, n, p, _)), r.length && (e.strokeStyle = this._data.color, this._drawPoints(e, t.pixelRatio, r, s, f, g))
                }
                hitTest(e) {
                    var t;
                    ...
                    const {
                        ...
                        pointsCursorType: r,
                        hittestResult: s
                    } = this._data, a = (0, d.interactionTolerance)().anchor;
                    for (let d = 0; d < n.length; ++d) {
                        const h = n[d];
                        if (h.subtract(e).length() <= i + a) return new o.HitTestResult(Array.isArray(s) ? s[d] : s, {
                            pointIndex: h.data,
                ...
                _drawPoints(e, t, i, n, r, s) {
                    ...
                    for (let d = 0; d < i.length; ++d) {
                        ...
                        if (!((0, a.isInteger)(h.data) && o.linePointBeingEdited === h.data)) {
                            if (r(e, new c(Math.round(h.x * t) + f, Math.round(h.y * t) + f, h.data, h.square), g / 2, _), !o.disableInteractions) {
        ...
        42779: (e, t, i) => {
            ...
            class u extends c.ScaledPaneRenderer {
                constructor(e, t) {
                    super(), this._data = null, this._hittestResult = e || new l.HitTestResult(l.HitTestResult.MOVEPOINT), this._backHittestResult = t || new l.HitTestResult(l.HitTestResult.MOVEPOINT_BACKGROUND)
                }
                setData(e) {
                    this._data = e
                }
                hitTest(e, t) {
                    if (null === this._data || this._data.points.length < 2) return null;
                    const [i, n] = this._data.points, r = this._extendAndHitTestLineSegment(e, i, n, t);
                    if (null !== r) return r;
                    if (4 === this._data.points.length && !this._data.skipTopLine) {
                        const [, , r, s] = this._data.points, a = this._extendAndHitTestLineSegment(e, r, s, t);
                        if (null !== a) return a;
                        if (this._data.showMidline && !this._data.skipLines) {
                            const a = i.add(r).scaled(.5),
                                o = n.add(s).scaled(.5),
                ...
                _drawImpl(e, t) {
                    if (null === this._data || this._data.points.length < 2) return;
                    e.lineCap = "butt", e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, (0, o.setLineStyle)(e, this._data.linestyle);
                    const [i, n] = this._data.points;
                    if (this._data.points.some(e => !isFinite(e.y))) this._extendAndDrawLineSegment(e, i, n, t);
                    else if (this._data.skipLines || this._extendAndDrawLineSegment(e, i, n, t), 4 === this._data.points.length) {
                        const [, , r, s] = this._data.points;
                        if (this._data.skipLines || this._data.skipTopLine || this._extendAndDrawLineSegment(e, r, s, t), this._data.fillBackground && this._drawBackground(e, this._data.points, t), this._data.showMidline && !this._data.skipLines) {
                            e.strokeStyle = this._data.midcolor, e.lineWidth = this._data.midlinewidth, (0, o.setLineStyle)(e, this._data.midlinestyle);
                            const a = i.add(r).scaled(.5),
                                l = n.add(s).scaled(.5);
                ...
                _drawBackground(e, t, i) {
                    const a = (0, n.ensureNotNull)(this._data),
                        [o, l, d, h] = t;
                    if ((0, r.equalPoints)(o, l) || (0, r.equalPoints)(d, h) || (0, s.distanceToLine)(o, l, d).distance < 1e-6 || (0,
                            s.distanceToLine)(o, l, h).distance < 1e-6) return;
                    if (i.cssWidth <= 0 || i.cssHeight <= 0) return;
                    let c = [new r.Point(0, 0), new r.Point(i.cssWidth, 0), new r.Point(i.cssWidth, i.cssHeight), new r.Point(0, i.cssHeight)];
                    if (c = _(c, o, l, h), a.extendright || (c = _(c, l, h, d)), c = _(c, h, d, o), a.extendleft || (c = _(c, d, o, l)), null !== c) {
                ...
                _hitTestBackground(e) {
                    ...
                    const [i, r, s] = t.points, a = (r.y - i.y) / (r.x - i.x), o = i.y + a * (e.x - i.x), l = s.y + a * (e.x - s.x), d = Math.max(o, l), h = Math.min(o, l), c = Math.min(i.x, r.x), u = Math.max(i.x, r.x);
                    return !t.extendleft && e.x < c || !t.extendright && e.x > u ? null : e.y >= h && e.y <= d ? this._backHittestResult : null
                }
            }

            function _(e, t, i, n) {
                return null !== e ? (0, a.intersectPolygonAndHalfplane)(e, (0, r.halfplaneThroughPoint)((0, r.lineThroughPoints)(t, i), n)) : null
            }
        },
        8422: (e, t, i) => {
            "use strict";
            ...
            class u extends h.ScaledPaneRenderer {
                constructor(e) {
                    super(), this._data = null, this._backHittest = new l.HitTestResult(l.HitTestResult.MOVEPOINT_BACKGROUND), this._points = [], this._hittest = null != e ? e : new l.HitTestResult(l.HitTestResult.MOVEPOINT)
                }
                setData(e) {
                    this._data = e, this._points = e.points
                }
                ...
                _drawImpl(e, t) {
                    ...
                    e.lineCap = l, e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, e.lineJoin = null !== (n = this._data.linejoin) && void 0 !== n ? n : "miter", (0, s.setLineStyle)(e, this._data.linestyle);
                    const h = this._points[0];
                    e.moveTo(h.x, h.y);
                    for (const t of this._points) e.lineTo(t.x, t.y);
                    if (this._data.filled && this._data.fillBackground && (e.fillStyle = (0, d.generateColor)(this._data.backcolor, this._data.transparency), e.fill()), this._data.filled && !this._data.skipClosePath && e.closePath(), this._data.linewidth > 0 && e.stroke(), r > 1) {
        ...
        2965: (e, t, i) => {
            ...
            class x {
                constructor(e, t, i) {
                    this._fontSize = 0, this._preRendered = !1, this._boundingBox = null, this._rect = null, this._padding = null, this._textPoint = null, this._textSizeCache = t, this._data = e, this._fontSize = e.fontSize ? e.fontSize : 12, this._lineSpacing = (0, h.isNumber)(this._data.lineSpacing) && this._data.lineSpacing ? this._data.lineSpacing : 0, e.lines = this._lines = null === e.text ? [] : (0, o.wordWrap)(e.text, this.fontStyle(), e.wordWrapWidth), this._hittest = i || new l.HitTestResult(l.HitTestResult.MOVEPOINT)
                }
                fontStyle() {
                ...
                draw(e, t) {
                    ...
                    if (this._rect) {
                        if ("right" !== this._data.horzAlign && "center" !== this._data.horzAlign || !0 !== this._data.doNotAlignText && (e.textAlign = "right" === this._data.horzAlign ? "end" : "center"), this._data.backgroundRoundRect ? ((0, d.drawRoundRect)(e, n.x, n.y, n.w, n.h, this._data.backgroundRoundRect), e.fillStyle = this._data.backgroundColor, e.fill(), e.globalAlpha = 1) : (e.fillStyle = this._data.backgroundColor, e.fillRect(n.x, n.y, n.w, n.h), e.globalAlpha = 1), this._data.icons) {
                            let r = 0;
                ...
                hitTest(e) {
                    return 0 === this._data.points.length ? null : (this._preRender(), this._boundingBox && (0, r.pointInBox)(e, this._boundingBox) ? this._hittest : null)
                }
                _preRender() {
                    ...
                    if ("right" === this._data.horzAlign || "center" === this._data.horzAlign) {
                        ...
                        i += n - _.x, _.x = n, !0 !== this._data.doNotAlignText && ("right" === this._data.horzAlign ? (e.textAlign = "end", i += h) : (e.textAlign = "center", i += h / 2))
                    }
                    _.w % 2 != 0 && _.w++, _.x += .5, _.y += .5, this._boundingBox = (0, n.box)(new n.Point(_.x, _.y), new n.Point(_.x + _.w, _.y + _.h)), this._rect = _, this._padding = u, this._textPoint = {
                        x: i,
                        y: s
                ...
                _drawIcon(e, t, i, n, r, o) {
                    ...
                    let d = v.get(l);
                    if (!d) {
                        d = document.createElement("canvas"), d.width = 18 * o.pixelRatio, d.height = 18 * o.pixelRatio, d.style.width = "18px", d.style.height = "18px";
        ...
        71227: (e, t, i) => {
            ...
            class h extends s.ScaledPaneRenderer {
                ...
                hitTest(e) {
                    ...
                    return s = (0, n.distanceToSegment)(i, l, e), s.distance <= o ? new a.HitTestResult(a.HitTestResult.MOVEPOINT) : (s = (0, n.distanceToSegment)(l, t, e), s.distance <= o ? new a.HitTestResult(a.HitTestResult.MOVEPOINT) : this._data.fillBackground && (0, r.pointInTriangle)(e, t, i, l) ? new a.HitTestResult(a.HitTestResult.MOVEPOINT_BACKGROUND) : null)
                }
                _drawImpl(e) {
                    if (null === this._data || this._data.points.length < 2) return;
                    e.lineCap = "butt", e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, void 0 !== this._data.linestyle && (0, l.setLineStyle)(e, this._data.linestyle);
                    const [t, i] = this._data.points, n = 2 === this._data.points.length ? i : this._data.points[2];
                    e.beginPath(), e.moveTo(t.x, t.y), e.lineTo(i.x, i.y), e.lineTo(n.x, n.y), e.lineTo(t.x, t.y), this._data.fillBackground && (e.fillStyle = (0, o.generateColor)(this._data.backcolor, this._data.transparency), e.fill()), e.stroke()
                }
            }
        }
    }
