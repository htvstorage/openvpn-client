    ...
    [7271], {
            ...
            function i(e) {
                ...
                e.fromQuotesSnapshot = function(e) {
                ...
                }, e.fromQuotes = t, e.fromSymbolSearchResult = function(e, t) {
                    {
                        ...
                        return r.enabled("pay_attention_to_ticker_not_symbol") ? (0, n.ensureDefined)(null != s ? s : o) : (0, n.ensureDefined)(o)
                    }
            ...
            class r {
                ...
                includes(e) {
                    return function(e, t) {
                        ...
                        return o.toLowerCase().includes(s) || n.toLowerCase().includes(s) || void 0 !== r && r.some(e => e.toLowerCase().includes(s))
                    }(this._exchange, e)
                }
        ...
        26163: (e, t, s) => {
            ...
            var o = s(88537),
                ...
                h = s(42923),
                m = s(21167);
            new Set(n.enabled("widget") ? ["pro_name", "short_name", "description", "exchange", "type", "country_code", "provider_id"] : ["pro_name", "short_name", "description", "exchange", "type", "country_code", "provider_id", "logoid", "currency-logoid", "base-currency-logoid"]);
            const y = (0, m.getAvailableExchanges)(),
                S = {};
            for (const e of y) S[e.value] = {
                country: e.country,
            ...
            class I {
                constructor(e) {
                    this._contentItemList = new(a())([]), this._checkedSymbols = new Map, this._recentLength = 10, this._isDataReady = new(a())(!1), this._highlightedSymbol = new(a())(null), this._defaultSymbolsDescriptions = new Map, this._idToStudyMap = new Map, this._chartSession = null, this._recentSymbolsEnabled = n.enabled("compare_recent_symbols_enabled"), this._preventHandleSourcesChange = !0, this.removeStudy = e => {
                        const {
                            symbol: t,
                            study: s
                        } = e;
                        ...
                        o && o.length > 1 ? this._removeStudyIdFromCheckedSymbols(t, s.id()) : this._checkedSymbols.delete(t), this._updateContentItemList(this._contentItemList.value(), !0)
                    }, this._getResolveSymbolPromise = (e, t) => new Promise(s => {
                        const n = (0, o.ensureNotNull)(this._chartSession).resolveSymbol((0, r.makeNextSymbolId)(), (0, i.encodeExtendedSymbolOrGetSimpleSymbolString)({
                            symbol: e
                        }), s);
                        t && t.set(e, n)
                    ...
                    Promise.all(d).then(e => {
                        ...
                        const n = Array.from(t).filter(e => this._checkedSymbols.has(e)).reduce((e, t) => (s.has(t) && e.push(t), e), []).concat(Array.from(c)),
                            r = Array.from(t);
                        if (this._recentSymbolsEnabled && r.length < this._recentLength) {
                            let e;
                            e = [], this._chartWidget.compareSymbols() && this._chartWidget.compareSymbols().forEach(t => {
                        ...
                        const i = Array.from(new Set(n)); {
                            ...
                            Promise.all(t).then(t => this._handleInitProcess(n, s => {
                                const o = e.get(s);
                                return t.find(e => e.params[0] === o)
                            }, (e, t) => h.QualifiedSources.fromSymbolMessage(t, e), (e, t, s, o) => "symbol_resolved" === e.method ? p(e.params[1], s, o) : f(t, s, o, this._getSymbolDescription(t))))
                        }
                    })
                }
                chartModel() {
                ...
                applyStudy(e, t, s) {
                    ...
                    Promise.all([this._getResolveSymbolPromise(e), n]).then(t => this._handleApplyProcess(t, t => h.QualifiedSources.fromSymbolMessage(e, t), (e, t, s) => "symbol_resolved" === e.method ? p(e.params[1], !0, s) : f(t, !0, s))), g.emit("add_compare")
                }
                _snapshoter() {
                ...
                _handleInitProcess(e, t, s, o) {
                    ...
                    for (const r of e) {
                        ...
                        if (void 0 === c || a) this._recentSymbolsEnabled && n.push(o(e, i, !1));
                            ...
                            for (const t of c) n.push(o(e, i, !0, this._idToStudyMap.get(t)))
                    }
                ...
                _showNewItem(e, t, s) {
                    ...
                    o.unshift(e), this._recentSymbolsEnabled && o.unshift({ ...e,
                        id: t,
                        study: void 0,
                        checked: !1
                    }), this._updateContentItemList(o), this._highlightedSymbol.setValue(s), setTimeout(() => this._highlightedSymbol.setValue(null), 500)
                }
