    ...
    [507], {
        8422: (t, e, i) => {
            ...
            class u extends d.ScaledPaneRenderer {
                ...
                _drawImpl(t, e) {
                    ...
                    t.lineCap = l, t.strokeStyle = this._data.color, t.lineWidth = this._data.linewidth, t.lineJoin = null !== (s = this._data.linejoin) && void 0 !== s ? s : "miter", (0, n.setLineStyle)(t, this._data.linestyle);
                    const d = this._points[0];
                    t.moveTo(d.x, d.y);
                    for (const e of this._points) t.lineTo(e.x, e.y);
                    if (this._data.filled && this._data.fillBackground && (t.fillStyle = (0, h.generateColor)(this._data.backcolor, this._data.transparency), t.fill()), this._data.filled && !this._data.skipClosePath && t.closePath(), this._data.linewidth > 0 && t.stroke(), r > 1) {
        ...
        41027: (t, e, i) => {
                ...
                hitTest(t, e) {
                    ...
                    for (const s of i.histograms) {
                        ...
                        for (const l of s.bars) {
                            ...
                            if (h.location === a.HHistLocation.Absolute && (s.xRange.min >= t.x || t.x >= s.xRange.max)) continue;
                            ...
                            const d = v(s.xRange, h, e.cssWidth),
                                ...
                                p = Math.max(h.percentWidth * o / 100 - l.subBarValues.length, 0);
                            let f = c;
                            for (let e = 0; e < l.subBarValues.length; e++) {
                                ...
                                if (f = o, (t.x >= a && t.x <= o || t.x >= o && t.x <= a) && t.y >= i && t.y <= s) return new n.HitTestResult(n.HitTestResult.REGULAR)
                            }
                        }
                    }
                    return null
                ...
                draw(t, e) {
                    ...
                    t.save(), i.histograms.forEach(r => {
                        ...
                        const l = o / r.bars.length,
                            h = (d = l, c = e.pixelRatio, Math.floor(d * c) >= 1 * c ? Math.floor(c) : 0);
                        var d, c;
                        const u = f(r.xRange),
                            p = [];
                        if (r.bars.forEach(s => {
                                ...
                                if (o.showValues && o.addToTotalValue)
                                    for (let t = 0; t < s.subBarValues.length; t++) n[t] = (n[t] || 0) + s.subBarValues[t];
                                ...
                                const f = Math.max(o.percentWidth * u / 100 - s.subBarValues.length, 0);
                                let _ = d;
                                for (let i = 0; i < s.subBarValues.length; i++) {
                                    const r = s.y,
                                        n = s.y + s.height,
                                        l = _,
                                        d = l + c * (f * s.subBarValues[i] / a);
                                    if (_ = d, Math.abs(d - l) < .5) continue;
            ...
            function m(t, e, i, s, r, n) {
                const o = Math.min(Math.round(1.7 * t / n.length), Math.round(.6 * i)),
            ...
            function R(t, e, i) {
                ...
                t.font = `${n}px ${u.CHART_FONT_FAMILY}`, t.fillStyle = r, t.textAlign = a, (0, d.drawScaled)(t, e.pixelRatio, () => t.fillText(s, o.x, o.y))
            }
            var T = i(76036);
            class w {
                constructor(t, e, i) {
                    this._invalidated = !0,
                        this._provider = t, this._model = e, this._rendererData = {
                            histograms: [],
                            styles: {}
                ...
                renderer() {
                    ...
                    for (const e of this._textData) t.append(new l.TextRenderer(e, new n.HitTestResult(n.HitTestResult.REGULAR)));
                    return t
                }
                _resetRenderersData() {
                ...
                _prepareStyles() {
                    const t = (0, r.ensureDefined)(this._provider.graphicsInfo().hhists),
                        ...
                        s = this._provider.properties().child("inputs").child("volume").value() === a.HHistVolumeMode.Delta;
                    for (const n of e) {
                        const e = (0, r.ensureDefined)(i.child(n)),
                            a = (0, r.ensureDefined)(t[n]);
                        if (s) this._rendererData.styles[n + "UpDominate"] = {
                            colors: x(e.colors[0].value(), e.transparencies[0].value()),
                            ...
                            colors: x(e.colors[1].value(), e.transparencies[1].value()),
                            visible: e.visible.value(),
                            percentWidth: e.percentWidth.value(),
                            location: a.location,
                            direction: e.direction.value(),
                            ...
                            const t = (0, T.generateColor)(e.colors[0].value(), e.transparencies[0].value()),
                                i = e.colors[1] ? (0, T.generateColor)(e.colors[1].value(), e.transparencies[1].value()) : t;
                ...
                _updateViewInternal() {
                    ...
                    const n = s.firstBar(),
                        a = s.lastBar();
                    this._prepareStyles(), (0, r.ensureDefined)(i).forEach((i, s) => {
                        let r = 1 / 0,
                            o = -1 / 0;
                        i.forEach(t => {
                ...
                _updateDataForRenderers(t, e, i) {
                    ...
                    const o = this._provider.properties().child("inputs").child("volume").value() === a.HHistVolumeMode.Delta,
                        l = function(t, e) {
            ...
            function x(t, e) {
                ...
                if ((0, T.isHexColor)(t)) i = 100 - e;
                    ...
                    i = 100 - (null !== r ? (0, T.alphaToTransparency)(r[3]) : e)
                }
                return [(0, T.generateColor)(t, 100 - i, !0), (0, T.generateColor)(t, 100 - i / 2, !0), (0, T.generateColor)(t, 100 - i / 4, !0)]
            }
        },
        56216: (t, e, i) => {
            i.r(e), i.d(e, {
            ...
            class o {
                constructor(t, e, i) {
                    this._data = [], this._invalidated = !0, this._provider = t, this._model = e, this._hitTestResult = void 0 !== i ? new r.HitTestResult(r.HitTestResult.CUSTOM, i) : new r.HitTestResult(r.HitTestResult.REGULAR)
                }
                update() {
                    this._invalidated = !0
                }
                    ...
                    i.forEach((i, r) => {
                        ...
                        l.visible.value() && i.forEach(i => {
                            const r = i.startIndex,
                                h = i.endIndex;
                            !i.extendRight && Math.max(r, h) < a || !i.extendLeft && Math.min(r, h) > o || this._data.push({
        ...
        85898: (t, e, i) => {
            ...
            class h {
                constructor(t, e, i) {
                    this._data = [], this._invalidated = !0, this._provider = t, this._model = e, this._hitTestResult = void 0 !== i ? new n.HitTestResult(n.HitTestResult.CUSTOM, i) : new n.HitTestResult(n.HitTestResult.REGULAR)
                }
                update() {
                    this._invalidated = !0
                }
                ...
                _updateViewInternal() {
                    ...
                    const l = n.firstBar(),
                        ...
                        c = (0,
                            s.ensureDefined)(this._provider.metaInfo().graphics.polygons);
                    i.forEach((i, n) => {
                        const u = d[n];
