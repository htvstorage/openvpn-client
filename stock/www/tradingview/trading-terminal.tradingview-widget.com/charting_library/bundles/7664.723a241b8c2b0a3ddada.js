...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [7664], {
        80802: (r, t, e) => {
            ...
            const c = function(r) {
                return (r = (0, i.default)(r)) && r.replace(u, o).replace(s, "")
            };
            ...
            var p = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",
                h = "[" + p + "]",
                v = "\\d+",
                b = "[\\u2700-\\u27bf]",
                y = "[a-z\\xdf-\\xf6\\xf8-\\xff]",
                _ = "[^\\ud800-\\udfff" + p + v + "\\u2700-\\u27bfa-z\\xdf-\\xf6\\xf8-\\xffA-Z\\xc0-\\xd6\\xd8-\\xde]",
                x = "(?:\\ud83c[\\udde6-\\uddff]){2}",
                w = "[\\ud800-\\udbff][\\udc00-\\udfff]",
                ...
                g = "(?:" + S + "|" + _ + ")",
                E = "(?:[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]|\\ud83c[\\udffb-\\udfff])?",
                T = "[\\ufe0e\\ufe0f]?" + E + ("(?:\\u200d(?:" + ["[^\\ud800-\\udfff]", x, w].join("|") + ")[\\ufe0e\\ufe0f]?" + E + ")*"),
                A = "(?:" + [b, x, w].join("|") + ")" + T,
                O = RegExp([S + "?" + y + "+(?:['’](?:d|ll|m|re|s|t|ve))?(?=" + [h, S, "$"].join("|") + ")", g + "+(?:['’](?:D|LL|M|RE|S|T|VE))?(?=" + [h, S + m, "$"].join("|") + ")", S + "?" + m + "+(?:['’](?:d|ll|m|re|s|t|ve))?", S + "+(?:['’](?:D|LL|M|RE|S|T|VE))?", "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", v, A].join("|"), "g");
            const C = function(r) {
                return r.match(O) || []
            };
            const I = function(r, t, e) {
                return r = (0, i.default)(r), void 0 === (t = e ? void 0 : t) ? d(r) ? C(r) : f(r) : r.match(t) || []
            };
            var P = RegExp("['’]", "g");
            const j = function(r) {
                return function(t) {
                    return (0, n.default)(I(c(t).replace(P, "")), r, "")
                }
            }((function(r, t, e) {
            ...
            var c = e(77254),
                ...
                l = function() {
                    ...
                    return r.prototype.lift = function(t) {
                        ...
                        return (0, f.errorContext)((function() {
                            var r = u,
                                t = r.operator,
                                e = r.source;
        ...
        37538: (r, t, e) => {
            ...
            var n = e(46685),
                o = e(15544),
                i = e(3448),
                u = (0, e(30634).createErrorClass)((function(r) {
                    return function() {
                ...
                a = function(r) {
                    ...
                    return (0, n.__extends)(t, r), t.prototype.lift = function(r) {
                        ...
                        var t = this.hasError,
                            e = this.isStopped,
                            n = this.observers;
                        return t || e ? i.EMPTY_SUBSCRIPTION : (n.push(r), new i.Subscription((function() {
                            return (0, s.arrRemove)(n, r)
                        })))
                    }, t.prototype._checkFinalizedStatuses = function(r) {
                        var t = this.hasError,
                            e = this.thrownError,
                            n = this.isStopped;
                        t ? r.error(e) : n && r.complete()
            ...
            var l = e(92402),
                ...
                p = function(r) {
                    ...
                    return (0, n.__extends)(t, r), t.create = function(r, t, e) {
                            ...
                            this.isStopped ? y(f("E", void 0, r), this) : (this.isStopped = !0, this._error(r))
                        }, t.prototype.complete = function() {
            ...
            function v(r, t) {
                return function() {
                    ...
                    try {
                        ...
                        u.config.useDeprecatedSynchronousErrorHandling ? (0, d.captureError)(r) : (0, s.reportUnhandledError)(r)
                    }
                }
            }
        ...
        3448: (r, t, e) => {
            ...
            var n = e(46685),
                o = e(38323),
                i = (0, e(30634).createErrorClass)((function(r) {
                    return function(t) {
                        ...
                        if (!this.closed) {
                            ...
                            if (c)
                                if (this._parentage = null, Array.isArray(c)) try {
                                    for (var a = (0, n.__values)(c), l = a.next(); !l.done; l = a.next()) {
                                        l.value.remove(this)
                                    }
                                } catch (t) {
                                    r = {
        ...
        46685: (r, t, e) => {
            ...
            function f(r) {
                return this instanceof f ? (this.v = r, this) : new f(r)
            }
            ...
            function l(r, t, e) {
                ...
                function s(r, t) {
                    try {
                        (e = o[r](t)).value instanceof f ? Promise.resolve(e.value.v).then(c, a) : l(i[0][2], e)
                    } catch (r) {
                        l(i[0][3], r)
                    }
                    var e
