    ...
    [4193], {
        ...
        34900: (t, e, i) => {
            ...
            var s = i(88537),
                ...
                g = i(22279);
            i(5985), i(13413);
            const c = parseInt(g["css-value-chart-controls-bar-height-with-border"]);
            class _ {
                constructor(t, e) {
                    this._draggable = null, this._inited = !1, this._widgetContents = new WeakMap, this._minHeight = 30, this._paddingTop = o.footerWidgetHeight, this.open = () => {
                ...
                _init(t) {
                    ...
                    const e = () => {
                        ...
                        i = () => {
                            if ("minimized" !== this._mode.value()) {
                                const e = this._activeWidget.value();
                                let i;
                                if (this._container.classList.remove("js-hidden"), this._container.style.height = this._actualHeight.value() + "px", Array.from(this._container.querySelectorAll(".bottom-widgetbar-content"), t => {
                                    ...
                                    t && this._widgetContents.has(t) && (i = (0, s.ensureDefined)(this._widgetContents.get(t)), i.classList.remove("js-hidden"))
                                } else {
                                    i = document.createElement("div"), i.className = "bottom-widgetbar-content " + e, this._container.append(i), this._initWidgetProperties(e);
                                    const s = new(r());
                                    ...
                                    const n = () => {
                                            this.toggleWidget(e, !0)
                                        },
                                        a = this._config[e];
                                    if (a) {
                                        const r = a.ctor;
                                        this._widgets[e] = new r({
                                            container: i,
                    ...
                    this._mode.subscribe(i), this._activeWidget.subscribe(i), this._normalHeight.subscribe(() => {
                        ...
                        callWithLast: !0
                    }), this._registerWidgets(), this._loadState(), this._subscribeCheckOverlap(), this._subscribeVisibility(), this._inited = !0
                }
                ...
                _createLayout(t) {
                    t.innerHTML = "", this._footerWidgetContainer = document.createElement("div"), this._footerWidgetContainer.style.height = o.footerWidgetHeight + "px", t.append(this._footerWidgetContainer),
                        this._container = document.createElement("div"), this._container.id = "bottom-area", t.append(this._container);
                    ...
                    this._draggable = new d.PointerBackend({
                        ...
                        onDragMove: t => {
                            ...
                            let r, a = e - (n.pageY - s.pageY);
                            a <= 0 ? (a = e, r = !0) : r = !1, a = Math.max(a, this._minHeight), isFinite(a) && ("minimized" === this._mode.value() !== r ? r ? (this._mode.setValue("minimized"), this.setNormalHeight(Math.max(e, this._minHeight))) : (this._mode.setValue("normal"), this.setNormalHeight(a)) : this._normalHeight.value() !== a && (a >= this._getContentBoxHeight(this._resizerAvailHeight()) ? (this._mode.setValue("maximized"), this.setNormalHeight(e)) : (this._mode.setValue("normal"), this.setNormalHeight(a))))
                        },
                        onDragStop: () => {
                            if (null === i) return;
                            const {
                ...
                _checkOverlap() {
                    const t = this._getPaddingBoxHeight(this._actualHeight.value()),
                        e = this._mode.value();
                    this._isOverlap.setValue("maximized" === e || "normal" === e && this._resizerAvailHeight() - t <= 300 + c)
                }
                _resizerAvailHeight() {
                ...
                _loadState() {
                    ...
                    this._mode.setValue(t.mode), this._activeWidget.setValue(this.isWidgetEnabled(t.activeWidget) ? t.activeWidget : this._enabledWidgets[0]), this.setNormalHeight(Math.max(t.height, this._minHeight))
                }
                _save() {
        ...
        96818: (t, e, i) => {
                ...
                constructor(t) {
                    ...
                    this._helper = null, this._handleDragStart = t => {
                        ...
                        const {
                            current: i,
                            initial: s
                        } = t.detail, n = this._source, r = this._helper.nextTop, a = this._helper.nextLeft, o = "y" === this._axis || !1 === this._axis || 0 !== i.movementY;
                        if (o) {
                        ...
                        if (null !== this._helper.containment) {
                            ...
                            o && this._helper.nextTop && (this._helper.nextTop = Math.min(this._helper.nextTop, s), this._helper.nextTop = Math.max(this._helper.nextTop, e)), h && this._helper.nextLeft && (this._helper.nextLeft = Math.min(this._helper.nextLeft, i), this._helper.nextLeft = Math.max(this._helper.nextLeft, t))
                        }
                        null !== this._helper.raf || r === this._helper.nextTop && a === this._helper.nextLeft || (this._helper.raf = requestAnimationFrame(() => {
            ...
            class h {
                ...
                _getEventTarget() {
                    return r.CheckMobile.iOS() || (0, r.isMac)() && a.touch ? window.document.documentElement : this._handle
                }
                _dispatchEvent(t) {
                    switch (t.type) {
        ...
        2369: (t, e, i) => {
            ...
            function r(t, e = !1) {
                const i = getComputedStyle(t),
                    s = [i.height];
                return "border-box" !== i.boxSizing && s.push(i.paddingTop, i.paddingBottom, i.borderTopWidth, i.borderBottomWidth),
                    e && s.push(i.marginTop, i.marginBottom), s.reduce((t, e) => t + (parseFloat(e) || 0), 0)
            }
            ...
            function l(t) {
                ...
                if ("fixed" === e.position) i = t.getBoundingClientRect();
                    ...
                    n && n !== t && 1 === n.nodeType && (s = h(n), s.top += parseFloat(getComputedStyle(n).borderTopWidth), s.left += parseFloat(getComputedStyle(n).borderLeftWidth))
                }
                return {
