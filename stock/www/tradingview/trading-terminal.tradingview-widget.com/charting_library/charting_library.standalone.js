var TradingView = function(t) {
    ...
    function r(t, e) {
        const n = new URL(`${t||""}`, location.href).href,
            i = JSON.parse('["bundles/runtime.a743ea3490a28f4f67f9.js","bundles/4020.c92c038c73c036b71422.css","bundles/4020.c92c038c73c036b71422.rtl.css","bundles/1857.8038e0de718564e7e11e.js","bundles/library.7b364787b2f00e5ecf82.js","bundles/b1a63a011fd92dfb93db6db243bb036c.woff2","bundles/40f9a03d174178efb12303caa9bc7cd8.woff2","bundles/3293616ec0c605c7c2db25829a0a509e.woff"]'),
    ...
    const d = class {
        constructor(t) {
            ...
            }), this._options.debug && (o || (o = !0, console.log("Using TT v23.024 (internal id f8aafab5 @ 2022-10-24T06:08:16.416Z)"))), this._create()
        }
        setDebugMode(t) {
        ...
        _create() {
            ...
            (this._options.autosize || this._options.fullscreen) && (i.style.width = "100%", this._options.fullscreen || (i.style.height = "100%")), window.addEventListener("resize", this._onWindowResize), this._onWindowResize(), this._innerWindowLoaded = new Promise((t => {
                const e = () => {
